...
__all__ = ['RfpgmResponse']


@typechecked
class RfpgmResponse(IResponseGetterMixin):
    ...
    def __init__(self, nadr: int, hwpid: int = dpa_constants.HWPID_MAX, rcode: int = 0, dpa_value: int = 0,
        ...
        super().__init__(
            ...
            pcmd=OSResponseCommands.RFPGM,
            m_type=OSMessages.RFPGM,
            hwpid=hwpid,
            rcode=rcode,
            dpa_value=dpa_value,
            msgid=msgid,
    ...
    @staticmethod
    def from_dpa(dpa: bytes) -> RfpgmResponse:
        ...
        return RfpgmResponse(nadr=nadr, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, result=None)

    @staticmethod
    def from_json(json: dict) -> RfpgmResponse:
        ...
        return RfpgmResponse(nadr=nadr, msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, result=None)
