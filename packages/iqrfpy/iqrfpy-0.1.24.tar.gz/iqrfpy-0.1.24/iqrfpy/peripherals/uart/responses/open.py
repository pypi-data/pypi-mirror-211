...
@typechecked
class OpenResponse(IResponseGetterMixin):
    ...
    def __init__(self, nadr: int, hwpid: int = dpa_constants.HWPID_MAX, rcode: int = 0, dpa_value: int = 0,
        ...
        super().__init__(
            ...
            pcmd=UartResponseCommands.OPEN,
    ...
    @staticmethod
    def from_dpa(dpa: bytes) -> OpenResponse:
        ...
        return OpenResponse(nadr=nadr, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, result=None)

    @staticmethod
    def from_json(json: dict) -> OpenResponse:
        ...
        return OpenResponse(nadr=nadr, msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, result=None)
