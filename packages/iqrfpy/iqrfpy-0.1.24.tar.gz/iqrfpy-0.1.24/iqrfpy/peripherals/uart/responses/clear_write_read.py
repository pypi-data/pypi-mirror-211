...
@typechecked
class ClearWriteReadResponse(IResponseGetterMixin):
    ...
    def __init__(self, nadr: int, hwpid: int = dpa_constants.HWPID_MAX, rcode: int = 0, dpa_value: int = 0,
        ...
        super().__init__(
            ...
            pcmd=UartResponseCommands.CLEAR_WRITE_READ,
        ...
        if rcode == ResponseCodes.OK:
            self._read_data = result['readData']

    def get_read_data(self) -> List[int]:
        return self._read_data

    @staticmethod
    def from_dpa(dpa: bytes) -> ClearWriteReadResponse:
        ...
        return ClearWriteReadResponse(nadr=nadr, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, pdata=pdata,
                                      result=result)

    @staticmethod
    def from_json(json: dict) -> ClearWriteReadResponse:
        ...
        return ClearWriteReadResponse(nadr=nadr, msgid=msgid, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value,
