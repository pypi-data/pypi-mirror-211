...
from iqrfpy.peripherals.os.responses.read_tr_conf import ReadTrConfResponse as OsReadTrConfRsp, OsReadTrConfData
from iqrfpy.peripherals.os.requests.write_tr_conf import WriteTrConfRequest as OsWriteTrConfReq, OsWriteTrConfData
