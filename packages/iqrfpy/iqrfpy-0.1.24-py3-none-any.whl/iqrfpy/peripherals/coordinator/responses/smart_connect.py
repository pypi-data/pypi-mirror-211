...
class SmartConnectResponse(IResponseGetterMixin):
    ...
    def from_dpa(dpa: bytes) -> SmartConnectResponse:
        ...
        return SmartConnectResponse(hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, pdata=pdata, result=result)
    ...
    def from_json(json: dict) -> SmartConnectResponse:
        ...
        return SmartConnectResponse(msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, pdata=pdata,
                                    result=result)
