...
class AuthorizeBondResponse(IResponseGetterMixin):
    ...
    def from_dpa(dpa: bytes) -> AuthorizeBondResponse:
        ...
        return AuthorizeBondResponse(hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, pdata=pdata, result=result)
    ...
    def from_json(json: dict) -> AuthorizeBondResponse:
        ...
        return AuthorizeBondResponse(msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, pdata=pdata,
                                     result=result)
