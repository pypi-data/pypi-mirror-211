...
class RemoveBondResponse(IResponseGetterMixin):
    ...
    def from_dpa(dpa: bytes) -> RemoveBondResponse:
        ...
        if rcode == ResponseCodes.OK:
            ...
            result = {'devNr': dpa[8]}
        return RemoveBondResponse(hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, pdata=pdata, result=result)
    ...
    def from_json(json: dict) -> RemoveBondResponse:
        ...
        return RemoveBondResponse(msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, pdata=pdata,
                                  result=result)
