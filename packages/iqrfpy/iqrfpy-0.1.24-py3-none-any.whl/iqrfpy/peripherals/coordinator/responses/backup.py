...
class BackupResponse(IResponseGetterMixin):
    ...
    def from_dpa(dpa: bytes) -> BackupResponse:
        ...
        return BackupResponse(hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, pdata=pdata, result=result)
    ...
    def from_json(json: dict) -> BackupResponse:
        ...
        return BackupResponse(msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, pdata=pdata, result=result)
