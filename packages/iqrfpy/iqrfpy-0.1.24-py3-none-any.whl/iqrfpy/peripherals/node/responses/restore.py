...
class RestoreResponse(IResponseGetterMixin):
    ...
    def from_dpa(dpa: bytes) -> RestoreResponse:
        ...
        return RestoreResponse(nadr=nadr, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, result=None)
    ...
    def from_json(json: dict) -> RestoreResponse:
        ...
        return RestoreResponse(nadr=nadr, msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, result=None)
