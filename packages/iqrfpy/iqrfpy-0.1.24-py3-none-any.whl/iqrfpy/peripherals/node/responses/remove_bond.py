...
class RemoveBondResponse(IResponseGetterMixin):
    ...
    def from_dpa(dpa: bytes) -> RemoveBondResponse:
        ...
        return RemoveBondResponse(nadr=nadr, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, result=None)
    ...
    def from_json(json: dict) -> RemoveBondResponse:
        ...
        return RemoveBondResponse(nadr=nadr, msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, result=None)
