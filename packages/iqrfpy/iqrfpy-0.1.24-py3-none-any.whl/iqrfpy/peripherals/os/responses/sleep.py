...
__all__ = ['SleepResponse']


@typechecked
class SleepResponse(IResponseGetterMixin):
    ...
    @staticmethod
    def from_dpa(dpa: bytes) -> SleepResponse:
        ...
        return SleepResponse(nadr=nadr, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, result=None)

    @staticmethod
    def from_json(json: dict) -> SleepResponse:
        ...
        return SleepResponse(nadr=nadr, msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, result=None)
