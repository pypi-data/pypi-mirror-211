...
class RestartResponse(IResponseGetterMixin):
    ...
    @staticmethod
    def from_dpa(dpa: bytes) -> RestartResponse:
        ...
        return RestartResponse(nadr=nadr, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, result=None)

    @staticmethod
    def from_json(json: dict) -> RestartResponse:
        ...
        return RestartResponse(nadr=nadr, msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, result=None)
