...
__all__ = ['SetSecurityResponse']


@typechecked
class SetSecurityResponse(IResponseGetterMixin):
    ...
    def __init__(self, nadr: int, hwpid: int = dpa_constants.HWPID_MAX, rcode: int = 0, dpa_value: int = 0,
        ...
        super().__init__(
            ...
            pcmd=OSResponseCommands.SET_SECURITY,
    ...
    @staticmethod
    def from_dpa(dpa: bytes) -> SetSecurityResponse:
        ...
        return SetSecurityResponse(nadr=nadr, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, result=None)

    @staticmethod
    def from_json(json: dict) -> SetSecurityResponse:
        ...
        return SetSecurityResponse(nadr=nadr, msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, result=None)
