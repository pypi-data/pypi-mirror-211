...
class WriteReadResponse(IResponseGetterMixin):
    ...
    @staticmethod
    def from_dpa(dpa: bytes) -> WriteReadResponse:
        ...
        return WriteReadResponse(nadr=nadr, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, pdata=pdata, result=result)

    @staticmethod
    def from_json(json: dict) -> WriteReadResponse:
        ...
        return WriteReadResponse(nadr=nadr, msgid=msgid, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, pdata=pdata,
                                 result=result)
