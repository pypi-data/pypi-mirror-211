...
class DelphesAppModule(ModuleBase):
  ...
  def runIt(self):
    ...
    cmd.append({'DelphesPythia8_EDM4HEP': "%s %s %s %s" % (self.detectorCard, self.outputCard, self.pythia8Card, self.OutputFile),
               'DelphesSTDHEP_EDM4HEP': "%s %s %s %s" % (self.detectorCard, self.outputCard, self.OutputFile, self.InputFile),
               'DelphesROOT_EDM4HEP': "%s %s %s %s" % (self.detectorCard, self.outputCard, self.OutputFile, self.InputFile),
              }[self.executableName])
