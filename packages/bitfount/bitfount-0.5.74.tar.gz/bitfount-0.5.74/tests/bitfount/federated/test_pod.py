...
from bitfount.federated.exceptions import BitfountTaskStartError, PodNameError
...
class TestPod:
    ...
    def mock_view_config(self) -> Mock:
        ...
        mock_view_config: Mock = create_autospec(_ViewDatasourceConfig, instance=True)
    ...
    def test__get_target_datasource_error_on_missing_view_source_datasource(
        ...
        view_datasource_name = "view_datasource"
        mocker.patch.object(
        ...
        mock_view_datasource = Mock(
            **{
                ...
                "datasource": Mock(_ViewDatasourceConfig),
            }
        )
    ...
    def test__process_datasource_args_with_datasources(self) -> None:
        """Test that _process_datasource_args wraps/returns `datasources`."""
        datasource_1 = Mock()
        datasource_2 = Mock()

        datasources = Pod._process_datasource_args(
    ...
    def test__process_datasource_args_with_datasource(self) -> None:
