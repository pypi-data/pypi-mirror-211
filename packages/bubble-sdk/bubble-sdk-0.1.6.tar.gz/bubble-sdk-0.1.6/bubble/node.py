...
class NodePersonal(Module):
    """
    https://bub.ethereum.org/docs/interacting-with-bub/rpc/ns-personal
    """
    ...
    list_wallets: Method[Callable[[], List[BubWallet]]] = Method(
...
class NodeTxPool(Module):
    """
    https://bub.ethereum.org/docs/interacting-with-bub/rpc/ns-txpool
    """
...
class NodeAdmin(Module):
    """
    https://bub.ethereum.org/docs/interacting-with-bub/rpc/ns-admin
    """
...
class AsyncNodePersonal(Module):
    """
    https://bub.ethereum.org/docs/interacting-with-bub/rpc/ns-personal
    """
    ...
    _list_wallets: Method[Callable[[], Awaitable[List[BubWallet]]]] = Method(
        RPC.personal_listWallets,
        is_property=True,
    )
    ...
    async def list_wallets(self) -> List[BubWallet]:
...
class AsyncNode(Module):
    is_async = True

    personal: AsyncNodePersonal
    admin: AsyncNodeAdmin
    txpool: AsyncNodeTxPool
