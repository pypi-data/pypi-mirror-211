...
Welcome to ``csvsheet`` contributor's guide.
...
If you experience bugs or general issues with ``csvsheet``, please have a look
...
You can help improve ``csvsheet`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``csvsheet`` documentation uses Sphinx_ as its main documentation compiler.
...
or Miniconda_::
    ...
    conda create -n csvsheet python=3 six virtualenv pytest pytest-cov
    conda activate csvsheet
...
#. Install |pre-commit|_::
   ...
   ``csvsheet`` comes with a lot of hooks configured to automatically help the
