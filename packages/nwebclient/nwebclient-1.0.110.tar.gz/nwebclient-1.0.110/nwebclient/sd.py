...
class ImageGen:
    ...
    def initA1111(self):
        import webuiapi
        if self.api is None:
            self.api = webuiapi.WebUIApi(sampler='DPM++ SDE Karras', steps=20)
    def initDiffCn(self):
    ...
    def genA1111(self, loop_number=1):  
        ...
        # ig.a11_default['enable_hr']=True,
        # ig.a11_default['hr_scale']=2,
        # ig.a11_default['hr_upscaler']= 'Latent' #webuiapi.HiResUpscaler.Latent,
        # ig.a11_default['hr_second_pass_steps']=20,
