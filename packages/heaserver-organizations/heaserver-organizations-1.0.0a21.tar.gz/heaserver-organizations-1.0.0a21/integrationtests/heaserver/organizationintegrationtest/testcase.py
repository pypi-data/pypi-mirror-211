...
HEASERVER_REGISTRY_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-registry:1.0.0a38'
# HEASERVER_PEOPLE_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-people:1.0.0a16'
HEASERVER_VOLUME_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-volumes:1.0.0a18'
HEASERVER_ACCOUNTS_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-accounts:1.0.0a40'
...
TestCase = get_test_case_cls_default(coll=service.MONGODB_ORGANIZATION_COLLECTION,
                                     ...
                                     get_actions=[Action(name='heaserver-organizations-organization-get-properties',
                                                  ...
                                                  Action(name='heaserver-organizations-organization-get-self',
                                                         ...
                                                         rel=['self']),
                                                  Action(name='heaserver-organizations-organization-get-members',
                                                         url='http://localhost:8080/organizations/{id}/members/',
                                                         rel=['application/x.person'])
                                                  ],
