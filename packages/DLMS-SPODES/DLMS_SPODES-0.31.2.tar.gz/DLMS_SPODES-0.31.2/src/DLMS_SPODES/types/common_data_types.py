...
match settings.get_current_language():
    case settings.Language.ENGLISH: from ..Values.EN import cdt as tn, se
    case settings.Language.RUSSIAN: from ..Values.RU import cdt as tn, se
...
class Enum(SimpleDataType, ABC):
    ...
    def __init_subclass__(cls, **kwargs):
        ...
        try:
            ...
            c = dict()
        cls.ELEMENTS = {el.to_bytes(1, "big"): c.get(el, F"enum.{cls.__name__}({el})") for el in elements}
