...
class Unit(Enum):
    ...
    for par in config_parser.get_values("DLMS", "Enumerated_values_for_physical_units"):
        b_v: bytes = par["unit"].to_bytes()
        """value in bytes"""
        ELEMENTS[b_v] = par["Unit"]
        SCALERS[b_v] = par.get("scaler", 0)
