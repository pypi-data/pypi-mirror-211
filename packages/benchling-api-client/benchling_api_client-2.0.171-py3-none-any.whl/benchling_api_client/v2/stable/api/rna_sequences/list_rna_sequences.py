...
from ...models.list_rna_sequences_sort import ListRNASequencesSort
from ...models.rna_sequences_paginated_list import RnaSequencesPaginatedList
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, ListRNASequencesSort] = ListRNASequencesSort.MODIFIEDATDESC,
    ...
    url = "{}/rna-sequences".format(client.base_url)
...
) -> Optional[Union[RnaSequencesPaginatedList, BadRequestError]]:
    if response.status_code == 200:
        response_200 = RnaSequencesPaginatedList.from_dict(response.json(), strict=False)
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[RnaSequencesPaginatedList, BadRequestError]]:
    return Response(
