...
def simulate(
    ...
    """
    if rebalance:
        return simulate_with_rebalance(prices=prices, rebal_weights=weights, rebal_freq=rebal_freq)
    else:
        return simulate_without_rebalance(prices=prices, starting_weights=weights)