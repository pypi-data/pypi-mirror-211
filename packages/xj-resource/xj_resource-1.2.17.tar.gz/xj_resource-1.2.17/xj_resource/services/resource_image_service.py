...
from ..utils.custom_tool import force_transform_type, filter_fields_handler, format_params_handle
...
class ResourceImageService:
    file_fields = [i.name for i in ResourceImage._meta.fields] + ["group_id"]
    ...
    def get_list(params: dict = None):
        ...
        filter_fields = filter_fields_handler(
            ...
            all_field_list=ResourceImageService.file_fields
        )
        ...
        # 构建ORM
        list_obj = ResourceImage.objects.extra(select={
