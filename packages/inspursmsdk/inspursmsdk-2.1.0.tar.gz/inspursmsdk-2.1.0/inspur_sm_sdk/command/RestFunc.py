...
class NF5280M5_SensorDesc():
    ...
    def __init__(self):
        ...
        from inspur_sm_sdk.command.M5Log import eventLogString
        self.eventLogString = eventLogString.eventLogString

        from inspur_sm_sdk.command.M5Log import sensorSpecificEventStr
        self.sensorSpecificEventStr = sensorSpecificEventStr.sensorSpecificEventStr

        from inspur_sm_sdk.command.M5Log import biosPostEventStr
        self.biosPostEventStr = biosPostEventStr.biosPostEventStr

        from inspur_sm_sdk.command.M5Log import sensorEventStr
        self.sensorEventStr = sensorEventStr.sensorEventStr

        from inspur_sm_sdk.command.M5Log import commonInfoStr
