...
class NetworkBondBean():
    def __init__(self):
        self.dict = collections.OrderedDict()

    def BondStatus(self):
        return self.dict['BondStatus']

    def BondStatus(self, value):
        self.dict['BondStatus'] = value

    def BondMode(self):
        return self.dict['BondMode']

    def BondMode(self, value):
        self.dict['BondMode'] = value

    def BondIfc(self):
        return self.dict['BondIfc']

    def BondIfc(self, value):
        self.dict['BondIfc'] = value

    def AutoCfg(self):
        return self.dict['AutoCfg']

    def AutoCfg(self, value):
        self.dict['AutoCfg'] = value


class NetworkLinkBean():
    def __init__(self):
        self.dict = collections.OrderedDict()

    def LANInterface(self):
        return self.dict['LANInterface']

    def LANInterface(self, value):
        self.dict['LANInterface'] = value
    ...
    def AutoNegotiation(self):
        return self.dict['AutoNegotiation']

    def AutoNegotiation(self, value):
        self.dict['AutoNegotiation'] = value

    def LinkSpeed(self):
        return self.dict['LinkSpeed']

    def LinkSpeed(self, value):
        self.dict['LinkSpeed'] = value

    def DuplexMode(self):
        return self.dict['DuplexMode']

    def DuplexMode(self, value):
        self.dict['DuplexMode'] = value


class PowerConsumptionBean():
    def __init__(self):
        self.dict = collections.OrderedDict()

    def PolicyId(self):
        return self.dict['PolicyId']

    def PolicyId(self, value):
        self.dict['PolicyId'] = value

    def DomainId(self):
        return self.dict['DomainId']

    def DomainId(self, value):
        self.dict['DomainId'] = value

    def PowerLimit(self):
        return self.dict['PowerLimit']

    def PowerLimit(self, value):
        self.dict['PowerLimit'] = value

    def Suspend(self):
        return self.dict['Suspend']

    def Suspend(self, value):
        self.dict['Suspend'] = value

    def CurrentStatus(self):
        return self.dict['CurrentStatus']

    def CurrentStatus(self, value):
        self.dict['CurrentStatus'] = value
...
class SuspendBean():
    ...
    def StartTime(self):
        return self.dict['StartTime']

    def StartTime(self, value):
        self.dict['StartTime'] = value

    def EndTime(self):
        return self.dict['EndTime']

    def EndTime(self, value):
        self.dict['EndTime'] = value

    def Recurrence(self):
        return self.dict['Recurrence']

    def Recurrence(self, value):
        self.dict['Recurrence'] = value


class VirtualMediaBean():
    def __init__(self):
        self.dict = collections.OrderedDict()

    def LocalMediaSupport(self):
        return self.dict['LocalMediaSupport']

    def LocalMediaSupport(self, value):
        self.dict['LocalMediaSupport'] = value

    def RemoteMediaSupport(self):
        return self.dict['RemoteMediaSupport']

    def RemoteMediaSupport(self, value):
        self.dict['RemoteMediaSupport'] = value

    def SameSettings(self):
        return self.dict['SameSettings']

    def SameSettings(self, value):
        self.dict['SameSettings'] = value
...
class MediaDiskBean():
    ...
    def Mount(self):
        return self.dict['Mount']

    def Mount(self, value):
        self.dict['Mount'] = value
    ...
    def SourcePath(self):
        return self.dict['SourcePath']

    def SourcePath(self, value):
        self.dict['SourcePath'] = value

    def ShareType(self):
        return self.dict['ShareType']

    def ShareType(self, value):
        self.dict['ShareType'] = value

    def DmainName(self):
        return self.dict['DmainName']

    def DmainName(self, value):
        self.dict['DmainName'] = value
...
class MediaInstanceBean():
    def __init__(self):
        self.dict = collections.OrderedDict()

    def FDNum(self):
        return self.dict['FDNum']

    def FDNum(self, value):
        self.dict['FDNum'] = value

    def CDNum(self):
        return self.dict['CDNum']

    def CDNum(self, value):
        self.dict['CDNum'] = value

    def HDNum(self):
        return self.dict['HDNum']

    def HDNum(self, value):
        self.dict['HDNum'] = value

    def KVMFDNum(self):
        return self.dict['KVMFDNum']

    def KVMFDNum(self, value):
        self.dict['KVMFDNum'] = value

    def KVMCDNum(self):
        return self.dict['KVMCDNum']

    def KVMCDNum(self, value):
        self.dict['KVMCDNum'] = value

    def KVMHDNum(self):
        return self.dict['KVMHDNum']

    def KVMHDNum(self, value):
        self.dict['KVMHDNum'] = value

    def SDMedia(self):
        return self.dict['SDMedia']

    def SDMedia(self, value):
        self.dict['SDMedia'] = value

    def SecureChannel(self):
        return self.dict['SecureChannel']

    def SecureChannel(self, value):
        self.dict['SecureChannel'] = value

    def PowerSaveMode(self):
        return self.dict['PowerSaveMode']
