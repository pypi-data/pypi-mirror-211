...
class URLRules:
    ...
    def create_translator(self, page, part_translator=False, replace_links=None):
        ...
        return URLTranslator(self.rel_to_root, page, mods, self._external_dirs, replace_links)
...
class URLTranslator:
    ...
    def __init__(self, rel_to_root, page, modifiers, external_dirs, replace_links):
        self._rel_to_root = rel_to_root
        self._page = page
