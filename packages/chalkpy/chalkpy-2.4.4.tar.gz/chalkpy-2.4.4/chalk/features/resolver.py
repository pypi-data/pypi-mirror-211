...
def _explode_windowed_features(ret_val: Type[Features], inputs: List[Feature]) -> Type[Features]:
    new_features = []
...
def parse_function(
    ...
    if not is_streaming_resolver:
        ret_val = _explode_windowed_features(ret_val, inputs)
