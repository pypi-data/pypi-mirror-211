...
class ChalkClient:
    ...
    def create_branch(
        ...
        source_deployment_id
            ...
            the project page in the Chalk UI.
        environment
    ...
    def get_branches(self) -> List[str]:
        ...
        Returns
        -------
        List[str] -- A list of the names of branches available on this environment.
        """
        ...

    def get_branch(self) -> Optional[str]:
        """
        Displays the current branch this client is pointed at. If the current environment does not support branch
        deployments or no branch is set, returns None.

        Returns
        -------
        Optional[str] -- The name of the current branch, or None.
        """
        ...

    def set_branch(self, branch_name: str):
        """
        Point the Chalk client at the given branch. If the branch does not exist or if branch deployments are not
        enabled for the current environment, raises an error.
