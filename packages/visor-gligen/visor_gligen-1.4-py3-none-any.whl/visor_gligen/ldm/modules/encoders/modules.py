...
from visor_gligen.ldm.modules.x_transformer import Encoder, TransformerWrapper  # TODO: can we directly rely on lucidrains code and simply add this as a reuirement? --> test
...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    # def __init__(self, version="/apdcephfs/share_1290796/jinhengxie/pretrained/clip-vit-large-patch14", device="cuda", max_length=77):
...
if __name__ == "__main__":
    from visor_gligen.ldm.util import count_params
