"use strict";
(self["webpackChunkjupyterview"] = self["webpackChunkjupyterview"] || []).push([[294],{
...
var emotion_serialize_browser_esm = __webpack_require__(164);
...
var EmotionCacheContext = /* #__PURE__ */(0,consume_shared_module_default_react_18_2_singleton_.createContext)( // we're doing this to avoid preconstruct's dead code elimination in this one case
...
var __unsafe_useEmotionCache = function useEmotionCache() {
  return (0,consume_shared_module_default_react_18_2_singleton_.useContext)(EmotionCacheContext);
};

var withEmotionCache = function withEmotionCache(func) {
  // $FlowFixMe
  return /*#__PURE__*/(0,consume_shared_module_default_react_18_2_singleton_.forwardRef)(function (props, ref) {
    // the cache will never be null in the browser
    var cache = (0,consume_shared_module_default_react_18_2_singleton_.useContext)(EmotionCacheContext);
    return func(props, cache, ref);
  });
};

var ThemeContext = /* #__PURE__ */(0,consume_shared_module_default_react_18_2_singleton_.createContext)({});

if (false) {}

var useTheme = function useTheme() {
  return (0,consume_shared_module_default_react_18_2_singleton_.useContext)(ThemeContext);
};
...
var ThemeProvider = function ThemeProvider(props) {
  var theme = (0,consume_shared_module_default_react_18_2_singleton_.useContext)(ThemeContext);

  if (props.theme !== theme) {
    theme = createCacheWithTheme(theme)(props.theme);
  }

  return /*#__PURE__*/(0,consume_shared_module_default_react_18_2_singleton_.createElement)(ThemeContext.Provider, {
    value: theme
  }, props.children);
};
function withTheme(Component) {
  ...
  var render = function render(props, ref) {
    var theme = (0,consume_shared_module_default_react_18_2_singleton_.useContext)(ThemeContext);
    return /*#__PURE__*/(0,consume_shared_module_default_react_18_2_singleton_.createElement)(Component, (0,esm_extends/* default */.Z)({
      theme: theme,
      ref: ref
    }, props));
  }; // $FlowFixMe
  ...
  var WithTheme = /*#__PURE__*/(0,consume_shared_module_default_react_18_2_singleton_.forwardRef)(render);
...
var Emotion = /* #__PURE__ */withEmotionCache(function (props, cache, ref) {
  ...
  var serialized = (0,emotion_serialize_browser_esm/* serializeStyles */.O)(registeredStyles, undefined, (0,consume_shared_module_default_react_18_2_singleton_.useContext)(ThemeContext));
  ...
  var ele = /*#__PURE__*/(0,consume_shared_module_default_react_18_2_singleton_.createElement)(type, newProps);
  var possiblyStyleElement = /*#__PURE__*/(0,consume_shared_module_default_react_18_2_singleton_.createElement)(Noop, null);


  return /*#__PURE__*/(0,consume_shared_module_default_react_18_2_singleton_.createElement)(consume_shared_module_default_react_18_2_singleton_.Fragment, null, possiblyStyleElement, ele);
});
...
var jsx = function jsx(type, props) {
  ...
  if (props == null || !emotion_element_699e6908_browser_esm_hasOwnProperty.call(props, 'css')) {
    // $FlowFixMe
    return consume_shared_module_default_react_18_2_singleton_.createElement.apply(undefined, args);
  }
  ...
  return consume_shared_module_default_react_18_2_singleton_.createElement.apply(null, createElementArgArray);
};
...
var Global = /* #__PURE__ */withEmotionCache(function (props, cache) {
  ...
  var serialized = (0,emotion_serialize_browser_esm/* serializeStyles */.O)([styles], undefined, (0,consume_shared_module_default_react_18_2_singleton_.useContext)(ThemeContext));
  // but it is based on a constant that will never change at runtime
  // it's effectively like having two implementations and switching them out
  // so it's not actually breaking anything


  var sheetRef = (0,consume_shared_module_default_react_18_2_singleton_.useRef)();
  (0,consume_shared_module_default_react_18_2_singleton_.useLayoutEffect)(function () {
...
var ClassNames = /* #__PURE__ */withEmotionCache(function (props, cache) {
  ...
  var content = {
    css: css,
    cx: cx,
    theme: (0,consume_shared_module_default_react_18_2_singleton_.useContext)(ThemeContext)
  };
  var ele = props.children(content);
  hasRendered = true;
  var possiblyStyleElement = /*#__PURE__*/(0,consume_shared_module_default_react_18_2_singleton_.createElement)(emotion_react_browser_esm_Noop, null);
