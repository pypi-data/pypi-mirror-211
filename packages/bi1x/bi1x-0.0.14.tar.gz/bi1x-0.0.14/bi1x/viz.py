...
def record_clicks(
    ...
    def modify_doc(doc):
        ...
        if bokeh.__version__[0] < "3":
            args["view"] = bokeh.models.CDSView(source=points_source)

        renderer = p.scatter(**renderer_args)
...
def draw_rois(
    ...
    def modify_doc(doc):
        ...
        if bokeh.__version__[0] < "3":
            rendere_args["view"] = bokeh.models.CDSView(source=poly_source)
        renderer = p.patches(**renderer_args)
