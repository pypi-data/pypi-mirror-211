...
from pofinance.api.shares import *
...
class TestPDF(unittest.TestCase):
    ...
    def test_add_watermark_by_parameters(self):
        add_watermark_by_parameters(
            pdf_file=r'D:\workplace\code\github\pofinance\tests\test_files\pdf\in.pdf',
    ...
    def test_encrypt4pdf(self):
        encrypt4pdf(
            path=r'D:\workplace\code\github\pofinance\tests\test_files\pdf',
            password='123456',
