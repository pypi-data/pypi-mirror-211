...
def create_sign_list(apps, schema_editor):
    ...
    states.objects.using(db_alias).bulk_create([states(name = Values.NO_SIGN.value, sign_id = 0 , sub_action_name = Values.NO_SIGN.value),
    states(name = Values.AWAITING_SIGN_A.value, sign_id = 1 , sub_action_name = Values.SIGN_A.value),
    states(name = Values.AWAITING_SIGN_B.value, sign_id = 2 , sub_action_name = Values.SIGN_B.value),
    states(name = Values.AWAITING_SIGN_C.value, sign_id = 3 , sub_action_name = Values.SIGN_C.value)])


def create_initial_draft(apps, schema_editor):
    states = apps.get_model("finflo.States")
    db_alias = schema_editor.connection.alias
    states.objects.using(db_alias).create(description = Values.DRAFT.value)
...
def creates_default_return_Action(apps,schema_editor):
    ...
    states = apps.get_model("finflo.States")
    db_alias = schema_editor.connection.alias
    action.objects.using(db_alias).create(description = Values.RETURN.value , to_state = states.objects.get(id = 1 )  )
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('party', models.ForeignKey(blank=True, help_text='this field is optional', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_party_model', to='finflo.party')),
                ...
                ('from_party', models.ForeignKey(blank=True, help_text='this field is optional', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='from_transition_party_type', to='finflo.party')),
                ...
                ('stage_required', models.ForeignKey(blank=True, help_text='this field is optional , IMPORTANT : if NO_SIGN means initial_transition', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='finflo.signlist')),
                ('to_party', models.ForeignKey(blank=True, help_text='this field is optional', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='to_transition_party_type', to='finflo.party')),
        ...
        migrations.AddConstraint(
            model_name='action',
            constraint=models.UniqueConstraint(fields=('description', 'model', 'party'), name='unique_with_optional'),
        ),
        migrations.AddConstraint(
            model_name='action',
            constraint=models.UniqueConstraint(condition=models.Q(('party', None)), fields=('description', 'model'), name='unique_without_optional'),
        ),
