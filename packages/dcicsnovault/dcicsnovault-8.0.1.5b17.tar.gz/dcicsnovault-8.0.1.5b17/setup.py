...
package_data = \
{'': ['*'],
 'snovault': ['schemas/*', 'test_schemas/*'],
 'snovault.tests': ['data/inserts/*', 'data/master-inserts/*']}
...
['PyBrowserID>=0.10.0,<1',
 ...
 'boto3>=1.26.124,<2.0.0',
 'botocore>=1.19.124,<2.0.0',
 'dcicutils>=7.4.4.5b25,<8.0.0.0',
...
entry_points = \
{'console_scripts': ['dev-servers = snovault.dev_servers:main',
                     'list-db-tables = snovault.commands.list_db_tables:main',
                     'prepare-local-dev = '
                     'snovault.commands.prepare_template:prepare_local_dev_main',
                     'wipe-test-indices = '
