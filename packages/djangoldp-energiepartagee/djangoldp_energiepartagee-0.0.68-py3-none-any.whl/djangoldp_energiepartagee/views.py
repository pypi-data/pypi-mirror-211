...
from djangoldp_energiepartagee.models import Contribution, CONTRIBUTION_CHOICES, Actor, Relatedactor

# What about a html version ofthe view generation from a template ?
...
class ExportContributionsAll(APIView):
    ...
    def post(self, request):
        ...
        if (request.data):
            ...
            for instance in Contribution.objects.filter(year=request.data) : 
                if instance and instance.actor:
                    ...
                    print(instance.actor)
                    print(instance.actor.regionalnetwork)
                    print(instance.actor.regionalnetwork.name)
