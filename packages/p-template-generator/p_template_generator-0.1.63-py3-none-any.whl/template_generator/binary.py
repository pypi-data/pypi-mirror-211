...
def updateBin(rootDir):
    ...
    getOssResource(rootDir, "http://mecord-m.2tianxin.com/res/skymedia_20230505.zip", "c76d28231af5305639053f06a91ece50", "skymedia.zip.py")
    getOssResource(rootDir, "http://mecord-m.2tianxin.com/res/randomTemplates_20230524.zip", "986a54249851cc06e62b954a91fcdd6d", "randomTemplates.zip.py")
