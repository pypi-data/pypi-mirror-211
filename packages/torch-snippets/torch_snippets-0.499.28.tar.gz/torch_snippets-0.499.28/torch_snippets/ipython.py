...
# %% auto 0
__all__ = ['is_in_notebook', 'save_notebook', 'backup_this_notebook', 'display_dfs_side_by_side', 'show_big_dataframe', 'h1',
           'h2', 'h3', 'h4', 'h5', 'h6', 'shutdown_current_notebook']
...
def backup_this_notebook(
    ...
    if override_previous_backup:
        available_number -= 1
        if input(f'Are you sure you want to override `{save_html_to}/{stem(this_file_path)}__{available_number:04}.html` ? [y/n]').lower() != 'y':
