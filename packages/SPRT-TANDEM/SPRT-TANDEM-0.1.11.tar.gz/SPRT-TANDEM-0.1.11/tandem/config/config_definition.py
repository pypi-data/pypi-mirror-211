...
# )
DATA_PATH = pkg_resources.resource_filename("tandem", f"data/")
NUM_TRAIN = 10000  # 300000  # 25000 # 19000
NUM_VAL = 100  # 30000  # 4000 # # 990
NUM_TEST = 100  # 30000  # 1000 # 10
TRAIN_DATA = f"{DATA_PATH}train_{NUM_TRAIN}"
VAL_DATA = f"{DATA_PATH}val_{NUM_VAL}"
TEST_DATA = f"{DATA_PATH}test_{NUM_TEST}"
...
OPTIMIZATION_TARGET = "all"  # "ausat_confmx"
...
config = {
    ...
    "SPACE_IS_POSITIONAL_ENCODING": {
        "PARAM_SPACE": "categorical",
        "CATEGORY_SET": [True, False],
    },
    "SPACE_IS_TRAINABLE_ENCODING": {
        "PARAM_SPACE": "categorical",
        "CATEGORY_SET": [True, False],
    },
    "SPACE_OPTIMIZER": {
    ...
    "TRANSFORMER": {
        ...
        "SPACE_NUM_HEADS": {  # num_heads need to be a divisor of feat_dim (=embed_dim)
            "PARAM_SPACE": "int",
            "LOW": 2,
            "HIGH": 4,
            "STEP": 2,
