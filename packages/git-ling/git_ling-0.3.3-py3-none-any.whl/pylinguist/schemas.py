# Purpose: Defines the schemas for the data returned by the pylinguist API.
...
class Language(BaseModel):
    ...
    language_id: Optional[int] = None  # Integer used as a language-name-independent indexed field so that we can rename languages in pylinguist without reindexing all the code on GitHub. Must not be changed for existing languages without the explicit permission of GitHub staff.
