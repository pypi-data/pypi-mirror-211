...
"""
结构体定义: s.py 中已有结构体可直接调用，如不存在请暂时在 c.py 中定义
调用方式 s.AlarmRule()  或 c.OtherClass()
"""
...
def array_struct(struct_name, num, *args):
    ...
    #  json={'c_func_name': 'InoAlmRuleAllRead','alms_array': c.array_struct('AlarmRule',30)  # 无参数的
    #  json={'c_func_name': 'InoAlmRuleAllRead','alms_array': c.array_struct('AlarmRule',30, {'id':b'CNTEST_HCTEST_ALM2'}, {'id':b'CNTEST_HCTEST_YXALM1'}, {'id':b'CNTEST_HCTEST_YXALM2'}, {'id':b'a'})  # 有指定参数的
    #  json={'c_func_name': 'InoAlmRuleAllRead','alms_array': c.array_struct('AlarmRule',30, b'CNTEST_HCTEST_ALM2', b"a")  # 无指定参数名 顺序传参，（结构体字段顺序）
    #  json={'c_func_name': 'InoAlmRuleAllRead','alms_array': c.array_struct('AlarmRule',30, (b'CNTEST_HCTEST_ALM2', b'YXCJ2'), (b"a", b'x'))  # 批量tuple 无指定参数名 顺序传参，（结构体字段顺序）
    #  json={'c_func_name': 'InoAlmRuleAllRead','alms_array': c.array_struct('AlarmRule',30, [b'CNTEST_HCTEST_ALM2', b'YXCJ2'], [b"a", b'x'])  # 批量list 无指定参数名 顺序传参，（结构体字段顺序）
