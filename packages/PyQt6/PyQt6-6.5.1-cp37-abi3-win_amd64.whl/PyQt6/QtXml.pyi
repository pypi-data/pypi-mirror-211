...
class QDomDocument(QDomNode):
    ...
    @typing.overload
    def setContent(self, reader: QtCore.QXmlStreamReader, options: 'QDomDocument.ParseOption' = ...) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
    def setContent(self, device: QtCore.QIODevice, options: 'QDomDocument.ParseOption' = ...) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
    def setContent(self, data: typing.Union[QtCore.QByteArray, str], options: 'QDomDocument.ParseOption' = ...) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
