...
class QOpenGLFunctions_2_0(QAbstractOpenGLFunctions):
    ...
    def glVertexAttrib4Nub(self, index: int, x: bytes, y: bytes, z: bytes, w: bytes) -> None: ...
    ...
    def glSecondaryColor3b(self, red: bytes, green: bytes, blue: bytes) -> None: ...
    ...
    def glSecondaryColor3ub(self, red: bytes, green: bytes, blue: bytes) -> None: ...
    ...
    def glHistogram(self, target: int, width: int, internalformat: int, sink: bytes) -> None: ...
    def glMinmax(self, target: int, internalformat: int, sink: bytes) -> None: ...
    ...
    def glColor3b(self, red: bytes, green: bytes, blue: bytes) -> None: ...
    ...
    def glColor3ub(self, red: bytes, green: bytes, blue: bytes) -> None: ...
    ...
    def glColor4b(self, red: bytes, green: bytes, blue: bytes, alpha: bytes) -> None: ...
    ...
    def glColor4ub(self, red: bytes, green: bytes, blue: bytes, alpha: bytes) -> None: ...
    ...
    def glEdgeFlag(self, flag: bytes) -> None: ...
    ...
    def glNormal3b(self, nx: bytes, ny: bytes, nz: bytes) -> None: ...
    ...
    def glIsList(self, list: int) -> bytes: ...
    ...
    def glIsProgram(self, program: int) -> bytes: ...
    def glIsShader(self, shader: int) -> bytes: ...
    ...
    def glUniformMatrix2fv(self, location: int, count: int, transpose: bytes, value: PYQT_OPENGL_ARRAY) -> None: ...
    def glUniformMatrix3fv(self, location: int, count: int, transpose: bytes, value: PYQT_OPENGL_ARRAY) -> None: ...
    def glUniformMatrix4fv(self, location: int, count: int, transpose: bytes, value: PYQT_OPENGL_ARRAY) -> None: ...
    def glValidateProgram(self, program: int) -> None: ...
    def glVertexAttribPointer(self, index: int, size: int, type: int, normalized: bytes, stride: int, pointer: PYQT_OPENGL_BOUND_ARRAY) -> None: ...
    def glGenQueries(self, n: int) -> typing.Union[int, typing.Tuple[int, ...]]: ...
    def glDeleteQueries(self, n: int, ids: PYQT_OPENGL_ARRAY) -> None: ...
    def glIsQuery(self, id: int) -> bytes: ...
    ...
    def glIsBuffer(self, buffer: int) -> bytes: ...
    ...
    def glUnmapBuffer(self, target: int) -> bytes: ...
    ...
    def glSampleCoverage(self, value: float, invert: bytes) -> None: ...
    ...
    def glIsTexture(self, texture: int) -> bytes: ...
    def glIndexub(self, c: bytes) -> None: ...
    ...
    def glColorMask(self, red: bytes, green: bytes, blue: bytes, alpha: bytes) -> None: ...
    def glDepthMask(self, flag: bytes) -> None: ...
    ...
    def glIsEnabled(self, cap: int) -> bytes: ...
...
class QOpenGLFunctions_4_1_Core(QAbstractOpenGLFunctions):
    ...
    def glIsProgramPipeline(self, pipeline: int) -> bytes: ...
    ...
    def glIsTransformFeedback(self, id: int) -> bytes: ...
    ...
    def glIsSampler(self, sampler: int) -> bytes: ...
    ...
    def glVertexAttribP1ui(self, index: int, type: int, normalized: bytes, value: int) -> None: ...
    def glVertexAttribP2ui(self, index: int, type: int, normalized: bytes, value: int) -> None: ...
    def glVertexAttribP3ui(self, index: int, type: int, normalized: bytes, value: int) -> None: ...
    def glVertexAttribP4ui(self, index: int, type: int, normalized: bytes, value: int) -> None: ...
    ...
    def glTexImage2DMultisample(self, target: int, samples: int, internalformat: int, width: int, height: int, fixedsamplelocations: bytes) -> None: ...
    def glTexImage3DMultisample(self, target: int, samples: int, internalformat: int, width: int, height: int, depth: int, fixedsamplelocations: bytes) -> None: ...
    ...
    def glColorMaski(self, index: int, r: bytes, g: bytes, b: bytes, a: bytes) -> None: ...
    def glEnablei(self, target: int, index: int) -> None: ...
    def glDisablei(self, target: int, index: int) -> None: ...
    def glIsEnabledi(self, target: int, index: int) -> bytes: ...
    ...
    def glIsRenderbuffer(self, renderbuffer: int) -> bytes: ...
    ...
    def glIsFramebuffer(self, framebuffer: int) -> bytes: ...
    ...
    def glIsVertexArray(self, array: int) -> bytes: ...
    def glBlendEquationSeparate(self, modeRGB: int, modeAlpha: int) -> None: ...
    def glDrawBuffers(self, n: int, bufs: PYQT_OPENGL_ARRAY) -> None: ...
    def glStencilOpSeparate(self, face: int, sfail: int, dpfail: int, dppass: int) -> None: ...
    def glStencilFuncSeparate(self, face: int, func: int, ref: int, mask: int) -> None: ...
