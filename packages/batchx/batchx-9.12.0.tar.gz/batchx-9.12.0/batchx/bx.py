...
class JobService:
    ...
    def Run(self, submit_request, logs_enabled=True):
        ...
        request_stream = self.StreamRequest(environment=submit_request.environment, job_id=submit_response.job_id, logs_enabled=logs_enabled)
