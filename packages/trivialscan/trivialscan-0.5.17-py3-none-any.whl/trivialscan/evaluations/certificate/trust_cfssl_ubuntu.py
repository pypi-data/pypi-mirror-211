...
class EvaluationTask(BaseEvaluationTask):
    ...
    def evaluate(self, certificate: BaseCertificate) -> Union[bool, None]:
        ...
        self.substitution_metadata["root_store_name"] = context.CFSSL_UBUNTU
        ...
        self.substitution_metadata["short_name"] = context.SHORT_LOOKUP.get(
            context.CFSSL_UBUNTU, context.CFSSL_UBUNTU
        )
        try:
            self.substitution_metadata["exists_in_store"] = store.exists(
                context_type=context.PLATFORM_CFSSL_UBUNTU
            )
        ...
        return store.check_trust(context_type=context.PLATFORM_CFSSL_UBUNTU)
