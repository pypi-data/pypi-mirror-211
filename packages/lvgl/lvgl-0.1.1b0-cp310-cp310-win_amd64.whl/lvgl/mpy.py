...
class gd_GIF(_lvgl.gd_GIF):
    ...
    def application_xcb_t(self, id: "List", auth: "List") -> None:
...
class style_t(_lvgl.style_t):
    ...
    def set_grid_row_dsc_array(self, value: "List") -> None:
        return _lvgl.style_set_grid_row_dsc_array(self, value)

    def set_grid_column_dsc_array(self, value: "List") -> None:
...
class draw_ctx_t(_lvgl.draw_ctx_t):
    ...
    def polygon(self, draw_dsc: "draw_rect_dsc_t", points: "List", point_cnt: _lvgl.uint16_t) -> None:
        return _lvgl.draw_polygon(self, draw_dsc, points, point_cnt)

    def triangle(self, draw_dsc: "draw_rect_dsc_t", points: "List") -> None:
...
class obj(_lvgl.obj_t):
    ...
    def set_style_grid_row_dsc_array(self, value: "List", selector: _lvgl.style_selector_t) -> None:
        return _lvgl.obj_set_style_grid_row_dsc_array(self, value, selector)

    def set_style_grid_column_dsc_array(self, value: "List", selector: _lvgl.style_selector_t) -> None:
...
class animimg(obj):
    ...
    def set_src(self, dsc: "List", num: _lvgl.uint8_t) -> None:
...
class calendar(obj):
    ...
    def set_highlighted_dates(self, highlighted: "List", date_num: _lvgl.uint16_t) -> None:
...
class canvas(obj):
    ...
    def draw_line(self, points: "List", point_cnt: _lvgl.uint32_t, draw_dsc: "draw_line_dsc_t") -> None:
        return _lvgl.canvas_draw_line(self, points, point_cnt, draw_dsc)

    def draw_polygon(self, points: "List", point_cnt: _lvgl.uint32_t, draw_dsc: "draw_rect_dsc_t") -> None:
...
class chart(obj):
    ...
    def set_ext_y_array(self, ser: _lvgl.chart_series_t, array: "List") -> None:
        return _lvgl.chart_set_ext_y_array(self, ser, array)

    def set_ext_x_array(self, ser: _lvgl.chart_series_t, array: "List") -> None:
...
class line(obj):
    ...
    def set_points(self, points: "List", point_num: _lvgl.uint16_t) -> None:
...
class msgbox(obj):
    ...
    def __init__(self, parent: _lvgl.obj_t, title: _lvgl.char, txt: _lvgl.char, btn_txts: _lvgl.List, add_close_btn: _lvgl._Bool):
        if self.__class__.__name__ == 'obj':
            super().__init__()
        else:
            super().__init__(_lvgl._DefaultArg)  # NOQA
