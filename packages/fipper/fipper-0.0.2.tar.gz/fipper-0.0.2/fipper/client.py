...
from fipper.storage import FileStorage, MemoryStorage
...
class Client(Methods):
    ...
    Parameters:
        ...
        end_client (``int`` | ``str``, *optional*):
            The *end_client* Disconnect of the Client in the Month, as integer or string.
            E.g.: 1 or "1".
    ...
    APP_VERSION = f"PyrogramXd {__version__}"
    ...
    def __init__(
        ...
        self.end_client = int(end_client) if end_client else None
    ...
    def endclient(
        ...
        # This loop will continue until the stop time is reached
            pass

        # Stop the client once the stop time is reached
        self.stop()
