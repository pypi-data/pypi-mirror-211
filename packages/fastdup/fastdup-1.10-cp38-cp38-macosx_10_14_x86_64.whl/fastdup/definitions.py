...
SUPPORTED_IMG_FORMATS = [".png", ".jpg", ".jpeg", ".giff", ".jpeg", ".tif", ".heic", ".heif", ".bmp", ".webp"]
...
CLIP_MODEL = "https://clip-as-service.s3.us-east-2.amazonaws.com/models/onnx/ViT-B-32/visual.onnx"
CLIP_MODEL_DIM = 512
CLIP_MODEL2 = "https://clip-as-service.s3.us-east-2.amazonaws.com/models/onnx/ViT-L-14@336px/visual.onnx"
CLIP_MODEL2_DIM = 768
