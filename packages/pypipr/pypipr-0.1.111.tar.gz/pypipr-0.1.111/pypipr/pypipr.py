...
# serialize()
__serialize__modul__ = {
    "yaml": yaml.dump,
    "json": json.dumps,
    "html": lambda x: serialize_to_html(x),
    # "jsonl": jsonlines.dump,
}
...
def serialize(data, syntax="yaml"):
    """
    ...
    return __serialize__modul__[syntax](data)
...
def serialize_to_html(data, indent=4):
    """
