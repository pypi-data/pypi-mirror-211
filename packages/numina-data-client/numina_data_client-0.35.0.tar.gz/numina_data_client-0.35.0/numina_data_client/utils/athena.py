...
ATHENA_DATABASE_CLEAN = "numina_data_lake_v20230509_prod"
ATHENA_WORKGROUP = "data-science"


def query_athena(
    query: str, database: str = ATHENA_DATABASE, workgroup: str = ATHENA_WORKGROUP
):
...
def query_tracks(
    ...
    # TODO remove this once we switch over to the new data lake
    athena_db = ATHENA_DATABASE
    if not query_raw_tracks:
        athena_db = ATHENA_DATABASE_CLEAN
