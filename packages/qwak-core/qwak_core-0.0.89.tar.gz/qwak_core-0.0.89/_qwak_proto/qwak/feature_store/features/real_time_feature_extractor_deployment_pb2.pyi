...
class KubernetesExtractorDeploymentState(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deployment_id", b"deployment_id", "environment_id", b"environment_id", "extractor_id", b"extractor_id", "featureset_id", b"featureset_id", "status", b"status", "status_details", b"status_details"]) -> None: ...
