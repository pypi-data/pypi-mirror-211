...
class BuildProperties(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["branch", b"branch", "build_id", b"build_id", "model_id", b"model_id", "model_uri", b"model_uri", "tags", b"tags"]) -> None: ...
