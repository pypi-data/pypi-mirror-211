...
NOW_GATEWAY_VERSION = '0.0.7-fix-remove-sbert-4'
NOW_PREPROCESSOR_VERSION = '0.0.128-executor-image-build-1'
NOW_ELASTIC_INDEXER_VERSION = '0.0.151-executor-image-build-1'
...
class FolderStructure(BetterEnum):
...
JCLOUD_PHASES = 'Pending,Starting,Serving,Failed,Updating,Paused'
