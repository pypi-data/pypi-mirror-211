...
def get_reload_weight(model_path, model, pth='ckpt_max.pth'):
    ...
    # print("Keys in model state_dict but not in pretrained state_dict:")
    # missing_in_model, missing_in_pretrained = compare_dicts(model.state_dict(), pretrain_dict)
    # print(missing_in_pretrained)
    #
    # print("Keys in pretrained state_dict but not in model state_dict:")
