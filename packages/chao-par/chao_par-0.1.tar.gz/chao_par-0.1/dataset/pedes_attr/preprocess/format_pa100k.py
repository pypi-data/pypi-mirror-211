...
def generate_data_description(save_dir, reorder):
    """
    create a dataset description file(pkl file), which consists of images, labels
    """
    with zipfile.ZipFile(r'\Users\licha\Desktop\行人分析数据集\PA100K\annotation.zip', 'r') as zfile:
        with zfile.open('annotation.mat') as mat:
            pa100k_data = loadmat(mat)
    ...
    with open(os.path.join(r'C:\Users\licha\PycharmProjects\attribute-based_retrieval\data\PA100K', 'dataset_all.pkl'), 'wb+') as f:
        pickle.dump(dataset, f)


if __name__ == "__main__":
    save_dir = r'C:\Users\licha\Desktop\行人分析数据集\PA100K'
