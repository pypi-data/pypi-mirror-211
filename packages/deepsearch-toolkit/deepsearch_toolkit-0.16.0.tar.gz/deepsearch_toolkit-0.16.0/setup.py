...
['deepsearch',
 ...
 'deepsearch.model.examples.minimal_annotator',
 'deepsearch.model.examples.simple_text_geography_annotator',
 'deepsearch.model.examples.simple_text_geography_annotator.entities',
 'deepsearch.model.examples.simple_text_geography_annotator.entities.common',
 'deepsearch.model.examples.simple_text_geography_annotator.relationships',
 'deepsearch.model.examples.simple_text_geography_annotator.relationships.common',
...
package_data = \
{'': ['*'],
 'deepsearch.model.examples.simple_text_geography_annotator': ['resources/*']}
...
extras_require = \
{'all': ['fastapi>=0.95.1,<0.96.0',
         'uvicorn>=0.21.1,<0.22.0',
         'anyio>=3.6.2,<4.0.0',
         'starlette>=0.26.1,<0.27.0'],
 'api': ['fastapi>=0.95.1,<0.96.0',
         'uvicorn>=0.21.1,<0.22.0',
         'anyio>=3.6.2,<4.0.0',
         'starlette>=0.26.1,<0.27.0']}
