...
if TYPE_CHECKING:
    from ........models import artifact_reference, error

class ReferencesRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/groups/{groupId}/artifacts/{artifactId}/versions/{version}/references{?refType*}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def get(self,request_configuration: Optional[ReferencesRequestBuilderGetRequestConfiguration] = None) -> Optional[List[artifact_reference.ArtifactReference]]:
        """
        ...
        from ........models import artifact_reference

        return await self.request_adapter.send_collection_async(request_info, artifact_reference.ArtifactReference, error_mapping)
    ...
    @dataclass
    class ReferencesRequestBuilderGetRequestConfiguration():
        """
