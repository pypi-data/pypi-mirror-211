...
if TYPE_CHECKING:
    from ...models import artifact_search_results, error
...
class ArtifactsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/search/artifacts{?name*,offset*,limit*,order*,orderby*,labels*,properties*,description*,group*,globalId*,contentId*,canonical*,artifactType*,offset*,limit*,order*,orderby*}"
    ...
    async def post(self,body: bytes, request_configuration: Optional[ArtifactsRequestBuilderPostRequestConfiguration] = None) -> Optional[artifact_search_results.ArtifactSearchResults]:
        """
