...
if TYPE_CHECKING:
    from .....models import configuration_property, error, update_configuration_property

class WithPropertyNameItemRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/config/properties/{propertyName}"
    ...
    async def get(self,request_configuration: Optional[WithPropertyNameItemRequestBuilderGetRequestConfiguration] = None) -> Optional[configuration_property.ConfigurationProperty]:
        """
        ...
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[configuration_property.ConfigurationProperty]
        """
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from .....models import configuration_property

        return await self.request_adapter.send_async(request_info, configuration_property.ConfigurationProperty, error_mapping)
    
    async def put(self,body: Optional[update_configuration_property.UpdateConfigurationProperty] = None, request_configuration: Optional[WithPropertyNameItemRequestBuilderPutRequestConfiguration] = None) -> None:
        """
    ...
    def to_put_request_information(self,body: Optional[update_configuration_property.UpdateConfigurationProperty] = None, request_configuration: Optional[WithPropertyNameItemRequestBuilderPutRequestConfiguration] = None) -> RequestInformation:
        """
        Updates the value of a single configuration property.This operation may fail for one of the following reasons:* Property not found or not configured (HTTP error `404`)* A server error occurred (HTTP error `500`)
        Args:
            body: The request body
    ...
    @dataclass
    class WithPropertyNameItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class WithPropertyNameItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class WithPropertyNameItemRequestBuilderPutRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
