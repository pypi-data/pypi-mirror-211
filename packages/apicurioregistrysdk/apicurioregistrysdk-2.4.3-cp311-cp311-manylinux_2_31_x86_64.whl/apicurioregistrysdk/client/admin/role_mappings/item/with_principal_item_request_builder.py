...
if TYPE_CHECKING:
    from ....models import error, role_mapping, update_role

class WithPrincipalItemRequestBuilder():
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/roleMappings/{principalId}"
    ...
    async def get(self,request_configuration: Optional[WithPrincipalItemRequestBuilderGetRequestConfiguration] = None) -> Optional[role_mapping.RoleMapping]:
        """
        ...
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[role_mapping.RoleMapping]
        """
        ...
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from ....models import role_mapping

        return await self.request_adapter.send_async(request_info, role_mapping.RoleMapping, error_mapping)
    
    async def put(self,body: Optional[update_role.UpdateRole] = None, request_configuration: Optional[WithPrincipalItemRequestBuilderPutRequestConfiguration] = None) -> None:
        """
    ...
    def to_put_request_information(self,body: Optional[update_role.UpdateRole] = None, request_configuration: Optional[WithPrincipalItemRequestBuilderPutRequestConfiguration] = None) -> RequestInformation:
        """
        Updates a single role mapping for one user/principal.This operation can fail for the following reasons:* No role mapping for the principalId exists (HTTP error `404`)* A server error occurred (HTTP error `500`)
        Args:
            body: The request body
    ...
    @dataclass
    class WithPrincipalItemRequestBuilderDeleteRequestConfiguration():
        """
    ...
    @dataclass
    class WithPrincipalItemRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
    ...
    @dataclass
    class WithPrincipalItemRequestBuilderPutRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
