...
if TYPE_CHECKING:
    from ...models import download_ref, error
...
class ExportRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/admin/export{?forBrowser*}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def get(self,request_configuration: Optional[ExportRequestBuilderGetRequestConfiguration] = None) -> Optional[download_ref.DownloadRef]:
        """
        Exports registry data as a ZIP archive.
        Args:
            requestConfiguration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[download_ref.DownloadRef]
        """
        ...
        from ...models import download_ref

        return await self.request_adapter.send_async(request_info, download_ref.DownloadRef, error_mapping)
    ...
    class ExportRequestBuilderGetQueryParameters():
        ...
        for_browser: Optional[bool] = None
