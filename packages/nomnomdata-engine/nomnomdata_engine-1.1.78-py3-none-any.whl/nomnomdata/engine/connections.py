...
FacebookMarketingConnection = Connection(
    connection_type_uuid="FBADS-IDSTK",
    alias="Facebook:Marketing",
    description="Facebook Marketing Credentials",
    categories=["facebook", "credentials", "marketing", "ads"],
    parameter_groups=[
        ParameterGroup(
            Parameter(
                type=String(),
            ...
            Parameter(
                type=Password(),
                name="access_token",
                display_name="Access Token. Valid for 2 months.",
                required=True,
            ),
            name="facebook_marketing_connection",
            display_name="Facebook Marketing Parameters",
        ),
    ],
)
