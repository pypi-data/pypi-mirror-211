...
class SVGConvertOptions(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SVGConvertOptions, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SVGConvertOptions, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = _PDFNetPython.new_SVGConvertOptions()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
SVGConvertOptions_swigregister = _PDFNetPython.SVGConvertOptions_swigregister
SVGConvertOptions_swigregister(SVGConvertOptions)

class DataExtractionOptions(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, DataExtractionOptions, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, DataExtractionOptions, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = _PDFNetPython.new_DataExtractionOptions()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
DataExtractionOptions_swigregister = _PDFNetPython.DataExtractionOptions_swigregister
DataExtractionOptions_swigregister(DataExtractionOptions)
...
class Convert(_object):
    ...
    if _newclass:
        FromSVG = staticmethod(_PDFNetPython.Convert_FromSVG)
    else:
        FromSVG = _PDFNetPython.Convert_FromSVG
    if _newclass:
...
Convert_FromSVG = _PDFNetPython.Convert_FromSVG
...
class DataExtractionModule(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, DataExtractionModule, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, DataExtractionModule, name)
    __repr__ = _swig_repr
    ...
    if _newclass:
        IsModuleAvailable = staticmethod(_PDFNetPython.DataExtractionModule_IsModuleAvailable)
    else:
        IsModuleAvailable = _PDFNetPython.DataExtractionModule_IsModuleAvailable
    if _newclass:
        ExtractData = staticmethod(_PDFNetPython.DataExtractionModule_ExtractData)
    else:
        ExtractData = _PDFNetPython.DataExtractionModule_ExtractData
    if _newclass:
        ExtractToXLSX = staticmethod(_PDFNetPython.DataExtractionModule_ExtractToXLSX)
    else:
        ExtractToXLSX = _PDFNetPython.DataExtractionModule_ExtractToXLSX

    def __init__(self):
        this = _PDFNetPython.new_DataExtractionModule()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
DataExtractionModule_swigregister = _PDFNetPython.DataExtractionModule_swigregister
DataExtractionModule_swigregister(DataExtractionModule)

def DataExtractionModule_IsModuleAvailable(engine):
    return _PDFNetPython.DataExtractionModule_IsModuleAvailable(engine)
DataExtractionModule_IsModuleAvailable = _PDFNetPython.DataExtractionModule_IsModuleAvailable

def DataExtractionModule_ExtractData(*args):
    return _PDFNetPython.DataExtractionModule_ExtractData(*args)
DataExtractionModule_ExtractData = _PDFNetPython.DataExtractionModule_ExtractData

def DataExtractionModule_ExtractToXLSX(*args):
    return _PDFNetPython.DataExtractionModule_ExtractToXLSX(*args)
DataExtractionModule_ExtractToXLSX = _PDFNetPython.DataExtractionModule_ExtractToXLSX
