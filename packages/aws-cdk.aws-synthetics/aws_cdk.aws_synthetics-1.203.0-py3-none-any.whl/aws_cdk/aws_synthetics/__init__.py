...
class CfnCanary(
    ...
    def __init__(
        ...
        *,
        ...
        start_canary_after_creation: typing.Union[builtins.bool, _aws_cdk_core_f4b25747.IResolvable],
    ...
    def start_canary_after_creation(
        ...
        '''
        return typing.cast(typing.Union[builtins.bool, _aws_cdk_core_f4b25747.IResolvable], jsii.get(self, "startCanaryAfterCreation"))
