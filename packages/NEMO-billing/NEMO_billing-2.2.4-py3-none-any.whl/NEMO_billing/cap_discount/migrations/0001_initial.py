...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('rate_category', 'core_facility'), name='cap_discount_capdiscountconfiguration_unique_rate_category_facility'),
        ),
        migrations.AddConstraint(
            model_name='capdiscountconfiguration',
            constraint=models.UniqueConstraint(condition=models.Q(('core_facility', None)), fields=('rate_category',), name='cap_discount_capdiscountconfiguration_unique_rate_category_null_facility'),
        ),
    ]
