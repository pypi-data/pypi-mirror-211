...
[![PyPI version shields.io](https://img.shields.io/pypi/v/vqa-cimod.svg)](https://pypi.python.org/pypi/vqa-cimod/)
[![PyPI pyversions](https://img.shields.io/pypi/pyversions/vqa-cimod.svg)](https://pypi.python.org/pypi/vqa-cimod/)
[![PyPI implementation](https://img.shields.io/pypi/implementation/vqa-cimod.svg)](https://pypi.python.org/pypi/ji-cimod/)
[![PyPI format](https://img.shields.io/pypi/format/vqa-cimod.svg)](https://pypi.python.org/pypi/vqa-cimod/)
[![PyPI license](https://img.shields.io/pypi/l/vqa-cimod.svg)](https://pypi.python.org/pypi/vqa-cimod/)
[![PyPI download month](https://img.shields.io/pypi/dm/vqa-cimod.svg)](https://pypi.python.org/pypi/vqa-cimod/)
[![Downloads](https://pepy.tech/badge/vqa-cimod)](https://pepy.tech/project/vqa-cimod)
...
```sh
# Binary
$ pip install vqa-cimod
# From Source 
$ pip install --no-binary=vqa-cimod vqa-cimod 
```
