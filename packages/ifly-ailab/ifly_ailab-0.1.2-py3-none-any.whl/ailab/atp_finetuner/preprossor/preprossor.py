...
class AILabPreprocessor(ABC) :
    ...
    @classmethod
    def from_pretrained(cls, task:Task, model_name:Model, dataset: AILabDataset,**kwargs) :
        ...
        return auto_preprocessor.build_preprocessor(model_name, dataset, **kwargs)
    
    @abstractmethod
    def forward(self) ->AILabDataset:
        pass
