...
from db.base.models import Artifact, DemodData, ExportedFrameset, LatestTleSet, Mode, Operator, \
    OpticalIdentification, OpticalObservation, Satellite, SatelliteEntry, SatelliteIdentifier, \
    SatelliteSuggestion, Telemetry, Tle, Transmitter, TransmitterEntry, TransmitterSuggestion
