...
def toDegrees(col: "ColumnOrName") -> Column:
    ...
    DeprecatedFuncUsageLogger().log_deprecated(
        "def toDegrees(col)", "python/pyspark/sql/functions.py"
    )
...
def toRadians(col: "ColumnOrName") -> Column:
    ...
    """
    DeprecatedFuncUsageLogger().log_deprecated(
        "def toRadians(col)", "python/pyspark/sql/functions.py"
    )
...
def approxCountDistinct(col: "ColumnOrName", rsd: Optional[float] = None) -> Column:
    ...
    """
    DeprecatedFuncUsageLogger().log_deprecated(
        "def approxCountDistinct(col, rsd=None)", "python/pyspark/sql/functions.py"
    )
