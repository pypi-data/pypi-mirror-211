...
class Catalog:
    ...
    def createExternalTable(
        ...
        **options: str,
        ...
        DeprecatedFuncUsageLogger().log_deprecated(
            "def createExternalTable(self, tableName, path=None, source=None, schema=None,"
            " **options)",
    ...
    def registerFunction(
        ...
        """
        DeprecatedFuncUsageLogger().log_deprecated(
            "def registerFunction(self, name, f, returnType=None)", "python/pyspark/sql/catalog.py"
        )
