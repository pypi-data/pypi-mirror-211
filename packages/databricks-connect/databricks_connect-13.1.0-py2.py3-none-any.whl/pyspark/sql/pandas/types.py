...
def to_arrow_schema(schema: StructType) -> "pa.Schema":
    ...
    for field in schema:
        try:
            ...
            raise PySparkTypeError(
                "Unable to convert the field {}. If this column is not necessary, "
                "you may consider dropping it or converting to primitive type "
                "before the conversion.".format(field.name)
            ) from e
