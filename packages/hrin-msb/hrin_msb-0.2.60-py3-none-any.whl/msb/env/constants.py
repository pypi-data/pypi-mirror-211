...
class NameConst:
	...
	CONF_SERVICE_NAME = 'CONF_SERVICE'
...
class PathConst:
	...
	BASE_DIR_PATH = Path(
		Path.cwd().__str__().replace(NameConst.RESOURCES_DIR_NAME, NameConst.APP_DIR_NAME)
...
__all__ = [
	"NameConst", "PathConst", "EnvDefaults", "MsbConfigNames",
]
