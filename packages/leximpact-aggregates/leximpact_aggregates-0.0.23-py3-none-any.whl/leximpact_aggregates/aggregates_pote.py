...
__all__ = [
    ...
    "perimeter",
    "year",
    "liste_des_variables_revenus_2020",
    "liste_des_variables_csg_2020",
    "pote",
    "aggregates_from_csv",
    "agm",
    "pote_var_to_dict",
...
csv_pote_extractions_folder = (
    "/mnt/data-in/casd_extract/pote/20230516-ExtractionPOTE_reductions_credits/data/"
)
calib_copulas_and_quantile_folder = (
...
metadata["rnimjw"] = {
    ...
    "openfisca_variable": "credits_impot",
}
...
liste_des_variables_revenus_2020 = pd.read_csv(
    csv_pote_extractions_folder + "/agregats_POTE_revenus_rici_2020.csv"
)
liste_des_variables_csg_2020 = pd.read_csv(
    csv_pote_extractions_folder + "/agregats_POTE_2020.csv"
)
...
# %% ../notebooks/aggregates_from_pote.ipynb 66
agm = AggregateManager()
agm.load_aggregate("POTE", "rfr", year, str(DataStructure.COPULAS_100))
