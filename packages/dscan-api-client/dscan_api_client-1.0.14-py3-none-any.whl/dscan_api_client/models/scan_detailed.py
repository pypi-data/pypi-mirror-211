...
class ScanDetailed:
    ...
    Attributes:
        ...
        task_ongoing_or_failed (Task):
        task_not_finished_count (int):
        task_success_count (int):
        name (str):
        status (StatusEnum): * `0` - Just Added - Will be Scheduled Soon
            * `1` - Scheduled/Started Enum Phase
            * `2` - Ready for HTTPX
            * `3` - HTTPX Started/Ongoing
            * `4` - Ready for Nuclei
            * `5` - Nuclei Started
            * `6` - Scan Finished
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        task_ongoing_or_failed = self.task_ongoing_or_failed.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        task_ongoing_or_failed = Task.from_dict(d.pop("task_ongoing_or_failed"))
