...
def log_state(available_game_variables, available_buttons, state):
    """
    Write the state of the game to a file called 'state.txt'.
    
    :param available_game_variables: A list of game variables.
    :type available_game_variables: list
    
    :param available_buttons: A list of buttons.
    :type available_buttons: list
    ...
    with open("state.txt", "a", encoding="utf-8") as f:
        f.write(str(available_game_variables) + "\n")
        f.write(str(available_buttons) + "\n")
        f.write(str(state) + "\n")
...
def main():
    ...
    for i in range(episodes):
        ...
        while not game.is_episode_finished():
            ...
            log_state(game, actions, sleep_time)
