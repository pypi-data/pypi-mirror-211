...
from nerualpha.providers.messages.contracts.IMessengerFileMessage import IMessengerFileMessage
from nerualpha.providers.messages.contracts.IURLPayload import IURLPayload

@dataclass
class MessengerFileMessage(IMessengerFileMessage):
    from_: str
    to: str
    file: IURLPayload
    message_type: str = field(default = "file")
