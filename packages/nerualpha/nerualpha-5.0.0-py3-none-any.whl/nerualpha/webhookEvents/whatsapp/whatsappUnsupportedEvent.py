...
from nerualpha.webhookEvents.whatsapp.IWhatsappUnsupportedEvent import IWhatsappUnsupportedEvent

@dataclass
class WhatsappUnsupportedEvent(IWhatsappUnsupportedEvent):
    to: str
    timestamp: str
    message_uuid: str
    from_: str
