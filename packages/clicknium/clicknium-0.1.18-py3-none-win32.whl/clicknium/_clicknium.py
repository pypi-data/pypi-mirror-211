...
class _Clicknium():
    ...
    def is_existing(
        ...
        """        
        result = _InvokerService.is_existing(locator, locator_variables, timeout)
        return True if result else False    
    ...
    def scrape_data(
        ...
        """        
        result = _InvokerService.scrape_data(locator, locator_variables, next_page_button_locator, next_page_button_locator_variables, next_page_button_by, wait_page_load_time, max_count, timeout)
