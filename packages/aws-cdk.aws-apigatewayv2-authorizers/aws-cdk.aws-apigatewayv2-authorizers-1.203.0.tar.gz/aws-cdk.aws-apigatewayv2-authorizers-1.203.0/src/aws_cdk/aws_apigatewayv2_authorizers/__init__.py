...
@jsii.implements(_aws_cdk_aws_apigatewayv2_4b54cf3e.IHttpRouteAuthorizer)
class HttpIamAuthorizer(
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-cdk/aws-apigatewayv2-authorizers.HttpIamAuthorizer",
):
    ...
    def bind(
        ...
        *,
    ...
    ) -> _aws_cdk_aws_apigatewayv2_4b54cf3e.HttpRouteAuthorizerConfig:
        ...
        :stability: experimental
        '''
        _options = _aws_cdk_aws_apigatewayv2_4b54cf3e.HttpRouteAuthorizerBindOptions(
            route=route, scope=scope
        )

        return typing.cast(_aws_cdk_aws_apigatewayv2_4b54cf3e.HttpRouteAuthorizerConfig, jsii.invoke(self, "bind", [_options]))
...
class HttpJwtAuthorizer(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1e7937476312b23cc3a040c6e1a29b01ad6d8660d717a8b6612ebdb2368acd30)
    ...
    def bind(
        ...
        *,
        ...
        :stability: experimental
        '''
        options = _aws_cdk_aws_apigatewayv2_4b54cf3e.HttpRouteAuthorizerBindOptions(
            route=route, scope=scope
        )

        return typing.cast(_aws_cdk_aws_apigatewayv2_4b54cf3e.HttpRouteAuthorizerConfig, jsii.invoke(self, "bind", [options]))
...
class HttpJwtAuthorizerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__006bc46199bd8f5bb1842b02f0c941a543dfe861675fcbf7f8838053ddcc040e)
...
class HttpLambdaAuthorizer(
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-cdk/aws-apigatewayv2-authorizers.HttpLambdaAuthorizer",
):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__82934c32235b183e7e4cd56cb4ac2a009724a32d8ae6d1e947b4360ff2385ef3)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-apigatewayv2-authorizers.HttpLambdaAuthorizerProps",
    jsii_struct_bases=[],
    name_mapping={
        "authorizer_name": "authorizerName",
        "identity_source": "identitySource",
...
class HttpLambdaAuthorizerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2db0a9c5ba6693767a87ac6d0b36748a12b521e7f7f29ddf7d2fb8e1e8120611)
            check_type(argname="argument authorizer_name", value=authorizer_name, expected_type=type_hints["authorizer_name"])
            check_type(argname="argument identity_source", value=identity_source, expected_type=type_hints["identity_source"])
...
@jsii.enum(jsii_type="@aws-cdk/aws-apigatewayv2-authorizers.HttpLambdaResponseType")
...
class HttpUserPoolAuthorizer(
    ...
    def __init__(
        self,
        id: builtins.str,
        pool: _aws_cdk_aws_cognito_371ee794.IUserPool,
        *,
        authorizer_name: typing.Optional[builtins.str] = None,
        identity_source: typing.Optional[typing.Sequence[builtins.str]] = None,
        user_pool_clients: typing.Optional[typing.Sequence[_aws_cdk_aws_cognito_371ee794.IUserPoolClient]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f160de5d787589b4c9a11bfa76a3f7e102b5fbb1e7c983857c9b2e1e27840e41)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-apigatewayv2-authorizers.HttpUserPoolAuthorizerProps",
    jsii_struct_bases=[],
    name_mapping={
        "authorizer_name": "authorizerName",
        "identity_source": "identitySource",
...
class HttpUserPoolAuthorizerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e8f781070d5cd9aa6a9f11f467345d36183ec1d35eed5c0865c64838de6d47f8)
            check_type(argname="argument authorizer_name", value=authorizer_name, expected_type=type_hints["authorizer_name"])
            check_type(argname="argument identity_source", value=identity_source, expected_type=type_hints["identity_source"])
    ...
    def user_pool_clients(
        self,
    ) -> typing.Optional[typing.List[_aws_cdk_aws_cognito_371ee794.IUserPoolClient]]:
        ...
        return typing.cast(typing.Optional[typing.List[_aws_cdk_aws_cognito_371ee794.IUserPoolClient]], result)
...
@jsii.implements(_aws_cdk_aws_apigatewayv2_4b54cf3e.IWebSocketRouteAuthorizer)
class WebSocketLambdaAuthorizer(
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-cdk/aws-apigatewayv2-authorizers.WebSocketLambdaAuthorizer",
):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__52d16a0087a382a60482cf0515fede6ad0c3f01d1c6436fab2dac63062f36737)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument handler", value=handler, expected_type=type_hints["handler"])
    ...
    def bind(
        ...
        *,
        ...
        scope: _constructs_77d1e7e8.Construct,
    ) -> _aws_cdk_aws_apigatewayv2_4b54cf3e.WebSocketRouteAuthorizerConfig:
        ...
        :stability: experimental
        '''
        options = _aws_cdk_aws_apigatewayv2_4b54cf3e.WebSocketRouteAuthorizerBindOptions(
            route=route, scope=scope
        )

        return typing.cast(_aws_cdk_aws_apigatewayv2_4b54cf3e.WebSocketRouteAuthorizerConfig, jsii.invoke(self, "bind", [options]))


@jsii.data_type(
    jsii_type="@aws-cdk/aws-apigatewayv2-authorizers.WebSocketLambdaAuthorizerProps",
    jsii_struct_bases=[],
    name_mapping={
        "authorizer_name": "authorizerName",
        "identity_source": "identitySource",
...
class WebSocketLambdaAuthorizerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__311c5c3b54b28940e9ce0feb46cd87b8954a095f21a9800a4397c0c9c712fde1)
            check_type(argname="argument authorizer_name", value=authorizer_name, expected_type=type_hints["authorizer_name"])
            check_type(argname="argument identity_source", value=identity_source, expected_type=type_hints["identity_source"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        if authorizer_name is not None:
...
def _typecheckingstub__1e7937476312b23cc3a040c6e1a29b01ad6d8660d717a8b6612ebdb2368acd30(
    id: builtins.str,
    jwt_issuer: builtins.str,
    *,
    jwt_audience: typing.Sequence[builtins.str],
...
def _typecheckingstub__006bc46199bd8f5bb1842b02f0c941a543dfe861675fcbf7f8838053ddcc040e(
    *,
    jwt_audience: typing.Sequence[builtins.str],
    authorizer_name: typing.Optional[builtins.str] = None,
    identity_source: typing.Optional[typing.Sequence[builtins.str]] = None,
...
def _typecheckingstub__82934c32235b183e7e4cd56cb4ac2a009724a32d8ae6d1e947b4360ff2385ef3(
    id: builtins.str,
    handler: _aws_cdk_aws_lambda_5443dbc3.IFunction,
    *,
    authorizer_name: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__2db0a9c5ba6693767a87ac6d0b36748a12b521e7f7f29ddf7d2fb8e1e8120611(
    *,
    authorizer_name: typing.Optional[builtins.str] = None,
    identity_source: typing.Optional[typing.Sequence[builtins.str]] = None,
    response_types: typing.Optional[typing.Sequence[HttpLambdaResponseType]] = None,
...
def _typecheckingstub__f160de5d787589b4c9a11bfa76a3f7e102b5fbb1e7c983857c9b2e1e27840e41(
    id: builtins.str,
    pool: _aws_cdk_aws_cognito_371ee794.IUserPool,
    *,
    authorizer_name: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__e8f781070d5cd9aa6a9f11f467345d36183ec1d35eed5c0865c64838de6d47f8(
    *,
    authorizer_name: typing.Optional[builtins.str] = None,
    identity_source: typing.Optional[typing.Sequence[builtins.str]] = None,
    user_pool_clients: typing.Optional[typing.Sequence[_aws_cdk_aws_cognito_371ee794.IUserPoolClient]] = None,
...
def _typecheckingstub__52d16a0087a382a60482cf0515fede6ad0c3f01d1c6436fab2dac63062f36737(
    id: builtins.str,
    handler: _aws_cdk_aws_lambda_5443dbc3.IFunction,
    *,
    authorizer_name: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__311c5c3b54b28940e9ce0feb46cd87b8954a095f21a9800a4397c0c9c712fde1(
    *,
    authorizer_name: typing.Optional[builtins.str] = None,
    identity_source: typing.Optional[typing.Sequence[builtins.str]] = None,
) -> None:
