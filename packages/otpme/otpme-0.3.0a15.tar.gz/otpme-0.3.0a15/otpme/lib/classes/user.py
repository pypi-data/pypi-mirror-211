    ...
    'add'   : {
            'OTPme-mgmt-1.0'    : {
                'missing'    : {
                    ...
                    'oargs'             : ['unit', 'group', 'template_object', 'template_name', 'gen_qrcode'],
                    'job_type'          : 'process',
                    },
                'exists'    : {
                    'method'            : 'add',
...
def register_object_unit():
    ...
    config.register_base_object("unit", USERS_UNIT)
    config.register_default_unit("user", USERS_UNIT)
...
class User(OTPmeObject):
    ...
    def add(self, group=None, add_default_token=None, default_token=None,
        template_name=None, template_object=None, gen_qrcode=True, run_policies=True,
