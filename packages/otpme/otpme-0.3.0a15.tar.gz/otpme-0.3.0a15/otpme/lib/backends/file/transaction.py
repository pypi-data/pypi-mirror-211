...
class BaseTransaction(object):
    ...
    def _write_object_file(self, config_file, object_config, full_data_update=False):
...
class FileTransaction(BaseTransaction):
    ...
    def write_object_file(self, config_file, object_config, full_data_update=False):
    ...
    def _commit(self):
        ...
        if not self.no_disk_writes:
            # Remove status file first to indicate finished transaction.
...
class ObjectTransaction(BaseTransaction):
    ...
    def write_object(self, object_file, object_config):
        ...
        # Write object config.
        try:
            filetools.create_file(object_file, object_config_json)
        except Exception as e:
