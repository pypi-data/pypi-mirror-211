...
def test_issue_388():
    ...
    assert path.nodes_only[0] is model.l1.p1.o
    assert path.nodes_only[1] is model.s1.p2.o  # Issue 388
    ...
    assert path.nodes_only[0] is model.s1.p2.i
    assert path.nodes_only[1] is model.l1.p1.i
