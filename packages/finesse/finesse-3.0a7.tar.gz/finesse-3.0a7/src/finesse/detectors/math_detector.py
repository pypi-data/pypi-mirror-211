...
class MathDetector(Detector):
    ...
    def __init__(self, name, expression, dtype="O", dtype_shape=tuple(), unit="arb.", label=None):
    ...
    def set_expression(self, expression, dtype="O", dtype_shape=tuple(), unit="arb.", label=None):
        self._expression = expression
