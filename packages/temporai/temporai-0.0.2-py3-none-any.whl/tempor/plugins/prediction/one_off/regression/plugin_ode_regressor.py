...
@plugins.register_plugin(name="ode_regressor", category="prediction.one_off.regression")
class ODERegressor(BaseOneOffRegressor):
    ...
    def __init__(self, **params) -> None:
        ...
        Example:
            ...
            >>>
            >>> # Load the model:
            >>> model = plugin_loader.get("prediction.one_off.regression.ode_regressor", n_iter=50)
            >>>
            >>> # Train:
            >>> model.fit(dataset)
            ODERegressor(...)
