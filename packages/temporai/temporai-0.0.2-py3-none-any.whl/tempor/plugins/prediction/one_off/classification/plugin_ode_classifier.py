...
class ODEClassifierParams:
    """Initialization parameters for :class:`ODEClassifier`."""
...
@plugins.register_plugin(name="ode_classifier", category="prediction.one_off.classification")
class ODEClassifier(BaseOneOffClassifier):
    ParamsDefinition = ODEClassifierParams
    params: ODEClassifierParams  # type: ignore
