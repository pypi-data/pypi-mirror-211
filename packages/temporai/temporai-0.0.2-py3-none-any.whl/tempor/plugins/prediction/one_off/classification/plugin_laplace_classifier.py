...
@plugins.register_plugin(name="laplace_ode_classifier", category="prediction.one_off.classification")
class LaplaceODEClassifier(BaseOneOffClassifier):
    ...
    def __init__(self, **params) -> None:
        ...
        Example:
            >>> from tempor.utils.dataloaders import GoogleStocksDataLoader
