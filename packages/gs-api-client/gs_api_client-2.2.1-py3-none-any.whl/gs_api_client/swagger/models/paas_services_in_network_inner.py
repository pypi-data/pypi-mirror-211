...
from gs_api_client.swagger.models.listen_ports_by_ip_index import ListenPortsByIpIndex  # noqa: F401,E501


class PaasServicesInNetworkInner(object):
    ...
    def __init__(self, object_name=None, object_uuid=None, service_template_uuid=None, service_template_category=None, listen_ports=None):  # noqa: E501
        """PaasServicesInNetworkInner - a model defined in Swagger"""  # noqa: E501

        self._object_name = None
        self._object_uuid = None
        self._service_template_uuid = None
        self._service_template_category = None
        ...
        if service_template_category is not None:
            self.service_template_category = service_template_category
        if listen_ports is not None:
            self.listen_ports = listen_ports

    @property
    def object_name(self):
        """Gets the object_name of this PaasServicesInNetworkInner.  # noqa: E501

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :return: The object_name of this PaasServicesInNetworkInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_name(self, object_name):
        """Sets the object_name of this PaasServicesInNetworkInner.

        The human-readable name of the object. It supports the full UTF-8 character set, with a maximum of 64 characters.  # noqa: E501

        :param object_name: The object_name of this PaasServicesInNetworkInner.  # noqa: E501
        :type: str
        """
    ...
    def object_uuid(self):
        """Gets the object_uuid of this PaasServicesInNetworkInner.  # noqa: E501

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :return: The object_uuid of this PaasServicesInNetworkInner.  # noqa: E501
        :rtype: str
        """
    ...
    def object_uuid(self, object_uuid):
        """Sets the object_uuid of this PaasServicesInNetworkInner.

        The UUID of an object is always unique, and refers to a specific object.  # noqa: E501

        :param object_uuid: The object_uuid of this PaasServicesInNetworkInner.  # noqa: E501
        :type: str
        """
    ...
    def service_template_uuid(self):
        """Gets the service_template_uuid of this PaasServicesInNetworkInner.  # noqa: E501

        The template used to create the service, you can find an available list at the /service_templates endpoint.  # noqa: E501

        :return: The service_template_uuid of this PaasServicesInNetworkInner.  # noqa: E501
        :rtype: str
        """
    ...
    def service_template_uuid(self, service_template_uuid):
        """Sets the service_template_uuid of this PaasServicesInNetworkInner.

        The template used to create the service, you can find an available list at the /service_templates endpoint.  # noqa: E501

        :param service_template_uuid: The service_template_uuid of this PaasServicesInNetworkInner.  # noqa: E501
        :type: str
        """
    ...
    @property
    def service_template_category(self):
        """Gets the service_template_category of this PaasServicesInNetworkInner.  # noqa: E501

        The template service's category used to create the service  # noqa: E501

        :return: The service_template_category of this PaasServicesInNetworkInner.  # noqa: E501
        :rtype: str
        """
        return self._service_template_category

    @service_template_category.setter
    def service_template_category(self, service_template_category):
        """Sets the service_template_category of this PaasServicesInNetworkInner.

        The template service's category used to create the service  # noqa: E501

        :param service_template_category: The service_template_category of this PaasServicesInNetworkInner.  # noqa: E501
        :type: str
        """

        self._service_template_category = service_template_category

    @property
    def listen_ports(self):
        """Gets the listen_ports of this PaasServicesInNetworkInner.  # noqa: E501


        :return: The listen_ports of this PaasServicesInNetworkInner.  # noqa: E501
        :rtype: ListenPortsByIpIndex
        """
        return self._listen_ports

    @listen_ports.setter
    def listen_ports(self, listen_ports):
        """Sets the listen_ports of this PaasServicesInNetworkInner.


        :param listen_ports: The listen_ports of this PaasServicesInNetworkInner.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServicesInNetworkInner, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServicesInNetworkInner):
            return False
