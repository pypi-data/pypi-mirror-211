...
from gs_api_client.swagger.models.paas_services_in_network_inner import PaasServicesInNetworkInner  # noqa: F401,E501


class PaasServicesInNetwork(object):
    ...
    def __init__(self):  # noqa: E501
        """PaasServicesInNetwork - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaasServicesInNetwork, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaasServicesInNetwork):
            return False
