...
class Site(object):
    ...
    postgres_migratable_plugin_prefixes = []
    """
    ...
    *within* the framework.
    ...
    def setup_logging(self):
        ...
        # Ignore logging in redundent startup.
...
#                     raise ChangedAPI(msg)
    ...
    def build_site_cache(self, force=False, later=False):
        """
        ...
        # no longer needed since 20221216
