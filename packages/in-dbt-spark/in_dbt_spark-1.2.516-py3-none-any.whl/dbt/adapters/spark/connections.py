...
class SparkConnectionManager(SQLConnectionManager):
    ...
    def cleanup_all(self) -> None:
        ...
        if connection is not None:
            ...
            if connection.credentials.method == SparkConnectionMethod.SETU:
        ...
        for i in range(1 + creds.connect_retries):
            try:
                if creds.method == SparkConnectionMethod.HTTP:
                    ...
                    user_agent_entry = (
                        # TODO: do we need to replace w/ in-dbt-spark as we are in-dbt-spark?
                ...
                elif creds.method == SparkConnectionMethod.SETU:
