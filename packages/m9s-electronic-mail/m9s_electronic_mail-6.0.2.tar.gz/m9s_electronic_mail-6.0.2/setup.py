...
download_url = 'https://gitlab.com/m9s/electronic_mail.git'
requires = [
    'jinja2',
    'babel',
    'email-validator'
...
setup(name=name,
    version=version,
    description='Tryton Electronic Mail Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/electronic_mail.git',
        },
    keywords='',
    package_dir={'trytond.modules.electronic_mail': '.'},
    packages=(
        ['trytond.modules.electronic_mail']
        + ['trytond.modules.electronic_mail.%s' % p
