...
#define EGS_SECP256K1 MODBYTES_256_28  /**< ECC Group Size in bytes */
#define EFS_SECP256K1 MODBYTES_256_28  /**< ECC Field Size in bytes */
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_SECP256K1_SVDP_DH(octet *s,octet *W,octet *K);
...
extern int ECP_SECP256K1_SP_DSA_NOHASH(int sha,csprng *RNG,octet *K,octet *S,octet *H,octet *C,octet *D, int *parity);
extern int ECP_SECP256K1_VP_DSA_NOHASH(int h,octet *W,octet *M,octet *c,octet *d);
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_SECP256K1_PUBLIC_KEY_RECOVERY(octet *X, int y_parity, octet *H, octet *C, octet *D, octet *PK);
#endif
