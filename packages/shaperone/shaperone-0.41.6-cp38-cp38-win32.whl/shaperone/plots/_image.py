...
from shaperone._explanation import Explanation
...
def image(shap_values: Explanation or np.ndarray,
    ...
    shap_values : [numpy.array]
        List of arrays of SHAP values. Each array has the shaperone (# samples x width x height x channels), and the
...
def image_to_text(shap_values):
    ...
    ----------
    shap_values : [numpy.array]
        List of arrays of SHAP values. Each array has the shaperone (# width x height x channels x num output tokens). One array
        for each sample
    ...
    # computing shaperone color values for every pixel and for every output token
