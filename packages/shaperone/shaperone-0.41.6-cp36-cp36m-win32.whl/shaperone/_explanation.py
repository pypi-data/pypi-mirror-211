...
op_chain_root = OpChain("shaperone.Explanation")
    ...
    def __init__( # pylint: disable=too-many-arguments
        ...
        if output_names is not None and not isinstance(output_names, Alias):
            ...
            if l == 0:
                ...
                raise ValueError("shaperone.Explanation does not yet support output_names of order greater than 3!")
...
class Cohorts():
    ...
    def __repr__(self):
        return f"<shaperone._explanation.Cohorts object with {len(self.cohorts)} cohorts of sizes: {[v.shape for v in self.cohorts.values()]}>"
