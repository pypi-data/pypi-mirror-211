...
from shaperone.utils import safe_isinstance, MaskedModel, partition_tree_shuffle
from shaperone import Explanation, links
from shaperone.maskers import Text, Image, FixedComposite
...
class ExplanationError():
    ...
    def __call__(self, explanation, name, step_fraction=0.01, indices=[], silent=False):
        ...
        if safe_isinstance(explanation, "numpy.ndarray"):
            ...
            raise ValueError("The passed explanation must be either of type numpy.ndarray or shaperone.Explanation!")
