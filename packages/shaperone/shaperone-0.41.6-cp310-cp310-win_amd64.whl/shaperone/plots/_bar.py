...
def bar(shap_values, max_display=10, order=Explanation.abs, clustering=None, clustering_cutoff=0.5,
    ...
    Parameters
    ----------
    shap_values : shaperone.Explanation or shaperone.Cohorts or dictionary of shaperone.Explanation objects
    ...
    if partition_tree is not None:
        assert partition_tree.shape[1] == 4, "The clustering provided by the Explanation object does not seem to be a partition tree (which is all shaperone.plots.bar supports)!"
