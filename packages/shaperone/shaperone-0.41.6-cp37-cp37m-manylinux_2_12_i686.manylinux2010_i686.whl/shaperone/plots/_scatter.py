...
def scatter(shap_values, color="#1E88E5", hist=True, axis_color="#333333", cmap=colors.red_blue,
    ...
    color : string or shap.Explanation
        ...
        This is calculated using shaperone.utils.approximate_interactions.
    ...
    assert str(type(shap_values)).endswith("Explanation'>"), "The shap_values paramemter must be a shaperone.Explanation object!"
    ...
    if len(shap_values.shape) != 1:
        raise Exception("The passed Explanation object has multiple columns, please pass a single feature column to " + \
                        "shaperone.plots.dependence like: shap_values[:,column]")
    ...
    # TODO: This stacking could be avoided if we use the new shaperone.utils.potential_interactions function
...
def dependence_legacy(ind, shap_values=None, features=None, feature_names=None, display_features=None,
    ...
    interaction_index : "auto", None, int, or string
        ...
        as a string. If "auto" then shaperone.common.approximate_interactions is used to pick what
