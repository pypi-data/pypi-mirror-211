...
log = logging.getLogger('shaperone')
...
class Tabular(Masker):
    ...
    def __init__(self, data, max_samples=100, clustering=None):
        ...
        max_samples : int
            ...
            than max_samples then shaperone.utils.sample is used to subsample the dataset. The number of
        ...
        #                 "run times. Consider shaperone.utils.sample(data, K) to summarize the background using only K samples.")
    ...
    def save(self, out_file):
        ...
        with Serializer(out_file, "shaperone.maskers.Tabular", version=0) as s:
