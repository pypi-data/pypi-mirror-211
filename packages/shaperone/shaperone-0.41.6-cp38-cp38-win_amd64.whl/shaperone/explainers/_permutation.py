...
class Permutation(Explainer):
    ...
    def __init__(self, model, masker, link=links.identity, feature_names=None, linearize_link=True, seed=None, **call_args):
        ...
        masker : function or numpy.array or pandas.DataFrame
            ...
            game structure you can pass a shaperone.maksers.Tabular(data, clustering=\"correlation\") object.
        ...
        **call_args : valid argument to the __call__ method
        ...
        # setting seed for random generation: if seed is not None, then shaperone values computation should be reproducible
        np.random.seed(seed)
    ...
    def __str__(self):
        return "shaperone.explainers.Permutation()"
