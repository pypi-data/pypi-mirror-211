...
class OutputComposite(Masker):
    ...
    def __init__(self, masker, model):
        ...
        ----------
        masker: object
            An object of the shaperone.maskers.Masker base class (eg. Text/Image masker).

        model: object
            An object shaperone.models.Model base class used to generate output.
    ...
    def save(self, out_file):
        ...
        with Serializer(out_file, "shaperone.maskers.OutputComposite", version=0) as s:
    ...
    def load(cls, in_file, instantiate=True):
        ...
        with Deserializer(in_file, "shaperone.maskers.OutputComposite", min_version=0, max_version=0) as s:
