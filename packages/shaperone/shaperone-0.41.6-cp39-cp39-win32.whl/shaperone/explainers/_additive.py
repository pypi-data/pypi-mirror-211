...
class Additive(Explainer):
    ...
    def __init__(self, model, masker, link=None, feature_names=None, linearize_link=True):
        ...
        masker : function or numpy.array or pandas.DataFrame
            ...
            game structure you can pass a shaperone.maskers.Tabular(data, hclustering=\"correlation\") object, but
        ...
        assert safe_isinstance(self.masker, "shaperone.maskers.Independent"), "The Additive explainer only supports the Tabular masker at the moment!"
