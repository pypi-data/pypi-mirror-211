...
codes = {'Yamada': ['-t3_1', '+t3_1', 't4_1.1', 't5_1.1', 't5_1.2', '-t5_2', '+t5_2', '-t5_3', '+t5_3',
                    '-t5_4', '+t5_4', '-t5_5', '+t5_5', '-t5_6', '+t5_6', '-t5_7', '+t5_7', 't0_1#-3_1', 't0_1#+3_1',
                    '+t3_1#3+t3_1', '-t3_1#3+t3_1', '-t3_1#3+t3_1', 'h2_1.1', 'h4_1.1', 'h5_1.1', 'h6_1',
                    'h6_2.1', 'h2_1.1#3h2_1.1', 'h2_1.1#3+t3_1', ], #h2_1.2, h4_1+-, h2_1#3h4_1
         'APS': []}
ideal = {'Yamada': {
                    ...
                    ('h4_1.2', ('4^2_1', '0_1', '0_1')): 'h41.xyz',
                    ('h6_1', ('0_1', '0_1', '0_1U0_1')): 'h61.xyz',
                    ('h2_1.1#3h2_1.1', ('0_1U0_1', '0_1', '0_1')): 'h21H3h21.xyz'
                    },
         'APS': {}}
random = {'Yamada': {'h2_1': 'h21.xyz', 'h4_1': 'h41.xyz', 'h5_1': 'h51.xyz', 'h6_2': 'h62.xyz',
                     'h2_1#3h2_1': 'h21H3h21.xyz', 'h2_1.1#3+t3_1': 'h21H3t31.xyz'}, #'+t3_1': 'pt31.xyz',
...
def test_ideal():
    ...
    for algorithm in algorithms.keys():
        for curve, knots in ideal[algorithm].keys():
            assert curve in polynomials[curve]['whole'].split('|')
