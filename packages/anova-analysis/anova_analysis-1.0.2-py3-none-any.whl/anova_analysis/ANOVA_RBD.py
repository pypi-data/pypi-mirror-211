...
def RBD(replication, treatment, file_path):
    # Import the dataset
    ...
    data = {
        ...
        "m.s": [round(rep_mss, 2), round(tre_mss, 2), round(error_mss, 2), "NA"],
        "F": [round(rep_mss / error_mss, 2), round(tre_mss / error_mss, 2), "NA", "NA"]
    }
