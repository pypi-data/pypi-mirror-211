...
from serializerLiza153501.constants import ELEMENT_REGULAR

class serialize_XML:

    def dumps(self, objet):
        # print(objet)
        return self.convert_to_str(serialize(objet))
    ...
    def loads(self, string):
        # print (string)
        return deserialize(self.convert_to_expression(string))
