...
class SparkFeatureProcess:
    ...
    def _dataframeprocess(f):
        ...
        def inner(params, col_frame, mode):
            ...
            # output
            ismulitresult, frame_idx = type(result) == tuple, None
            if ismulitresult:
                result = list(result)
            ...
            if ismulitresult and frame_idx is not None:
    ...
    @staticmethod
    @_dataframeprocess
    def quantile_transform(params: Union[str, dict, list], col_frame: object, mode: str) -> Tuple[object, Union[str, dict, list]]:
    ...
    @staticmethod
    @_dataframeprocess
    def log_transform(params: Union[str, dict, list], col_frame: object, mode: str) -> Tuple[object, Union[str, dict, list]]:
        col_name = col_frame.columns.pop()
    ...
    @staticmethod
    @_dataframeprocess
    def standard_scale(params: Union[str, dict, list], col_frame: object, mode: str) -> Tuple[object, Union[str, dict, list]]:
        col_name, new_col_name = col_frame.columns.pop(), "new_col"
    ...
    @staticmethod
    @_dataframeprocess
    def max_abs_scale(params: Union[str, dict, list], col_frame: object, mode: str) -> Tuple[object, Union[str, dict, list]]:
        col_name, new_col_name = col_frame.columns.pop(), "new_col"
        col_frame = SparkFeatureProcess._to_vector(col_frame)
        model = MaxAbsScaler(
            inputCol=col_name, outputCol=new_col_name
    ...
    @staticmethod
    @_dataframeprocess
    def min_max_scale(params: Union[str, dict, list], col_frame: object, mode: str) -> Tuple[object, Union[str, dict, list]]:
        col_name, new_col_name = col_frame.columns.pop(), "new_col"
        col_frame = SparkFeatureProcess._to_vector(col_frame)
        model = MinMaxScaler(
            inputCol=col_name, outputCol=new_col_name
    ...
    @staticmethod
    @_dataframeprocess
    def translation(params: Union[str, dict, list], col_frame: object, mode: str) -> Tuple[object, Union[str, dict, list]]:
        col_name = col_frame.columns.pop()
    ...
    @staticmethod
    @_dataframeprocess
    def robust_scale(params: Union[str, dict, list], col_frame: object, mode: str) -> Tuple[object, Union[str, dict, list]]:
        col_name = col_frame.columns.pop()
    ...
    @staticmethod
    @_dataframeprocess
    def hash_feature(params: Union[str, dict, list], col_frame: object, mode: str) -> Tuple[object, Union[str, dict, list]]:
    ...
    @staticmethod
    @_dataframeprocess
    def interval_bucket(params: Union[str, dict, list], col_frame: object, mode: str) -> Tuple[object, Union[str, dict, list]]:
    ...
    @staticmethod
    @_dataframeprocess
    def kmeans_bucket(params: Union[str, dict, list], col_frame: object, mode: str) -> Tuple[object, Union[str, dict, list]]:
    ...
    def numeric_miss_check_repair(check_repair_config: Union[str, dict, list], col_frame: object, mode: str) -> object:
        ...
        if mr == '1':
            ...
            if check_repair_config['miss_repair']['repair_type'] == '7':
                if not ('quantile_low' in check_repair_config['miss_repair'] and 'quantile_high' in check_repair_config['miss_repair']):
                    raise FeatureProcessException(
