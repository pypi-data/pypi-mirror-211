...
import lusid_notification.models
from lusid_notification import rest
from lusid_notification.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(lusid_notification.models, klass)
