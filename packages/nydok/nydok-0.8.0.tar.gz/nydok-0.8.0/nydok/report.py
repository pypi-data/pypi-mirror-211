...
RISK_ITEM_TEMPLATE = """
  ...
  <tbody>
    <tr>
      ...
      <td class="nydok-risk-text" style="padding: 10px;" colspan="5">{description}</td>
    </tr>
    <tr>
      <th class="nydok-risk-text-header" style="padding: 10px;">Consequence</th>
      <td class="nydok-risk-text" style="padding: 10px;" colspan="5">{consequence}</td>
    </tr>
    <tr>
      <th class="nydok-risk-text-header" style="padding: 10px;">Mitigation</th>
      <td class="nydok-risk-text" style="padding: 10px;" colspan="5">{mitigation}</td>
    </tr>
  </tbody>
"""  # noqa: E501
