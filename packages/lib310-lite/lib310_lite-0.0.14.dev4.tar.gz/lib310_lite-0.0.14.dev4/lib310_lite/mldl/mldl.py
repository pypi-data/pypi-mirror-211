...
class MLDL:
    ...
    def __init__(self, db_url: str,
        ...
        self.engine = create_engine(db_url, pool_size=3 * num_threads, max_overflow=6 * num_threads, isolation_level='AUTOCOMMIT', pool_recycle=60)
    ...
    def fetch_sample(self, num: int, parts: dict = None, retry: int = 0):
        ...
        try:
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                main_thread = executor.submit(self.fetch_sample_main, index_list, parts, session)
    ...
    def fetch_sample_main(self, index_list: list, parts: dict = None, session: scoped_session = None):
        """
    ...
    def fetch_sample_interaction(self, index_list: list, session: scoped_session = None):
        """
