...
class ImageSourceForm(QVBoxLayout):
    ...
    def __init__(
        ...
        help_txt = (
            ...
            + "When images are available as files on PC, choose 'Local files' below and select the directory "
            + "where the images or directory hierarchy with the images are. For example, if you have "
            + "a directory 'Gel images' "
            ...
            + "As an alternative to storing images in folders, you can also use OMERO server to keep the images. While "
