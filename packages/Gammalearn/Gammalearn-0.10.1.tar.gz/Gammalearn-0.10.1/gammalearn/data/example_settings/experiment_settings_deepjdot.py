...
from gammalearn.data_handlers import GLearnDomainAdaptationDataModule, GLearnDataModule
...
targets = collections.OrderedDict({
    ...
    'deepjdot': {
        'loss': criterions.DeepJDOTLoss(batch_size=4),
        'loss_weight': 1,
        'metrics': {},
        'mt_balancing': True,
    }
...
loss_balancing_options = {
    'logvar_coeff': [2, 2, 2, 0.5, 2],  # for uncertainty
...
training_step = steps.get_training_step_deepjdot(**experiment_hparams)
...
eval_step = steps.get_eval_step_deepjdot(**experiment_hparams)
