...
targets = collections.OrderedDict({
    ...
    'class': {
        ...
        'metrics': {
            ...
            'AUC': AUROC(pos_label=particle_dict[GAMMA_ID],
    ...
    'parameters': {
        'backbone': {
            'parameters': {
                ...
                'mask_ratio': 0.75,
                'add_pointing': True,
                'weights': os.path.join(main_directory, 'test_mae/last.ckpt'),
...
optimizer_dic = {
    'network': optimizers.prime_optimizer,
}
...
training_step = steps.get_training_step_mt(
    **{'add_pointing': net_parameters_dic['parameters']['backbone']['parameters']['add_pointing']}
)
"""function: mandatory, the function to compute the training step"""
eval_step = steps.get_eval_step_mt(
    **{'add_pointing': net_parameters_dic['parameters']['backbone']['parameters']['add_pointing']}
)
