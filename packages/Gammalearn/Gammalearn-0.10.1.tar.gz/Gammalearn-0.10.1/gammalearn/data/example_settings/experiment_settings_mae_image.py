...
experiment_name = 'test_mae_image'
...
net_parameters_dic = {
    'model': nets.ImageMaskedAutoEncoder,
    'parameters': {
        'backbone': {
            'parameters': {
                'num_channels': 2,
...
data_module_train = {
    ...
    'transform': transforms.Compose([
        ...
        dsets.FlattenNumpy(start_dim=1),
    ]),
...
training_step = steps.get_training_step_mae(
...
eval_step = steps.get_eval_step_mae(
    **{'add_pointing': net_parameters_dic['parameters']['backbone']['parameters']['add_pointing']}
)
