...
class ExtensionsV1beta1IngressSpec:
    ...
    def __init__(self, *, backend: typing.Optional[kubernetes.client.ExtensionsV1beta1IngressBackend] = ..., ingress_class_name: typing.Optional[str] = ..., rules: typing.Optional[list[kubernetes.client.ExtensionsV1beta1IngressRule]] = ..., tls: typing.Optional[list[kubernetes.client.ExtensionsV1beta1IngressTLS]] = ...) -> None:
        ...
