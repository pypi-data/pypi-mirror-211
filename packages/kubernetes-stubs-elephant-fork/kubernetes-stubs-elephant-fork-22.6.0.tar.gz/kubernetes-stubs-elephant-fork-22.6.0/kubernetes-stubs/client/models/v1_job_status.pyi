...
class V1JobStatus:
    ...
    def __init__(self, *, active: typing.Optional[int] = ..., completed_indexes: typing.Optional[str] = ..., completion_time: typing.Optional[datetime.datetime] = ..., conditions: typing.Optional[list[kubernetes.client.V1JobCondition]] = ..., failed: typing.Optional[int] = ..., start_time: typing.Optional[datetime.datetime] = ..., succeeded: typing.Optional[int] = ..., uncounted_terminated_pods: typing.Optional[kubernetes.client.V1UncountedTerminatedPods] = ...) -> None:
        ...
...
class V1JobStatusDict(typing.TypedDict, total=False):
    ...
    succeeded: typing.Optional[int]
    uncountedTerminatedPods: typing.Optional[kubernetes.client.V1UncountedTerminatedPodsDict]
