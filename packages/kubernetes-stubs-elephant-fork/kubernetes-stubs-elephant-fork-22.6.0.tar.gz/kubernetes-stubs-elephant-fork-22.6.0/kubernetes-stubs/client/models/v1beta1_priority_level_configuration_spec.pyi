...
class V1beta1PriorityLevelConfigurationSpec:
    ...
    def __init__(self, *, limited: typing.Optional[kubernetes.client.V1beta1LimitedPriorityLevelConfiguration] = ..., type: str) -> None:
        ...
...
class V1beta1PriorityLevelConfigurationSpecDict(typing.TypedDict, total=False):
    limited: typing.Optional[kubernetes.client.V1beta1LimitedPriorityLevelConfigurationDict]
    type: str
