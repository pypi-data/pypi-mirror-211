...
class V2beta2HorizontalPodAutoscaler:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., spec: typing.Optional[kubernetes.client.V2beta2HorizontalPodAutoscalerSpec] = ..., status: typing.Optional[kubernetes.client.V2beta2HorizontalPodAutoscalerStatus] = ...) -> None:
        ...
