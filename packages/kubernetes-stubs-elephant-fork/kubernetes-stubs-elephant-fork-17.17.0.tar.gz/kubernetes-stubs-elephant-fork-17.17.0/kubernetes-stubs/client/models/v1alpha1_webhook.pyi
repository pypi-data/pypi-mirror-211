...
class V1alpha1Webhook:
    ...
    def __init__(self, *, client_config: kubernetes.client.V1alpha1WebhookClientConfig, throttle: typing.Optional[kubernetes.client.V1alpha1WebhookThrottleConfig] = ...) -> None:
        ...
