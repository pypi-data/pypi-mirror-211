...
class V1EndpointSubset:
    ...
    def __init__(self, *, addresses: typing.Optional[list[kubernetes.client.V1EndpointAddress]] = ..., not_ready_addresses: typing.Optional[list[kubernetes.client.V1EndpointAddress]] = ..., ports: typing.Optional[list[kubernetes.client.V1EndpointPort]] = ...) -> None:
        ...
