...
class V1beta1CertificateSigningRequest:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., spec: typing.Optional[kubernetes.client.V1beta1CertificateSigningRequestSpec] = ..., status: typing.Optional[kubernetes.client.V1beta1CertificateSigningRequestStatus] = ...) -> None:
        ...
...
class V1beta1CertificateSigningRequestDict(typing.TypedDict, total=False):
    ...
    status: typing.Optional[kubernetes.client.V1beta1CertificateSigningRequestStatusDict]
