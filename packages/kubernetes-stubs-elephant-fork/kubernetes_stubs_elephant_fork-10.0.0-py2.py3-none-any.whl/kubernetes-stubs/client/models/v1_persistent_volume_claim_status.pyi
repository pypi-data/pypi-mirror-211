...
class V1PersistentVolumeClaimStatus:
    ...
    def __init__(self, *, access_modes: typing.Optional[list[str]] = ..., capacity: typing.Optional[dict[str, str]] = ..., conditions: typing.Optional[list[kubernetes.client.V1PersistentVolumeClaimCondition]] = ..., phase: typing.Optional[str] = ...) -> None:
        ...
