...
class V1ContainerStatus:
    ...
    def __init__(self, *, container_id: typing.Optional[str] = ..., image: str, image_id: str, last_state: typing.Optional[kubernetes.client.V1ContainerState] = ..., name: str, ready: bool, restart_count: int, state: typing.Optional[kubernetes.client.V1ContainerState] = ...) -> None:
        ...
