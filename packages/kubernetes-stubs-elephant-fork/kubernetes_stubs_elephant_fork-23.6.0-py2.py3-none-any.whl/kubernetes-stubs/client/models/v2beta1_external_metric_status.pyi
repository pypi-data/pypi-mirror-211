...
class V2beta1ExternalMetricStatus:
    ...
    def __init__(self, *, current_average_value: typing.Optional[str] = ..., current_value: str, metric_name: str, metric_selector: typing.Optional[kubernetes.client.V1LabelSelector] = ...) -> None:
        ...
