...
class V2beta1HorizontalPodAutoscalerSpec:
    ...
    def __init__(self, *, max_replicas: int, metrics: typing.Optional[list[kubernetes.client.V2beta1MetricSpec]] = ..., min_replicas: typing.Optional[int] = ..., scale_target_ref: kubernetes.client.V2beta1CrossVersionObjectReference) -> None:
        ...
