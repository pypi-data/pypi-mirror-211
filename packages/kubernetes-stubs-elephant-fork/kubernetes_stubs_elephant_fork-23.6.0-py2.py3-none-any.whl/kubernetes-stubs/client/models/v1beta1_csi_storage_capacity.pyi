...
class V1beta1CSIStorageCapacity:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., capacity: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., maximum_volume_size: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., node_topology: typing.Optional[kubernetes.client.V1LabelSelector] = ..., storage_class_name: str) -> None:
        ...
