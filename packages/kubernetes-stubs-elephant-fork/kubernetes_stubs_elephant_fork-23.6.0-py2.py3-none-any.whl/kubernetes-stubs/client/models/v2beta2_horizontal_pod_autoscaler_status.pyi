...
class V2beta2HorizontalPodAutoscalerStatus:
    conditions: typing.Optional[list[kubernetes.client.V2beta2HorizontalPodAutoscalerCondition]]
    ...
    def __init__(self, *, conditions: typing.Optional[list[kubernetes.client.V2beta2HorizontalPodAutoscalerCondition]] = ..., current_metrics: typing.Optional[list[kubernetes.client.V2beta2MetricStatus]] = ..., current_replicas: int, desired_replicas: int, last_scale_time: typing.Optional[datetime.datetime] = ..., observed_generation: typing.Optional[int] = ...) -> None:
        ...
...
class V2beta2HorizontalPodAutoscalerStatusDict(typing.TypedDict, total=False):
    conditions: typing.Optional[list[kubernetes.client.V2beta2HorizontalPodAutoscalerConditionDict]]
