...
class V1alpha1PriorityLevelConfiguration:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., spec: typing.Optional[kubernetes.client.V1alpha1PriorityLevelConfigurationSpec] = ..., status: typing.Optional[kubernetes.client.V1alpha1PriorityLevelConfigurationStatus] = ...) -> None:
        ...
...
class V1alpha1PriorityLevelConfigurationDict(typing.TypedDict, total=False):
    ...
    status: typing.Optional[kubernetes.client.V1alpha1PriorityLevelConfigurationStatusDict]
