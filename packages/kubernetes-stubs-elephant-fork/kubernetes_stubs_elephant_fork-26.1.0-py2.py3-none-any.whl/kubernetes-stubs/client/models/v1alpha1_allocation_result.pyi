...
class V1alpha1AllocationResult:
    ...
    def __init__(self, *, available_on_nodes: typing.Optional[kubernetes.client.V1NodeSelector] = ..., resource_handle: typing.Optional[str] = ..., shareable: typing.Optional[bool] = ...) -> None:
        ...
