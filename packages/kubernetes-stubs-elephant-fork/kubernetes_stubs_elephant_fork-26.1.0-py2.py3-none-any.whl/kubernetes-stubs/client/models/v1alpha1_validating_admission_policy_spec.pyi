...
class V1alpha1ValidatingAdmissionPolicySpec:
    ...
    def __init__(self, *, failure_policy: typing.Optional[str] = ..., match_constraints: typing.Optional[kubernetes.client.V1alpha1MatchResources] = ..., param_kind: typing.Optional[kubernetes.client.V1alpha1ParamKind] = ..., validations: list[kubernetes.client.V1alpha1Validation]) -> None:
        ...
