...
class V1alpha1ResourceClass:
    ...
    parameters_ref: typing.Optional[kubernetes.client.V1alpha1ResourceClassParametersReference]
    suitable_nodes: typing.Optional[kubernetes.client.V1NodeSelector]
    
    def __init__(self, *, api_version: typing.Optional[str] = ..., driver_name: str, kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., parameters_ref: typing.Optional[kubernetes.client.V1alpha1ResourceClassParametersReference] = ..., suitable_nodes: typing.Optional[kubernetes.client.V1NodeSelector] = ...) -> None:
        ...
...
class V1alpha1ResourceClassDict(typing.TypedDict, total=False):
    ...
    parametersRef: typing.Optional[kubernetes.client.V1alpha1ResourceClassParametersReferenceDict]
