...
class V1beta1CronJobStatus:
    ...
    def __init__(self, *, active: typing.Optional[list[kubernetes.client.V1ObjectReference]] = ..., last_schedule_time: typing.Optional[datetime.datetime] = ..., last_successful_time: typing.Optional[datetime.datetime] = ...) -> None:
        ...
