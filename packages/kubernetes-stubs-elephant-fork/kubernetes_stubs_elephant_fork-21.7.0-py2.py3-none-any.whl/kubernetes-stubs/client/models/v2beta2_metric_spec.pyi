...
class V2beta2MetricSpec:
    container_resource: typing.Optional[kubernetes.client.V2beta2ContainerResourceMetricSource]
    ...
    def __init__(self, *, container_resource: typing.Optional[kubernetes.client.V2beta2ContainerResourceMetricSource] = ..., external: typing.Optional[kubernetes.client.V2beta2ExternalMetricSource] = ..., object: typing.Optional[kubernetes.client.V2beta2ObjectMetricSource] = ..., pods: typing.Optional[kubernetes.client.V2beta2PodsMetricSource] = ..., resource: typing.Optional[kubernetes.client.V2beta2ResourceMetricSource] = ..., type: str) -> None:
        ...
    def to_dict(self) -> V2beta2MetricSpecDict:
        ...
class V2beta2MetricSpecDict(typing.TypedDict, total=False):
    containerResource: typing.Optional[kubernetes.client.V2beta2ContainerResourceMetricSourceDict]
