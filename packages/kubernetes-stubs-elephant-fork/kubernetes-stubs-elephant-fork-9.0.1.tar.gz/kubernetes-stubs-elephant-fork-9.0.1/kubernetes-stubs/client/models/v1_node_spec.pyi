...
class V1NodeSpec:
    ...
    def __init__(self, *, config_source: typing.Optional[kubernetes.client.V1NodeConfigSource] = ..., external_id: typing.Optional[str] = ..., pod_cidr: typing.Optional[str] = ..., provider_id: typing.Optional[str] = ..., taints: typing.Optional[list[kubernetes.client.V1Taint]] = ..., unschedulable: typing.Optional[bool] = ...) -> None:
        ...
