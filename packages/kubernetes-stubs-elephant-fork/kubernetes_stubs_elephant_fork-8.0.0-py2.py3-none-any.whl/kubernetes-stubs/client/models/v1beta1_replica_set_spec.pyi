...
class V1beta1ReplicaSetSpec:
    ...
    def __init__(self, *, min_ready_seconds: typing.Optional[int] = ..., replicas: typing.Optional[int] = ..., selector: typing.Optional[kubernetes.client.V1LabelSelector] = ..., template: typing.Optional[kubernetes.client.V1PodTemplateSpec] = ...) -> None:
        ...
    def to_dict(self) -> V1beta1ReplicaSetSpecDict:
        ...
class V1beta1ReplicaSetSpecDict(typing.TypedDict, total=False):
