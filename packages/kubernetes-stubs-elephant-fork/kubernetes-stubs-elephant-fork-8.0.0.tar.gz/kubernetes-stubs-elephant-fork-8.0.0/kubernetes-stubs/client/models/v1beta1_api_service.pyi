...
class V1beta1APIService:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., spec: typing.Optional[kubernetes.client.V1beta1APIServiceSpec] = ..., status: typing.Optional[kubernetes.client.V1beta1APIServiceStatus] = ...) -> None:
        ...
