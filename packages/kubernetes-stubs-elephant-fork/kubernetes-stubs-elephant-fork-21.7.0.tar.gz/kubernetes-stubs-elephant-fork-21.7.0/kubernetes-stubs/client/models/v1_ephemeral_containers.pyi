...
class V1EphemeralContainers:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., ephemeral_containers: list[kubernetes.client.V1EphemeralContainer], kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ...) -> None:
        ...
