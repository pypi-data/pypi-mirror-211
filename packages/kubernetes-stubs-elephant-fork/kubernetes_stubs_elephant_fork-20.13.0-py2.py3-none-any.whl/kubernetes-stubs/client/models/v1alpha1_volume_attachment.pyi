...
class V1alpha1VolumeAttachment:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., kind: typing.Optional[str] = ..., metadata: typing.Optional[kubernetes.client.V1ObjectMeta] = ..., spec: kubernetes.client.V1alpha1VolumeAttachmentSpec, status: typing.Optional[kubernetes.client.V1alpha1VolumeAttachmentStatus] = ...) -> None:
        ...
