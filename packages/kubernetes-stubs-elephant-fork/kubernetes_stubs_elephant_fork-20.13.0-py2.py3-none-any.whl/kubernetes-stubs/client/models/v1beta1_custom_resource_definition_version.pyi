...
class V1beta1CustomResourceDefinitionVersion:
    ...
    def __init__(self, *, additional_printer_columns: typing.Optional[list[kubernetes.client.V1beta1CustomResourceColumnDefinition]] = ..., deprecated: typing.Optional[bool] = ..., deprecation_warning: typing.Optional[str] = ..., name: str, schema: typing.Optional[kubernetes.client.V1beta1CustomResourceValidation] = ..., served: bool, storage: bool, subresources: typing.Optional[kubernetes.client.V1beta1CustomResourceSubresources] = ...) -> None:
        ...
