...
class V1beta2DeploymentSpec:
    ...
    def __init__(self, *, min_ready_seconds: typing.Optional[int] = ..., paused: typing.Optional[bool] = ..., progress_deadline_seconds: typing.Optional[int] = ..., replicas: typing.Optional[int] = ..., revision_history_limit: typing.Optional[int] = ..., selector: kubernetes.client.V1LabelSelector, strategy: typing.Optional[kubernetes.client.V1beta2DeploymentStrategy] = ..., template: kubernetes.client.V1PodTemplateSpec) -> None:
        ...
    def to_dict(self) -> V1beta2DeploymentSpecDict:
        ...
class V1beta2DeploymentSpecDict(typing.TypedDict, total=False):
    ...
    strategy: typing.Optional[kubernetes.client.V1beta2DeploymentStrategyDict]
