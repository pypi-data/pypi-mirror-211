...
class V2beta2HorizontalPodAutoscalerSpec:
    ...
    def __init__(self, *, behavior: typing.Optional[kubernetes.client.V2beta2HorizontalPodAutoscalerBehavior] = ..., max_replicas: int, metrics: typing.Optional[list[kubernetes.client.V2beta2MetricSpec]] = ..., min_replicas: typing.Optional[int] = ..., scale_target_ref: kubernetes.client.V2beta2CrossVersionObjectReference) -> None:
        ...
...
class V2beta2HorizontalPodAutoscalerSpecDict(typing.TypedDict, total=False):
    behavior: typing.Optional[kubernetes.client.V2beta2HorizontalPodAutoscalerBehaviorDict]
    maxReplicas: int
