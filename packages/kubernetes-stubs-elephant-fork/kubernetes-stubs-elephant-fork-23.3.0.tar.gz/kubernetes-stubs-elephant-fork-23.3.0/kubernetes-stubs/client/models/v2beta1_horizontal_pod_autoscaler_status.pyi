...
class V2beta1HorizontalPodAutoscalerStatus:
    conditions: typing.Optional[list[kubernetes.client.V2beta1HorizontalPodAutoscalerCondition]]
    ...
    def __init__(self, *, conditions: typing.Optional[list[kubernetes.client.V2beta1HorizontalPodAutoscalerCondition]] = ..., current_metrics: typing.Optional[list[kubernetes.client.V2beta1MetricStatus]] = ..., current_replicas: int, desired_replicas: int, last_scale_time: typing.Optional[datetime.datetime] = ..., observed_generation: typing.Optional[int] = ...) -> None:
        ...
...
class V2beta1HorizontalPodAutoscalerStatusDict(typing.TypedDict, total=False):
    conditions: typing.Optional[list[kubernetes.client.V2beta1HorizontalPodAutoscalerConditionDict]]
