...
class V2beta2HorizontalPodAutoscalerBehavior:
    ...
    def __init__(self, *, scale_down: typing.Optional[kubernetes.client.V2beta2HPAScalingRules] = ..., scale_up: typing.Optional[kubernetes.client.V2beta2HPAScalingRules] = ...) -> None:
        ...
