...
class V1beta1CSIDriverSpec:
    ...
    def __init__(self, *, attach_required: typing.Optional[bool] = ..., fs_group_policy: typing.Optional[str] = ..., pod_info_on_mount: typing.Optional[bool] = ..., storage_capacity: typing.Optional[bool] = ..., volume_lifecycle_modes: typing.Optional[list[str]] = ...) -> None:
        ...
