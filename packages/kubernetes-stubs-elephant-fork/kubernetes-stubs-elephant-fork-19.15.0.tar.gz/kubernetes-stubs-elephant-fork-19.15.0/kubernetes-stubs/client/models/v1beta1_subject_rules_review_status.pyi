...
class V1beta1SubjectRulesReviewStatus:
    ...
    def __init__(self, *, evaluation_error: typing.Optional[str] = ..., incomplete: bool, non_resource_rules: list[kubernetes.client.V1beta1NonResourceRule], resource_rules: list[kubernetes.client.V1beta1ResourceRule]) -> None:
        ...
