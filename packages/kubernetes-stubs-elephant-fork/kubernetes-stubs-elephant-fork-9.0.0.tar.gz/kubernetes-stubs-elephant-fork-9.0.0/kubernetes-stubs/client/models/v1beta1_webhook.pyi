...
class V1beta1Webhook:
    ...
    def __init__(self, *, client_config: kubernetes.client.AdmissionregistrationV1beta1WebhookClientConfig, failure_policy: typing.Optional[str] = ..., name: str, namespace_selector: typing.Optional[kubernetes.client.V1LabelSelector] = ..., rules: typing.Optional[list[kubernetes.client.V1beta1RuleWithOperations]] = ..., side_effects: typing.Optional[str] = ...) -> None:
        ...
