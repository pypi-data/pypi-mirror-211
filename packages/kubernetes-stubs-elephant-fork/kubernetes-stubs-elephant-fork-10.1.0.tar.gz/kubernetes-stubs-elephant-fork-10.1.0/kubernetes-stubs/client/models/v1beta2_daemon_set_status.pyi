...
class V1beta2DaemonSetStatus:
    ...
    conditions: typing.Optional[list[kubernetes.client.V1beta2DaemonSetCondition]]
    ...
    def __init__(self, *, collision_count: typing.Optional[int] = ..., conditions: typing.Optional[list[kubernetes.client.V1beta2DaemonSetCondition]] = ..., current_number_scheduled: int, desired_number_scheduled: int, number_available: typing.Optional[int] = ..., number_misscheduled: int, number_ready: int, number_unavailable: typing.Optional[int] = ..., observed_generation: typing.Optional[int] = ..., updated_number_scheduled: typing.Optional[int] = ...) -> None:
        ...
    def to_dict(self) -> V1beta2DaemonSetStatusDict:
        ...
class V1beta2DaemonSetStatusDict(typing.TypedDict, total=False):
    collisionCount: typing.Optional[int]
    conditions: typing.Optional[list[kubernetes.client.V1beta2DaemonSetConditionDict]]
