...
class V2beta2ObjectMetricStatus:
    ...
    def __init__(self, *, current: kubernetes.client.V2beta2MetricValueStatus, described_object: kubernetes.client.V2beta2CrossVersionObjectReference, metric: kubernetes.client.V2beta2MetricIdentifier) -> None:
        ...
