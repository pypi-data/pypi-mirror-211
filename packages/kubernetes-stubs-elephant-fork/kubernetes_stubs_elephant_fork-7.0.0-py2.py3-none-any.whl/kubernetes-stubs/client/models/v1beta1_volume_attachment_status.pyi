...
class V1beta1VolumeAttachmentStatus:
    ...
    def __init__(self, *, attach_error: typing.Optional[kubernetes.client.V1beta1VolumeError] = ..., attached: bool, attachment_metadata: typing.Optional[dict[str, str]] = ..., detach_error: typing.Optional[kubernetes.client.V1beta1VolumeError] = ...) -> None:
        ...
