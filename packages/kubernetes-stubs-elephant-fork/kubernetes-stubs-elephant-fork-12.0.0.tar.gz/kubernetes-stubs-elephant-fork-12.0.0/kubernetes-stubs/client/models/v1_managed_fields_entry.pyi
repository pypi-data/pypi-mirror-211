...
class V1ManagedFieldsEntry:
    ...
    def __init__(self, *, api_version: typing.Optional[str] = ..., fields_type: typing.Optional[str] = ..., fields_v1: typing.Optional[typing.Any] = ..., manager: typing.Optional[str] = ..., operation: typing.Optional[str] = ..., time: typing.Optional[datetime.datetime] = ...) -> None:
        ...
