...
class V1beta1CSINodeDriver:
    ...
    def __init__(self, *, allocatable: typing.Optional[kubernetes.client.V1beta1VolumeNodeResources] = ..., name: str, node_id: str, topology_keys: typing.Optional[list[str]] = ...) -> None:
        ...
