...
def genSlices(self,delta=200,window=2000,settings_update=True):
    ...
    # Settings file checkout and update
    if settings_update:
        print('Updating settings')
        self.settings_file_checkout()
    ...
    self.update_slicesbook_from_slices()

    # Save
    self.save_slices()
    self.save_slicesbook()
