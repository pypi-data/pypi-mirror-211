...
VERSION = '0.0.30' #Muy importante, deberéis ir cambiando la versión de vuestra librería según incluyáis nuevas funcionalidades
...
setup(
    ...
    package_data={'obrpy':['UTILS/*','ANALYSIS/*']},
