...
class Backend:
    def __init__(self, request_data: RequestData, circuit):
        ...
        self.required_qubit = self.__get_qubit_number(circuit)
        self.backend_request = self.__generate_backend_request(request_data.device_id)
        self.backend_data = self.__get_backend_data()
        self.circuit_export_url = request_data.circuit_export_url
        self.__export_circuit(circuit)

    def __get_qubit_number(self, circuit) -> int:
    ...
    def __generate_backend_request(self, device_id):
    ...
    def __export_circuit(self, circuit):
        ...
        logging.info("Sending circuit svg image to [%s] with POST method ...",
