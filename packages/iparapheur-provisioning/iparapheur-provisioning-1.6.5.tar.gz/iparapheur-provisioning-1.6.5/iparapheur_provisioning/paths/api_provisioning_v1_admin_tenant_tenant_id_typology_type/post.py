...
# body param
SchemaForRequestBodyApplicationJson = TypeDto


request_body_type_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_type_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_type_dto.serialize(body, content_type)
