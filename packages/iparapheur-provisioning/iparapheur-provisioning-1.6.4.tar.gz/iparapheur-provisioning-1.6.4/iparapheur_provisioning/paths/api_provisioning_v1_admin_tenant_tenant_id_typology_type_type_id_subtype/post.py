...
# body param
SchemaForRequestBodyApplicationJson = SubtypeDto


request_body_subtype_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_subtype_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_subtype_dto.serialize(body, content_type)
...
class CreateSubtype(BaseApi):
    ...
    def create_subtype(
        ...
        return self._create_subtype_oapg(
            body=body,
