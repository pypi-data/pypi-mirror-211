...
def ijtolatlon(line, col, subpoint=104.7, resolution=0.04):

    myfy4a = fy4searchtable(resolution)

    lat, lon = myfy4a.IJ2LatLon(line, col, subpoint=subpoint)

    return lat, lon

def latlon2ij(lat, lon, subpoint=104.7, resolution=0.04):
