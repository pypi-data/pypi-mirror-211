...
class DeciPlatformClient:
    ...
    def __init__(self, proxy_headers=None, logger=None):
    ...
    def register_model(
        ...
        **kwargs: "Any",
        ...
        :param framework: The model's framework.
                          Allowed values can be seen in deci_platform_client.FrameworkType.
        :param dl_task: The deep learning task of the model.
                        Allowed values can be seen in deci_platform_client.DeepLearningTask.
        ...
        :param hardware_types: A list of hardware types to benchmark the model on. Optional.
                               Allowed values can be seen in deci_platform_client.HardwareType.
        :param accuracy: The model's accuracy, as a float. Optional.
        :param accuracy_key: The model's accuracy key. Optional.
        ...
        :param target_metric: The model's target metric. Optional.
                              Allowed values can be seen in deci_platform_client.Metric.
        ...
        response = self.raw_api.add_model_v2(
            body=BodyAddModelV2(model=model_metadata, hardware_types=hardware_types or [HardwareType.T4]),
    ...
    def edit_model(
        ...
        *,
        ...
        primary_hardware: "Optional[HardwareType]" = None,
    ...
    def get_all_models(
        ...
        :param reorder: Whether to reorder the models in the response,
                        placing optimized models in an array on their baseline model.
        :param with_deleted: Whether to include deleted models in the response.
        :param ids: List of model ids to query the models metadata for. Optional, if not given all will be fetched.
        """
        query_params = {}
        if ids is not None:
    ...
    def get_model_by_id(self, model_id: "Union[UUID, str]") -> "ModelMetadata":
        """
        Gets a model from the user's model repository by ID
    ...
    def optimize_model(
        ...
        *,
        ...
        """
        Optimizes a model
        :param model_id: The ID of the model to optimize.
        :param hardware_types: The types of hardware to optimize for. Optional, defaults to T4.
        :param batch_size: The batch size to optimize for. Optional, defaults to 1.
        :param quantization_level: The quantization level to optimize for. Optional, defaults to FP16.
        :param infery_pkl_format: Whether to use the infery pkl format. Optional, defaults to True.
        :param conversion_parameters: Additional conversion parameters, to be used when optimizing the model. Optional.
        :param name: The name to set for the optimized model. Optional.
        :param target_metric: The target metric to optimize for. Optional, defaults to latency.
        """
    ...
    def autonac_model(self, model_id: "Union[UUID, str]") -> "UUID":
        """
        Runs AutoNAC on an existing model.
        :param model_id: The ID of the model to run AutoNAC on.
        """
