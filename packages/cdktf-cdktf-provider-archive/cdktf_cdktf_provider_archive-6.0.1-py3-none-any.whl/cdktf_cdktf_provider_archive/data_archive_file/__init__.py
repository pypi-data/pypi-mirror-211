...
class DataArchiveFileSourceOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataArchiveFileSource, _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataArchiveFileSource, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataArchiveFileSource, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
