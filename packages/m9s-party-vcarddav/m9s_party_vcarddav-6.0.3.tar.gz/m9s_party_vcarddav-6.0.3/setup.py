...
download_url = 'https://gitlab.com/m9s/party_vcarddav.git'
requires = [
    'm9s-PyWebDAV3 >= 0.9.14.1',
    'vobject >= 0.8.0',
    ]
...
setup(name=name,
    version=version,
    description='Tryton Party Vcarddav Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/party_vcarddav.git',
        },
    keywords='',
    package_dir={'trytond.modules.party_vcarddav': '.'},
    packages=(
        ['trytond.modules.party_vcarddav']
        + ['trytond.modules.party_vcarddav.%s' % p
