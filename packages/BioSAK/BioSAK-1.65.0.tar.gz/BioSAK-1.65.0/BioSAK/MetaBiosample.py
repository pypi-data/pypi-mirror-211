...
python3 /Users/songweizhi/PycharmProjects/Sponge_r214/Sponge_Hologenome/MetaBiosample.py -i a.txt -a 'isolation_source,host,geo_loc_name,lat_lon' -o op_dir -f 
'''