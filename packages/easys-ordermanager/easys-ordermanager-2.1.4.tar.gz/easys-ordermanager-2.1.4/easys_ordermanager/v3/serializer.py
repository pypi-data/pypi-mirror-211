...
class OrderLineEmailSerializer(serializers.Serializer):
    ...
    """
    included_accounts = serializers.ListField(child=serializers.EmailField(required=True), allow_empty=False)

    """
    list of additionally booked email accounts

    """
    additional_accounts = serializers.ListField(child=serializers.EmailField(required=True))
