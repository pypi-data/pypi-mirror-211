...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        # Can overwrite with environment variable MAGIC_API_HOST.
        self.host = os.getenv('MAGIC_API_HOST', "https://api.magic.unknowncyber.com")
        self.host += '/v2'
