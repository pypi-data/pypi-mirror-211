...
class BoardController(Controller):
    ...
    def clear_buffer(self):
        ...
        if self.board.using_new_backend:
            ...
            if device.type in [DeviceType.SERIAL, DeviceType.D2XX]:
    ...
    def read_scalers(self, channels: Iterable[int] = None) -> list[int]:
        ...
        result = self._read_scalars(channels)

        return result

    def _read_scalars(self, channels: Iterable[int]) -> list[int]:
        """Reads the scalars for the given channels."""
        result = []
