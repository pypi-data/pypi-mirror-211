...
from deeputilities.configuration.configuration_object import ConfigObject
...
class DemoCommand(Command):
    ...
    def handle(self):
        ...
        with open(os.path.join(CONFIG_PATH, "deeputils_config.yaml") , 'w') as yaml_file:
        ...
        data = pd.read_csv("https://www.kaggle.com/competitions/titanic/data?select=train.csv")
