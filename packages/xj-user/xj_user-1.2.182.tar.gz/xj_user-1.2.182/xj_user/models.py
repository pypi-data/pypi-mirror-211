...
class Platform(models.Model):
    ...
    platform_id = models.IntegerField(verbose_name='平台ID', primary_key=False, help_text='必填。不自动生成，由运营人员统一设置。')
...
class UserRelateType(models.Model):
    ...
    relate_name = models.CharField(verbose_name='关系搜索名称', max_length=50, blank=True, null=True, default="",
                                   help_text='')
    description = models.CharField(verbose_name='关系描述', max_length=255, blank=True, null=True, default="", help_text='')
...
class UserRelateToUser(models.Model):
    ...
    id = models.AutoField(verbose_name='ID', primary_key=True)
    user = models.ForeignKey(to="BaseInfo", verbose_name='关系人', related_name="relate_user_id_alias", blank=True,
                             null=True, help_text='', on_delete=models.DO_NOTHING)
    ...
    user_relate_type = models.ForeignKey(to=UserRelateType, verbose_name='关系类型ID', blank=True, null=True, help_text='',
                                         on_delete=models.DO_NOTHING)
