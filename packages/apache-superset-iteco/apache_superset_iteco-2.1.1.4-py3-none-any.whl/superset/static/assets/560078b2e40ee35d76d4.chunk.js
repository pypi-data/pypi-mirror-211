"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[8782],{18782:(e,t,l)=>{l.d(t,{p:()=>ie,Z:()=>ne});var r=l(5872),a=l.n(r),n=l(51995),i=l(55867),o=l(67294),s=l(29487),d=l(94184),u=l.n(d),c=l(35932),g=l(70163),p=l(49576),h=l(64158),m=l(97754),f=l(11965);const v=n.iK.div`
...
`;function y(e){let{bulkSelectEnabled:t,loading:l,prepareRow:r,renderCard:a,rows:n,showThumbnails:i}=e;return a?(0,f.tZ)(v,{showThumbnails:i},l&&0===n.length&&[...new Array(25)].map(((e,t)=>(0,f.tZ)("div",{key:t},a({loading:l})))),n.length>0&&n.map((e=>a?(r(e),(0,f.tZ)(b,{className:u()({"card-selected":t&&e.isSelected,"bulk-select":t}),key:e.id,onClick:l=>{return r=l,a=e.toggleRowSelected,void(t&&(r.preventDefault(),r.stopPropagation(),a()));var r,a},role:"none"},a({...e.original,loading:l}))):null))):null}var x=l(68135),w=l(4715),S=l(18446),Z=l.n(S),C=l(79521),$=l(35755),k=l(15926),F=l.n(k);const I={encode:e=>void 0===e?void 0:F().encode(e).replace(/%/g,"%25").replace(/&/g,"%26").replace(/\+/g,"%2B").replace(/#/g,"%23"),decode:e=>void 0===e||Array.isArray(e)?void 0:F().decode(e)};class _ extends Error{constructor(){super(...arguments),this.name="ListViewError"}}function P(e,t){return e.map((e=>{let{id:l,urlDisplay:r,operator:a}=e;return{id:l,urlDisplay:r,operator:a,value:t[r||l]}}))}function T(e,t){const l=[],r={};return Object.keys(e).forEach((t=>{const a={id:t,value:e[t]};r[t]=a,l.push(a)})),t.forEach((e=>{const t=e.urlDisplay||e.id,l=r[t];l&&(l.operator=e.operator,l.id=e.id)})),l}var U=l(49238);const R=n.iK.div`
  width: ${200}px;
`,M=(0,n.iK)(g.Z.Search)`
  color: ${e=>{let{theme:t}=e;return t.colors.grayscale.light1}};
`,B=(0,n.iK)(w.oc)`
  border-radius: ${e=>{let{theme:t}=e;return t.gridUnit}}px;
`;function A(e,t){let{Header:l,name:r,initialValue:a,onSubmit:n}=e;const[s,d]=(0,o.useState)(a||""),u=()=>{s&&n(s.trim())};return(0,o.useImperativeHandle)(t,(()=>({clearFilter:()=>{d(""),n("")}}))),(0,f.tZ)(R,null,(0,f.tZ)(U.lX,null,l),(0,f.tZ)(B,{allowClear:!0,placeholder:(0,i.t)("Type a value"),name:r,value:s,onChange:e=>{d(e.currentTarget.value),""===e.currentTarget.value&&n("")},onPressEnter:u,onBlur:u,prefix:(0,f.tZ)(M,{iconSize:"l"})}))}const V=(0,o.forwardRef)(A);var E=l(84101);const N=n.iK.div`
  display: inline-flex;
  font-size: ${e=>{let{theme:t}=e;return t.typography.sizes.s}}px;
  align-items: center;
  width: ${200}px;
`;function z(e,t){let{Header:l,name:r,fetchSelects:a,initialValue:n,onSelect:s,selects:d=[]}=e;const[u,c]=(0,o.useState)(n),g=e=>{s(e?{label:e.label,value:e.value}:void 0),c(e)},p=()=>{s(void 0,!0),c(void 0)};(0,o.useImperativeHandle)(t,(()=>({clearFilter:()=>{p()}})));const h=(0,o.useMemo)((()=>async(e,t,l)=>{if(a){const r=await a(e,t,l);return{data:r.data,totalCount:r.totalCount}}return{data:[],totalCount:0}}),[a]);return(0,f.tZ)(N,null,a?(0,f.tZ)(E.Z,{allowClear:!0,ariaLabel:"string"==typeof l?l:r||(0,i.t)("Filter"),header:(0,f.tZ)(U.lX,null,l),onChange:g,onClear:p,options:h,placeholder:(0,i.t)("Select or type a value"),showSearch:!0,value:u}):(0,f.tZ)(w.Ph,{allowClear:!0,ariaLabel:"string"==typeof l?l:r||(0,i.t)("Filter"),header:(0,f.tZ)(U.lX,null,l),labelInValue:!0,onChange:g,onClear:p,options:d,placeholder:(0,i.t)("Select or type a value"),showSearch:!0,value:u}))}const H=(0,o.forwardRef)(z);var O=l(30381),K=l.n(O),D=l(62276);const L=n.iK.div`
  display: inline-flex;
  flex-direction: column;
  justify-content: center;
  align-items: flex-start;
  width: 360px;
`;function X(e,t){let{Header:l,initialValue:r,onSubmit:a}=e;const[n,s]=(0,o.useState)(null!=r?r:null),d=(0,o.useMemo)((()=>!n||Array.isArray(n)&&!n.length?null:[K()(n[0]),K()(n[1])]),[n]);return(0,o.useImperativeHandle)(t,(()=>({clearFilter:()=>{s(null),a([])}}))),(0,f.tZ)(L,null,(0,f.tZ)(U.lX,null,l),(0,f.tZ)(D.S,{placeholder:[(0,i.t)("Start date"),(0,i.t)("End date")],showTime:!0,value:d,onChange:e=>{var t,l,r,n;if(!e)return s(null),void a([]);const i=[null!=(t=null==(l=e[0])?void 0:l.valueOf())?t:0,null!=(r=null==(n=e[1])?void 0:n.valueOf())?r:0];s(i),a(i)}}))}const q=(0,o.forwardRef)(X);function j(e,t){let{filters:l,internalFilters:r=[],updateFilterValue:a}=e;const n=(0,o.useMemo)((()=>Array.from({length:l.length},(()=>(0,o.createRef)()))),[l.length]);return(0,o.useImperativeHandle)(t,(()=>({clearFilters:()=>{n.forEach((e=>{var t;null==(t=e.current)||null==t.clearFilter||t.clearFilter()}))}}))),(0,f.tZ)(o.Fragment,null,l.map(((e,t)=>{var l;let{Header:i,fetchSelects:o,key:s,id:d,input:u,paginate:c,selects:g,onFilterUpdate:p}=e;const h=null==r||null==(l=r[t])?void 0:l.value;return"select"===u?(0,f.tZ)(H,{ref:n[t],Header:i,fetchSelects:o,initialValue:h,key:s,name:d,onSelect:(e,l)=>{p&&(l||p(e)),a(t,e)},paginate:c,selects:g}):"search"===u&&"string"==typeof i?(0,f.tZ)(V,{ref:n[t],Header:i,initialValue:h,key:s,name:d,onSubmit:e=>{p&&p(e),a(t,e)}}):"datetime_range"===u?(0,f.tZ)(q,{ref:n[t],Header:i,initialValue:h,key:s,name:d,onSubmit:e=>a(t,e)}):null})))}const G=(0,x.b)((0,o.forwardRef)(j)),W=n.iK.div`
  display: inline-flex;
  font-size: ${e=>{let{theme:t}=e;return t.typography.sizes.s}}px;
  align-items: center;
  text-align: left;
