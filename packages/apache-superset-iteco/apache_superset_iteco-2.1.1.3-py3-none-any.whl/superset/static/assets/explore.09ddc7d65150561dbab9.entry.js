...
`;class na extends n.Component{constructor(e){super(e),this.state={saveToDashboardId:null,newSliceName:e.sliceName,alert:null,action:this.canOverwriteSlice()?"overwrite":"saveas"},this.onDashboardSelectChange=this.onDashboardSelectChange.bind(this),this.onSliceNameChange=this.onSliceNameChange.bind(this),this.changeAction=this.changeAction.bind(this),this.saveOrOverwrite=this.saveOrOverwrite.bind(this),this.isNewDashboard=this.isNewDashboard.bind(this)}isNewDashboard(){return!(this.state.saveToDashboardId||!this.state.newDashboardName)}canOverwriteSlice(){var e,t,a;return(null==(e=this.props.slice)||null==(t=e.owners)?void 0:t.includes(this.props.userId))&&!(null!=(a=this.props.slice)&&a.is_managed_externally)}componentDidMount(){this.props.actions.fetchDashboards(this.props.userId).then((()=>{const e=this.props.dashboards.map((e=>e.value)),t=sessionStorage.getItem(ra);let a=t&&parseInt(t,10);this.props.dashboardId&&(a=this.props.dashboardId),null!==a&&-1!==e.indexOf(a)&&this.setState({saveToDashboardId:a})}))}onSliceNameChange(e){this.setState({newSliceName:e.target.value})}onDashboardSelectChange(e){const t=e?String(e):void 0,a=e&&"number"==typeof e?e:null;this.setState({saveToDashboardId:a,newDashboardName:t})}changeAction(e){this.setState({action:e})}saveOrOverwrite(e){this.setState({alert:null}),this.props.actions.removeSaveModalAlert();const t={};if(this.props.slice&&this.props.slice.slice_id&&(t.slice_id=this.props.slice.slice_id),"saveas"===t.action&&""===this.state.newSliceName)return void this.setState({alert:(0,Q.t)("Please enter a chart name")});t.action=this.state.action,t.slice_name=this.state.newSliceName,t.save_to_dashboard_id=this.state.saveToDashboardId,t.new_dashboard_name=this.state.newDashboardName;const{url_params:a,...r}=this.props.form_data||{};this.props.actions.saveSlice(r,t).then((t=>{null===t.dashboard_id?sessionStorage.removeItem(ra):sessionStorage.setItem(ra,t.dashboard_id);let r=e?t.dashboard_url:t.slice.slice_url;if(a){const e=r.includes("?")?"&":"?";r=`${r}${e}${new URLSearchParams(a).toString()}`}window.location.assign(r)})),this.props.onHide()}removeAlert(){this.props.alert&&this.props.actions.removeSaveModalAlert(),this.setState({alert:null})}render(){const e=this.state.saveToDashboardId||this.state.newDashboardName;return(0,Ue.tZ)(oa,{show:!0,onHide:this.props.onHide,title:(0,Q.t)("Save chart"),footer:(0,Ue.tZ)("div",null,(0,Ue.tZ)(wt.Z,{id:"btn_cancel",buttonSize:"small",onClick:this.props.onHide},(0,Q.t)("Cancel")),(0,Ue.tZ)(wt.Z,{id:"btn_modal_save_goto_dash",buttonSize:"small",disabled:!this.state.newSliceName||!this.state.saveToDashboardId&&!this.state.newDashboardName,onClick:()=>this.saveOrOverwrite(!0)},this.isNewDashboard()?(0,Q.t)("Save & go to new dashboard"):(0,Q.t)("Save & go to dashboard")),(0,Ue.tZ)(wt.Z,{id:"btn_modal_save",buttonSize:"small",buttonStyle:"primary",onClick:()=>this.saveOrOverwrite(!1),disabled:!this.state.newSliceName},!this.canOverwriteSlice()&&this.props.slice?(0,Q.t)("Save as new chart"):this.isNewDashboard()?(0,Q.t)("Save to new dashboard"):(0,Q.t)("Save")))},(0,Ue.tZ)(Gt.l0,{layout:"vertical"},(this.state.alert||this.props.alert)&&(0,Ue.tZ)(Xt.Z,{type:"warning",message:(0,Ue.tZ)(n.Fragment,null,this.state.alert?this.state.alert:this.props.alert,(0,Ue.tZ)("i",{role:"button","aria-label":"Remove alert",tabIndex:0,className:"fa fa-close pull-right",onClick:this.removeAlert.bind(this),style:{cursor:"pointer"}}))}),(0,Ue.tZ)(Gt.xJ,null,(0,Ue.tZ)(ta.Y,{id:"overwrite-radio",disabled:!this.canOverwriteSlice(),checked:"overwrite"===this.state.action,onChange:()=>this.changeAction("overwrite")},(0,Q.t)("Save (Overwrite)")),(0,Ue.tZ)(ta.Y,{id:"saveas-radio",checked:"saveas"===this.state.action,onChange:()=>this.changeAction("saveas")},(0,Q.t)("Save as..."))),(0,Ue.tZ)("hr",null),(0,Ue.tZ)(Gt.xJ,{label:(0,Q.t)("Chart name"),required:!0},(0,Ue.tZ)(Jt.II,{name:"new_slice_name",type:"text",placeholder:"Name",value:this.state.newSliceName,onChange:this.onSliceNameChange})),(0,Ue.tZ)(Gt.xJ,{label:(0,Q.t)("Add to dashboard")},(0,Ue.tZ)(aa.Ph,{allowClear:!0,allowNewOptions:!0,ariaLabel:(0,Q.t)("Select a dashboard"),options:this.props.dashboards,onChange:this.onDashboardSelectChange,value:e||void 0,placeholder:(0,Ue.tZ)("div",null,(0,Ue.tZ)("b",null,(0,Q.t)("Select")),(0,Q.t)(" a dashboard OR "),(0,Ue.tZ)("b",null,(0,Q.t)("create")),(0,Q.t)(" a new one"))}))))}}const sa=(0,Ce.$j)((function({explore:e,saveModal:t}){var a;return{datasource:e.datasource,slice:e.slice,userId:null==(a=e.user)?void 0:a.userId,dashboards:t.dashboards,alert:t.saveModalAlert}}),(()=>({})))(na);var ia=a(90233),ca=a(41331),la=a(93185),da=a(27034),ua=a(42753),fa=a(99963);const ha=qe.iK.div`
  ...
  `}
`;function pa(e){const{labelRef:t,showTooltip:a,type:r,value:o}=e,[{isDragging:n},s]=(0,da.c)({item:{value:e.value,type:e.type},collect:e=>({isDragging:e.isDragging()})}),i={labelRef:t,showTooltip:!n&&a,showType:!0};return(0,Ue.tZ)(ha,{ref:s},r===ua.g.Column?(0,Ue.tZ)(fa.l,Fe()({column:o},i)):(0,Ue.tZ)(fa.B,Fe()({metric:o},i)),(0,Ue.tZ)(Ye.Z.Drag,null))}const ba=(0,y.cr)(la.T.ENABLE_EXPLORE_DRAG_AND_DROP),ma=qe.iK.button`
  background: none;
  border: none;
  text-decoration: underline;
...
`,_a=qe.iK.div`
  ...
  `}
`,wa=e=>{const t={labelRef:(0,n.useRef)(null)};return(0,Ue.tZ)(ya,{className:e.className},n.cloneElement(e.children,t))};function Ea({datasource:e,controls:{datasource:t},actions:a,shouldForceUpdate:r}){const{columns:o,metrics:s}=e,i=(0,n.useMemo)((()=>[...o].sort(((e,t)=>e.is_dttm&&!t.is_dttm?-1:t.is_dttm&&!e.is_dttm?1:0))),[o]),[c,l]=(0,n.useState)(!1),[d,u]=(0,n.useState)(""),[f,h]=(0,n.useState)({columns:i,metrics:s}),[p,b]=(0,n.useState)(!1),[g,v]=(0,n.useState)(!1),y=(0,n.useMemo)((()=>m()((e=>{h(""!==e?{columns:(0,ia.Lu)(i,e,{keys:[{key:"verbose_name",threshold:ia.tL.CONTAINS},{key:"column_name",threshold:ia.tL.CONTAINS},{key:e=>[e.description,e.expression].map((e=>(null==e?void 0:e.replace(/[_\n\s]+/g," "))||"")),threshold:ia.tL.CONTAINS,maxRanking:ia.tL.CONTAINS}],keepDiacritics:!0}),metrics:(0,ia.Lu)(s,e,{keys:[{key:"verbose_name",threshold:ia.tL.CONTAINS},{key:"metric_name",threshold:ia.tL.CONTAINS},{key:e=>[e.description,e.expression].map((e=>(null==e?void 0:e.replace(/[_\n\s]+/g," "))||"")),threshold:ia.tL.CONTAINS,maxRanking:ia.tL.CONTAINS}],keepDiacritics:!0,baseSort:(e,t)=>Number(t.item.is_certified)-Number(e.item.is_certified)||String(e.rankedValue).localeCompare(t.rankedValue)})}:{columns:i,metrics:s})}),Ge.oP)),[i,s]);(0,n.useEffect)((()=>{h({columns:i,metrics:s}),u("")}),[i,e,s]);const S=(0,n.useMemo)((()=>p?f.metrics:f.metrics.slice(0,50)),[f.metrics,p]),_=(0,n.useMemo)((()=>(g?f.columns:f.columns.slice(0,50)).sort(((e,t)=>t.is_certified-e.is_certified))),[f.columns,g]),w=(0,n.useMemo)((()=>(0,Ue.tZ)(n.Fragment,null,(0,Ue.tZ)(Jt.II,{allowClear:!0,onChange:e=>{u(e.target.value),y(e.target.value)},value:d,className:"form-control input-md",placeholder:(0,Q.t)("Search Metrics & Columns")}),(0,Ue.tZ)("div",{className:"field-selections"},e.type===$t.i9.Query&&"false"!==sessionStorage.getItem("showInfobox")&&(0,Ue.tZ)(_a,null,(0,Ue.tZ)(Xt.Z,{closable:!0,onClose:()=>sessionStorage.setItem("showInfobox","false"),type:"info",message:"",description:(0,Ue.tZ)(n.Fragment,null,(0,Ue.tZ)("span",{role:"button",tabIndex:0,onClick:()=>l(!0),className:"add-dataset-alert-description"},(0,Q.t)("Create a dataset")),(0,Q.t)(" to edit or add columns and metrics."))})),(0,Ue.tZ)(jt.Z,{defaultActiveKey:["metrics","column"],expandIconPosition:"right",ghost:!0},(0,Ue.tZ)(jt.Z.Panel,{header:(0,Ue.tZ)(Sa,null,(0,Q.t)("Metrics")),key:"metrics"},(0,Ue.tZ)("div",{className:"field-length"},(0,Q.t)("Showing %s of %s",S.length,f.metrics.length)),S.map((e=>(0,Ue.tZ)(wa,{key:e.metric_name+String(r),className:"column"},ba?(0,Ue.tZ)(pa,{value:e,type:ua.g.Metric}):(0,Ue.tZ)(fa.B,{metric:e,showType:!0})))),f.metrics.length>50?(0,Ue.tZ)(ga,null,(0,Ue.tZ)(ma,{onClick:()=>b(!p)},p?(0,Q.t)("Show less..."):(0,Q.t)("Show all..."))):(0,Ue.tZ)(n.Fragment,null)),(0,Ue.tZ)(jt.Z.Panel,{header:(0,Ue.tZ)(Sa,null,(0,Q.t)("Columns")),key:"column"},(0,Ue.tZ)("div",{className:"field-length"},(0,Q.t)("Showing %s of %s",_.length,f.columns.length)),_.map((e=>(0,Ue.tZ)(wa,{key:e.column_name+String(r),className:"column"},ba?(0,Ue.tZ)(pa,{value:e,type:ua.g.Column}):(0,Ue.tZ)(fa.l,{column:e,showType:!0})))),f.columns.length>50?(0,Ue.tZ)(ga,null,(0,Ue.tZ)(ma,{onClick:()=>v(!g)},g?(0,Q.t)("Show Less..."):(0,Q.t)("Show all..."))):(0,Ue.tZ)(n.Fragment,null)))))),[_,d,f.columns.length,f.metrics.length,S,y,g,p,r]);return(0,Ue.tZ)(va,null,(0,Ue.tZ)(ca.W,{visible:c,onHide:()=>l(!1),buttonTextOnSave:(0,Q.t)("Save"),buttonTextOnOverwrite:(0,Q.t)("Overwrite"),datasource:e}),(0,Ue.tZ)(Ht.Z,Fe()({},t,{name:"datasource",actions:a})),null!=e.id&&w)}var Ta=a(28062),xa=a(41609),Ca=a.n(xa),Za=a(18446),Aa=a.n(Za),Da=a(88306),ka=a.n(Da),Oa=a(38575),Ra=a(92252);const Na=ka()(((e,t)=>{const a={};return((null==t?void 0:t.controlPanelSections)||[]).filter(Oa.D_).forEach((e=>{e.controlSetRows.forEach((e=>{e.forEach((e=>{e&&("string"==typeof e?a[e]=Ra.ai[e]:e.name&&e.config&&(a[e.name]=e.config))}))}))})),a}));var Ia=a(68073),$a=a(76962);const Ua={origFormData:Pe().object.isRequired,currentFormData:Pe().object.isRequired},Ma=qe.iK.span`
  ${({theme:e})=>`\n    font-size: ${e.typography.sizes.s}px;\n    color: ${e.colors.grayscale.dark1};\n    background-color: ${e.colors.alert.base};\n\n    &: hover {\n      background-color: ${e.colors.alert.dark1};\n    }\n  `}
`;function Fa(e){if(null==e||""===e)return null;if("object"==typeof e){if(Array.isArray(e)&&0===e.length)return null;const t=Object.keys(e);if(t&&0===t.length)return null}return e}class ja extends n.Component{constructor(e){super(e);const t=this.getDiffs(e),a=(e=>{const t=(0,Ut.Z)().get(e);return Na(e,t)})(this.props.origFormData.viz_type),r=this.getRowsFromDiffs(t,a);this.state={rows:r,hasDiffs:!Ca()(t),controlsMap:a}}UNSAFE_componentWillReceiveProps(e){if(Aa()(this.props,e))return;const t=this.getDiffs(e);this.setState((e=>({rows:this.getRowsFromDiffs(t,e.controlsMap),hasDiffs:!Ca()(t)})))}getRowsFromDiffs(e,t){return Object.entries(e).map((([e,a])=>({control:t[e]&&t[e].label||e,before:this.formatValue(a.before,e,t),after:this.formatValue(a.after,e,t)})))}getDiffs(e){const t=(0,nt.BR)(e.origFormData),a=(0,nt.BR)(e.currentFormData),r=Object.keys(a),o={};return r.forEach((e=>{(t[e]||a[e])&&(["filters","having","having_filters","where"].includes(e)||this.isEqualish(t[e],a[e])||(o[e]={before:t[e],after:a[e]}))})),o}isEqualish(e,t){return Aa()(Fa(e),Fa(t))}formatValue(e,t,a){var r,o,n,s;if(void 0===e)return"N/A";if(null===e)return"null";if("AdhocFilterControl"===(null==(r=a[t])?void 0:r.type))return e.length?e.map((e=>{const t=e.comparator&&e.comparator.constructor===Array?`[${e.comparator.join(", ")}]`:e.comparator;return`${e.subject} ${e.operator} ${t}`})).join(", "):"[]";if("BoundsControl"===(null==(o=a[t])?void 0:o.type))return`Min: ${e[0]}, Max: ${e[1]}`;if("CollectionControl"===(null==(n=a[t])?void 0:n.type))return e.map((e=>(0,f.o)(e))).join(", ");if("MetricsControl"===(null==(s=a[t])?void 0:s.type)&&e.constructor===Array){const t=e.map((e=>{var t;return null!=(t=null==e?void 0:e.label)?t:e}));return t.length?t.join(", "):"[]"}if("boolean"==typeof e)return e?"true":"false";if(e.constructor===Array){const t=e.map((e=>{var t;return null!=(t=null==e?void 0:e.label)?t:e}));return t.length?t.join(", "):"[]"}return"string"==typeof e||"number"==typeof e?e:(0,f.o)(e)}renderModalBody(){return(0,Ue.tZ)($a.Z,{columns:[{accessor:"control",Header:"Control"},{accessor:"before",Header:"Before"},{accessor:"after",Header:"After"}],data:this.state.rows,pageSize:50,className:"table-condensed",columnsForWrapText:["Control","Before","After"]})}renderTriggerNode(){return(0,Ue.tZ)(Be.u,{id:"difference-tooltip",title:(0,Q.t)("Click to see difference")},(0,Ue.tZ)(Ma,{className:"label"},(0,Q.t)("Altered")))}render(){return this.state.hasDiffs?(0,Ue.tZ)(Ia.Z,{triggerNode:this.renderTriggerNode(),modalTitle:(0,Q.t)("Chart changes"),modalBody:this.renderModalBody(),responsive:!0}):null}}ja.propTypes=Ua;var La=a(83673),za=a(52564),Pa=a(94413);const qa={actions:Pe().object.isRequired,canOverwrite:Pe().bool.isRequired,canDownload:Pe().bool.isRequired,dashboardId:Pe().number,isStarred:Pe().bool.isRequired,slice:Pe().object,sliceName:Pe().string,table_name:Pe().string,formData:Pe().object,ownState:Pe().object,timeout:Pe().number,chart:rt.$6,saveDisabled:Pe().bool},Ha=e=>Ue.iv`
  color: ${e.colors.primary.dark2};
  & > span[role='img'] {
    margin-right: 0;
  }
`,Qa=({dashboardId:e,slice:t,actions:a,formData:r,ownState:o,chart:s,user:i,canOverwrite:c,canDownload:l,isStarred:d,sliceUpdated:f,sliceName:h,onSaveChart:p,saveDisabled:b})=>{const{latestQueryFormData:m,sliceFormData:g}=s,[v,y]=(0,n.useState)(!1);(0,n.useEffect)((()=>{e&&(async()=>{await u.Z.get({endpoint:`/api/v1/chart/${t.slice_id}`}).then((t=>{var a;const r=null==t||null==(a=t.json)?void 0:a.result;if(r&&r.dashboards&&r.dashboards.length){const{dashboards:t}=r,a=e&&t.length&&t.find((t=>t.id===e));if(a&&a.json_metadata){const e=JSON.parse(a.json_metadata),t={...e.shared_label_colors||{},...e.label_colors||{}},r=Ta.getNamespace();Object.keys(t).forEach((a=>{r.setColor(a,t[a],e.color_scheme)}))}}})).catch((()=>{}))})()}),[]);const[S,_,w]=(0,Pa.gT)(m,l,t,a.redirectSQLLab,(()=>{y(!0)}),o),E=null==t?void 0:t.slice_name;return(0,Ue.tZ)(n.Fragment,null,(0,Ue.tZ)(za.u,{editableTitleProps:{title:h,canEdit:!t||c||((null==t?void 0:t.owners)||[]).includes(null==i?void 0:i.userId),onSave:a.updateChartTitle,placeholder:(0,Q.t)("Add the name of the chart"),label:(0,Q.t)("Chart title")},showTitlePanelItems:!!t,certificatiedBadgeProps:{certifiedBy:null==t?void 0:t.certified_by,details:null==t?void 0:t.certification_details},showFaveStar:!(null==i||!i.userId),faveStarProps:{itemId:null==t?void 0:t.slice_id,fetchFaveStar:a.fetchFaveStar,saveFaveStar:a.saveFaveStar,isStarred:d,showTooltip:!0},titlePanelAdditionalItems:g?(0,Ue.tZ)(ja,{className:"altered",origFormData:{...g,chartTitle:E},currentFormData:{...r,chartTitle:h}}):null,rightPanelAdditionalItems:(0,Ue.tZ)(Be.u,{title:b?(0,Q.t)("Add required control values to save chart"):null},(0,Ue.tZ)("div",null,(0,Ue.tZ)(wt.Z,{buttonStyle:"secondary",onClick:p,disabled:b,css:Ha},(0,Ue.tZ)(Ye.Z.SaveOutlined,{iconSize:"l"}),(0,Q.t)("Save")))),additionalActionsMenu:S,menuDropdownProps:{visible:_,onVisibleChange:w}}),v&&(0,Ue.tZ)(La.Z,{show:v,onHide:()=>{y(!1)},onSave:f,slice:t}))};Qa.propTypes=qa;const Va=(0,Ce.$j)(null,(function(e){return(0,i.DE)({sliceUpdated:_e,toggleActive:Z.M,deleteActiveReport:Z.MZ},e)}))(Qa),Ba={...It.propTypes,actions:Pe().object.isRequired,datasource_type:Pe().string.isRequired,dashboardId:Pe().number,isDatasourceMetaLoading:Pe().bool.isRequired,chart:rt.$6.isRequired,slice:Pe().object,sliceName:Pe().string,controls:Pe().object.isRequired,forcedHeight:Pe().string,form_data:Pe().object.isRequired,standalone:Pe().number.isRequired,force:Pe().bool,timeout:Pe().number,impressionId:Pe().string,vizType:Pe().string},Ka=qe.iK.div`
  display: flex;
  flex-direction: column;
  height: 100%;
`,Wa=qe.iK.div`
