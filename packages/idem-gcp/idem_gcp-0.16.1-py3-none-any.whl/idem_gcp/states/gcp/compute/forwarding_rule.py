...
async def present(
    ...
    r"""Creates a ForwardingRule resource in the specified project and region using the data included in the request.
        or
        Updates a ForwardingRule resource in the specified project and region using the data included in the request.
    ...
    Args:
        ...
        metadata_filters(List[Dict[str, Any]], Optional):
            ...
            * filter_match_criteria (str, Optional): Specifies how individual filter label matches within the list of filterLabels and contributes toward the overall metadataFilter match. Supported values are: - MATCH_ANY: at least one of the filterLabels must have a matching label in the provided metadata. - MATCH_ALL: all filterLabels must have matching labels in the provided metadata.
                Enum type. Allowed values:
