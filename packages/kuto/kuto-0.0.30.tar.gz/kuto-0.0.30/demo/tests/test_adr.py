...
class HomePage(kuto.Page):
    """首页"""
    ad = kuto.AdrElem(resourceId='com.qizhidao.clientapp:id/bottom_btn')
    my = kuto.AdrElem(text='我的')


class MyPage(kuto.Page):
    """我的页"""
    setting = kuto.AdrElem(resourceId='com.qizhidao.clientapp:id/me_top_bar_setting_iv')
