...
from regio import utils
from regio.registry_auth import HTTPBearerAuth, HTTPBasicAuthWithB64
...
if __name__ == "__main__":
    pass
    "prod.harbor.keysight.digital/loadcore/neo4j-ubi-image:4.2.0-test"
    manifest = ContainerRegistry("prod.harbor.keysight.digital", None).get_manifest(
        "loadcore/neo4j-ubi-image", "4.2.0-test"
    )
    manifest = ContainerRegistry("prod.harbor.keysight.digital", None).get_tags("loadcore/neo4j-ubi-image")
    print(manifest)
    # m = get_manifest(
    #     "prod.harbor.keysight.digital",
    #     None,
    #     "loadcore/neo4j-ubi-image",
    #     "4.2.0-test",
    # )
    # config = {
    #     "auths": {
    #         "registry.redhat.io": {"auth": "c2FuZGFyZW51bTpLR05zbTRoQTU3U2dVekw="},
    #         "sourcecontrol.hsenidmobile.com:5050": {
    #             "auth": "bXVsdGktbGluZ3VhbC1ib3QtcHJvamVjdC1hY2Nlc3MtdG9rZW46Z2xwYXQtenhRa2dkZW1lU3l4WEFhelU3Vi0="
    #         },
    #     }
    # }
    # m = get_manifest(
    #     "sourcecontrol.hsenidmobile.com:5050",
    #     json.dumps(config),
    #     "datascience/chatbot/multi-lingual-bot/ui_frontend",
    #     "sha256:99c3a90394d62457b67194f4451c675cdb1ddc4fc9d2bf4f3501944057268ad0",
    # )
    # print(m)
