...
@jsii.data_type(
    jsii_type="raindancers-network.sso.AssignmentAttributes",
    jsii_struct_bases=[],
    name_mapping={},
)
...
@jsii.data_type(
    jsii_type="raindancers-network.sso.AssignmentOptions",
    jsii_struct_bases=[],
    name_mapping={
        "principal": "principal",
        "target_id": "targetId",
...
class AssignmentOptions:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6077cd4ce5d43c09431d91159e235dfd426a4d22967fe38e8334c4f87f645611)
...
@jsii.data_type(
    jsii_type="raindancers-network.sso.AssignmentProps",
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(principal, dict):
            principal = PrincipalProperty(**principal)
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__eced49f0801322a3378bef7d8e31dbe5cdec53cda33298e6b9e9a71671c4e349)
            check_type(argname="argument principal", value=principal, expected_type=type_hints["principal"])
            check_type(argname="argument target_id", value=target_id, expected_type=type_hints["target_id"])
            check_type(argname="argument target_type", value=target_type, expected_type=type_hints["target_type"])
...
@jsii.data_type(
    jsii_type="raindancers-network.sso.CustomerManagedPolicyReference",
    jsii_struct_bases=[
...
class CustomerManagedPolicyReference(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2d43b945b70a4e6d3db4ad0675ccf22daf31b570663e3552a4746bfe6338acfa)
...
@jsii.interface(jsii_type="raindancers-network.sso.IAssignment")
...
class _IAssignmentProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "raindancers-network.sso.IAssignment"
    pass
...
@jsii.interface(jsii_type="raindancers-network.sso.IPermissionSet")
...
class _IPermissionSetProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "raindancers-network.sso.IPermissionSet"
    ...
    def grant(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__05f38d13a5d0ac04796985e06eb48e6ae08f701c4281b5e2972287cdb28e73c6)
...
@jsii.data_type(
    jsii_type="raindancers-network.sso.PermissionBoundary",
    jsii_struct_bases=[
...
class PermissionBoundary(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3a3e8ce45b8ebaacf3a4a78a0e5b7a74448a56544a54c04ddc8e5c0dc35da480)
...
class PermissionSet(
    ...
    jsii_type="raindancers-network.sso.PermissionSet",
):
    '''
    :stability: experimental
    '''
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1c198f59e8b8ca2d5b101b1dfbd0365ee0d4acb7635a0431670f888e8df99bd0)
    ...
    def from_permission_set_arn(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__23dfeb6edc33c706a0799a0df1d6bed87468ba0e89e37715fce09207a42c89f7)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def grant(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b640e0d6d1d227b65f3d4d68fc81bafbf1b9ce715c57546ea80e97546bf5ca8f)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        assignment_options = AssignmentOptions(
            principal=principal, target_id=target_id, target_type=target_type
        )
...
@jsii.data_type(
    jsii_type="raindancers-network.sso.PermissionSetAttributes",
    jsii_struct_bases=[],
    name_mapping={
...
class PermissionSetAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1dab672c395347f383301853e6db6a6972effc2446605adef50e260cfc8f27e8)
            check_type(argname="argument permission_set_arn", value=permission_set_arn, expected_type=type_hints["permission_set_arn"])
...
@jsii.data_type(
    jsii_type="raindancers-network.sso.PermissionSetProps",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
        "sso_instance_arn": "ssoInstanceArn",
...
class PermissionSetProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__baffff8a9675756c1ee3783cb685be8b2eb7ed3b73132ad8c04df9f66e2e23c5)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument sso_instance_arn", value=sso_instance_arn, expected_type=type_hints["sso_instance_arn"])
...
@jsii.data_type(
    jsii_type="raindancers-network.sso.PrincipalProperty",
    jsii_struct_bases=[],
...
class PrincipalProperty:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1d6c282cd84c0231d1751f177493d7b4b1c64ef15a10b7c046ce2e2b30d1ec2a)
...
@jsii.enum(jsii_type="raindancers-network.sso.PrincipalTypes")
...
@jsii.enum(jsii_type="raindancers-network.sso.TargetTypes")
...
class Assignment(
    _aws_cdk_ceddda9d.Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="raindancers-network.sso.Assignment",
):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__31aa9d2680f4eed1df9847ba22c0cfd350fb9ae67be98ea27116781250808dd9)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
def _typecheckingstub__6077cd4ce5d43c09431d91159e235dfd426a4d22967fe38e8334c4f87f645611(
    *,
    principal: typing.Union[PrincipalProperty, typing.Dict[builtins.str, typing.Any]],
    target_id: builtins.str,
    target_type: typing.Optional[TargetTypes] = None,
...
def _typecheckingstub__eced49f0801322a3378bef7d8e31dbe5cdec53cda33298e6b9e9a71671c4e349(
    *,
    principal: typing.Union[PrincipalProperty, typing.Dict[builtins.str, typing.Any]],
    target_id: builtins.str,
    target_type: typing.Optional[TargetTypes] = None,
...
def _typecheckingstub__2d43b945b70a4e6d3db4ad0675ccf22daf31b570663e3552a4746bfe6338acfa(
    *,
    name: builtins.str,
    path: typing.Optional[builtins.str] = None,
) -> None:
...
def _typecheckingstub__05f38d13a5d0ac04796985e06eb48e6ae08f701c4281b5e2972287cdb28e73c6(
    id: builtins.str,
    *,
    principal: typing.Union[PrincipalProperty, typing.Dict[builtins.str, typing.Any]],
    target_id: builtins.str,
...
def _typecheckingstub__3a3e8ce45b8ebaacf3a4a78a0e5b7a74448a56544a54c04ddc8e5c0dc35da480(
    *,
    customer_managed_policy_reference: typing.Optional[typing.Union[_aws_cdk_ceddda9d.IResolvable, typing.Union[_aws_cdk_aws_sso_ceddda9d.CfnPermissionSet.CustomerManagedPolicyReferenceProperty, typing.Dict[builtins.str, typing.Any]]]] = None,
    managed_policy_arn: typing.Optional[builtins.str] = None,
) -> None:
...
def _typecheckingstub__1c198f59e8b8ca2d5b101b1dfbd0365ee0d4acb7635a0431670f888e8df99bd0(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    name: builtins.str,
...
def _typecheckingstub__23dfeb6edc33c706a0799a0df1d6bed87468ba0e89e37715fce09207a42c89f7(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    permission_set_arn: builtins.str,
) -> None:
...
def _typecheckingstub__b640e0d6d1d227b65f3d4d68fc81bafbf1b9ce715c57546ea80e97546bf5ca8f(
    id: builtins.str,
    *,
    principal: typing.Union[PrincipalProperty, typing.Dict[builtins.str, typing.Any]],
    target_id: builtins.str,
...
def _typecheckingstub__1dab672c395347f383301853e6db6a6972effc2446605adef50e260cfc8f27e8(
    *,
    permission_set_arn: builtins.str,
    sso_instance_arn: builtins.str,
) -> None:
...
def _typecheckingstub__baffff8a9675756c1ee3783cb685be8b2eb7ed3b73132ad8c04df9f66e2e23c5(
    *,
    name: builtins.str,
    sso_instance_arn: builtins.str,
    aws_managed_policies: typing.Optional[typing.Sequence[_aws_cdk_aws_iam_ceddda9d.IManagedPolicy]] = None,
...
def _typecheckingstub__1d6c282cd84c0231d1751f177493d7b4b1c64ef15a10b7c046ce2e2b30d1ec2a(
    *,
    principal_id: builtins.str,
    principal_type: PrincipalTypes,
) -> None:
...
def _typecheckingstub__31aa9d2680f4eed1df9847ba22c0cfd350fb9ae67be98ea27116781250808dd9(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    permission_set: IPermissionSet,
