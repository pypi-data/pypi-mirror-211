...
from ccpem_utils.map.array_utils import calculate_contour_by_sigma
import mrcfile
...
def calc_mrc_sigma_contour(map_input: str):
    with mrcfile.open(map_input, mode="r", permissive=True) as mrc:
        return calculate_contour_by_sigma(arr=mrc.data)
