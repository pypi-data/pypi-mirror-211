...
class spotON_Area():
    ...
    CZ = Area_details(name='CZ',code='10YCZ-CEPS-----N',tz='Europe/Prague')
    CZ_DE_SK = Area_details(name='CZ_DE_SK',code='10YDOM-CZ-DE-SKK',tz='Europe/Prague')
    ...
    DK = Area_details(name='DK',code='10Y1001A1001A65H',tz='Europe/Copenhagen')
    DK_1 = Area_details(name='DK_1',code='10YDK-1--------W',tz='Europe/Copenhagen')
    DK_1_NO_1 = Area_details(name='DK_1_NO_1',code='46Y000000000007M',tz='Europe/Copenhagen')
    DK_2 = Area_details(name='DK_2',code='10YDK-2--------M',tz='Europe/Copenhagen')
    DK_CA = Area_details(name='DK_CA',code='10Y1001A1001A796',tz='Europe/Copenhagen')
    ...
    HR = Area_details(name='HR',code='10YHR-HEP------M',tz='Europe/Zagreb')
    HU = Area_details(name='HU',code='10YHU-MAVIR----U',tz='Europe/Budapest')
    ...
    PL = Area_details(name='PL',code='10YPL-AREA-----S',tz='Europe/Warsaw')
    PL_CZ = Area_details(name='PL_CZ',code='10YDOM-1001A082L',tz='Europe/Warsaw')
    PT = Area_details(name='PT',code='10YPT-REN------W',tz='Europe/Lisbon')
    RO = Area_details(name='RO',code='10YRO-TEL------P',tz='Europe/Bucharest')
    ...
    SE = Area_details(name='SE',code='10YSE-1--------K',tz='Europe/Stockholm')
    SE_1 = Area_details(name='SE_1',code='10Y1001A1001A44P',tz='Europe/Stockholm')
    SE_2 = Area_details(name='SE_2',code='10Y1001A1001A45N',tz='Europe/Stockholm')
    SE_3 = Area_details(name='SE_3',code='10Y1001A1001A46L',tz='Europe/Stockholm')
    SE_4 = Area_details(name='SE_4',code='10Y1001A1001A47J',tz='Europe/Stockholm')
