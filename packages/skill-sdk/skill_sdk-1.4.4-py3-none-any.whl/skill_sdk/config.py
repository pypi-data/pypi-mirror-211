...
class Settings(BaseSettings):
    ...
    # Client types for which the speaker shutdown post roll is active
    POST_ROLL_CLIENT_TYPES: List[str] = ["SmartSpeaker", "SmartSpeakerMini"]

    # The date at which to start showing the post roll message
    POST_ROLL_START_DATE: date = date(2023, 6, 12)

    # The skills in which the post roll should be shown
    POST_ROLL_SKILLS: List[str] = [
        "skill-radioplayer",
    ...
    # The post roll message attached to the end of the response
    POST_ROLL_MESSAGE: str = (
        "Davor noch kurz ein Hinweis: Alle Magenta Speaker verlieren zum dreißigsten "
        "Juni Zugang zum Internet. Alle bisherigen Sprachfunktionen sind dann nicht "
        "mehr verfügbar. Mehr Infos findest du jetzt in deiner Hallo Magenta App."
    )

    # The URL used for connecting to the persistence service for post roll
    PERSISTENCE_SERVICE_URL: str = ""

    # The skill token used for identifying post roll data in the persistence service
    PERSISTENCE_SERVICE_SKILL_TOKEN: str = ""
