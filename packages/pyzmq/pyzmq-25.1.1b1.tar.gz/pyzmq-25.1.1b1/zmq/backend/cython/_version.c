...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "zmq.backend.cython._version",
        "sources": [
            "zmq/backend/cython/_version.pyx"
        ]
    },
    "module_name": "zmq.backend.cython._version"
}
END: Cython Metadata */
...
extern int __pyx_module_is_main_zmq__backend__cython___version;
...
static const char __pyx_k_zmq_backend_cython__version[] = "zmq.backend.cython._version";
static const char __pyx_k_PyZMQ_and_0MQ_version_functions[] = "PyZMQ and 0MQ version functions.";
static const char __pyx_k_zmq_backend_cython__version_pyx[] = "zmq/backend/cython/_version.pyx";
...
static PyObject *__pyx_kp_s_zmq_backend_cython__version_pyx;
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_major); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_minor); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_patch); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 39, __pyx_L1_error)
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_zmq_backend_cython__version_pyx, __pyx_k_zmq_backend_cython__version_pyx, sizeof(__pyx_k_zmq_backend_cython__version_pyx), 0, 0, 1, 0},
 ...
 * 
 */
  __pyx_tuple_ = PyTuple_Pack(3, __pyx_n_s_major, __pyx_n_s_minor, __pyx_n_s_patch); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(0, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_zmq_backend_cython__version_pyx, __pyx_n_s_zmq_version_info, 32, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "zmq.backend.cython._version")) {
      if (unlikely(PyDict_SetItemString(modules, "zmq.backend.cython._version", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_3zmq_7backend_6cython_8_version_1zmq_version_info, 0, __pyx_n_s_zmq_version_info, NULL, __pyx_n_s_zmq_backend_cython__version, __pyx_d, ((PyObject *)__pyx_codeobj__2)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_zmq_version_info, __pyx_t_1) < 0) __PYX_ERR(0, 32, __pyx_L1_error)
