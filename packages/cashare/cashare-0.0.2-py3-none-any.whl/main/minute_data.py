...
def hg(sk_code,start_date,end_date,token,type):
    g_url=url2+'/us/stock/ts/'+sk_code+'/'+type+'/'+start_date+'/'+end_date+'/'+token
    return g_url
...
if __name__ == '__main__':
    df=m_data(sk_code="aapl",token='o458791c937789bbdcfd3d4e4ac5f7af738',type='30min',start_date='2023-05-02',end_date='2023-05-02')
    print(df)
