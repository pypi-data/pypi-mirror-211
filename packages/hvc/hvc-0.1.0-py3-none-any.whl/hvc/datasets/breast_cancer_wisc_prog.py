...
class BreastCancerWiscProg(DatasetFourFold):
    """`Breast Cancer Wisconsin (Prognostic) <https://archive.ics.uci.edu/ml/datasets/breast+cancer+wisconsin+(Prognostic)>`_ dataset.
