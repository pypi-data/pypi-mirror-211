...
class BreastCancerWisc(DatasetFourFold):
    """`Breast Cancer Wisconsin (Original) <https://archive.ics.uci.edu/ml/datasets/breast+cancer+wisconsin+%28original%29>`_ dataset.
