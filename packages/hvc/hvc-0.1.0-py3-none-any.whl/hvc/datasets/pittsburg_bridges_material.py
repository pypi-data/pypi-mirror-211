...
class PittsburgBridgesMaterial(DatasetFourFold):
    """`Pittsburgh Bridges <https://archive.ics.uci.edu/ml/datasets/Pittsburgh+Bridges>`_ dataset.
    ...
    name = "pittsburg-bridges-MATERIAL"
    classes: List[str] = [
        "wood",
        "iron",
        "steel",
