...
class Memory:
    ...
    def add(self, key: VSATensor, value: Any) -> None:
        ...
        Examples::
            ...
            >>> letters_hv = hvc.random(len(letters), 10000)
...
class HashTable:
    ...
    def from_tensors(cls, keys: VSATensor, values: VSATensor):
        ...
        Examples::
            >>> letters_hv = hvc.random(len(letters), 10000)
            >>> values = hvc.random(len(letters), 10000)
