...
class FHRRTensor(VSATensor):
    ...
    def empty(
        ...
        *,
        ...
        Examples::
            ...
            >>> hvc.FHRRTensor.empty(3, 6)
            FHRR([[0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j],
                    [0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j],
                    [0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j]])

            >>> hvc.FHRRTensor.empty(3, 6, dtype=torch.complex128)
            FHRR([[0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j],
                    [0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j],
                    [0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j, 0.+0.j]],
    ...
    def identity(
        ...
        *,
        ...
        Examples::
            ...
            >>> hvc.FHRRTensor.identity(3, 6)
            FHRR([[1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j],
                    [1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j],
                    [1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j]])

            >>> hvc.FHRRTensor.identity(3, 6, dtype=torch.complex128)
            FHRR([[1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j],
                    [1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j],
                    [1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j, 1.+0.j]],
                   dtype=torch.complex128)
    ...
    def random(
        ...
        *,
        ...
        Examples::
            ...
            >>> hvc.FHRRTensor.random(3, 6, dtype=torch.long)
    ...
    def bundle(self, other: "FHRRTensor") -> "FHRRTensor":
        ...
        Examples::
            ...
            >>> a, b = hvc.FHRRTensor.random(2, 10, dtype=torch.complex128)
            >>> a
    ...
    def bind(self, other: "FHRRTensor") -> "FHRRTensor":
        ...
        Examples::
            ...
            >>> a, b = hvc.FHRRTensor.random(2, 6, dtype=torch.complex128)
            >>> a
