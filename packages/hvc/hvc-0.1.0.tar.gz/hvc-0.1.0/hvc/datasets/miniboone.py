...
class Miniboone(DatasetFourFold):
    """`MiniBooNE particle identification <https://archive.ics.uci.edu/ml/datasets/MiniBooNE+particle+identification>`_ dataset.
