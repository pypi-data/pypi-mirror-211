...
from hvc.datasets import DatasetFourFold


class PostOperative(DatasetFourFold):
    """`Post-Operative Patient <https://archive.ics.uci.edu/ml/datasets/Post-Operative+Patient>`_ dataset.
    ...
    name = "post-operative"
    classes: List[str] = [
        "patient sent to general hospital floor",
        "patient sent to intensive care unit",
        "patient prepared to go home",
    ]
