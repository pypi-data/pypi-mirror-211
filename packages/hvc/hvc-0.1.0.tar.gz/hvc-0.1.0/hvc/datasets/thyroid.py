...
from hvc.datasets import DatasetTrainTest


class Thyroid(DatasetTrainTest):
    """`Thyroid Disease <https://archive.ics.uci.edu/ml/datasets/thyroid+disease>`_ dataset.
