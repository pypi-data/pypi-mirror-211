...
class BreastCancerWiscDiag(DatasetFourFold):
    """`Breast Cancer Wisconsin (Diagnostic) <https://archive.ics.uci.edu/ml/datasets/breast+cancer+wisconsin+(diagnostic)>`_ dataset.
