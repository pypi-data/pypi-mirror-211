...
class Cardiotocography10Clases(DatasetFourFold):
    """`Cardiotocography <https://archive.ics.uci.edu/ml/datasets/cardiotocography>`_ dataset.
    ...
    name = "cardiotocography-10clases"
    classes: List[str] = [
        "1",
        "2",
        "3",
