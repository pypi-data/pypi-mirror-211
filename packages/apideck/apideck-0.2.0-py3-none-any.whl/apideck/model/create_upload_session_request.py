...
class CreateUploadSessionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, parent_folder_id, size, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            drive_id (str): ID of the drive to upload to.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, parent_folder_id, size, *args, **kwargs):  # noqa: E501
        """CreateUploadSessionRequest - a model defined in OpenAPI
