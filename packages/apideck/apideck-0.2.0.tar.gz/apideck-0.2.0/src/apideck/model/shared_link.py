...
class SharedLink(ModelNormal):
    ...
    attribute_map = {
        ...
        'password_protected': 'password_protected',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, target_id, *args, **kwargs):  # noqa: E501
