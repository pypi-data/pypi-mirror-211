...
class CreateFolderRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, parent_folder_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            drive_id (str): ID of the drive to create the folder in.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, parent_folder_id, *args, **kwargs):  # noqa: E501
        """CreateFolderRequest - a model defined in OpenAPI
