...
class OrderLineItems(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'applied_taxes': ([bool, date, datetime, dict, float, int, list, str, none_type],),  # noqa: E501
            'applied_discounts': ([bool, date, datetime, dict, float, int, list, str, none_type],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'applied_taxes': 'applied_taxes',  # noqa: E501
        'applied_discounts': 'applied_discounts',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            applied_taxes ([bool, date, datetime, dict, float, int, list, str, none_type]): [optional]  # noqa: E501
            applied_discounts ([bool, date, datetime, dict, float, int, list, str, none_type]): [optional]  # noqa: E501
            modifiers ([bool, date, datetime, dict, float, int, list, str, none_type]): Customizable options – toppings, add-ons, or special requests – create item modifiers. Modifiers that are applied to items will display on your customers’ digital receipts. [optional]  # noqa: E501
        """
