...
class CreateSessionResponseData(ModelNormal):
    ...
    attribute_map = {
        'session_uri': 'session_uri',  # noqa: E501
        'session_token': 'session_token',  # noqa: E501
    }

    read_only_vars = {
        'session_uri',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, session_uri, session_token, *args, **kwargs):  # noqa: E501
