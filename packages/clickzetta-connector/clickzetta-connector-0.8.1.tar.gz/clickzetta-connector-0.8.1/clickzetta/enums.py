...
class GetJobResultRequest(object):
...
class APIJobRequest(object):
    def __init__(self, get_job_result_request: GetJobResultRequest, user_agent: string):
        self.get_job_result_request = get_job_result_request
        self.user_agent = user_agent
        self._properties = {'get_result_request': get_job_result_request.to_api_repr(), 'user_agent': user_agent}
