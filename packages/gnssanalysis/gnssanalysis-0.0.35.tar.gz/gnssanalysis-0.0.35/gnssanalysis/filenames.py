...
def generate_IGS_long_filename(
    ...
    *,
    end_epoch: datetime.datetime,
    timespan: Optional[datetime.timedelta] = ...,
    solution_type: str = ...,
    sampling_rate: str = ...,
    version: str = ...,
    project: str = ...,
...
def generate_IGS_long_filename(
    ...
    *,
    ...
    Either `end_epoch` or `timespan` must be provided, if both are provided then end_epoch takes precedence.
    ...
    :param Optional[datetime.timedelta] timespan: timedelta representing time range of data in file, defaults to None
