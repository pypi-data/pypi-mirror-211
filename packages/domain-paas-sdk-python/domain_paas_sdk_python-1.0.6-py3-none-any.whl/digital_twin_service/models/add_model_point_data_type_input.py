...
class AddModelPointDataTypeInput(object):
    ...
    def model_component(self, model_component):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and model_component is None:  # noqa: E501
            raise ValueError("Invalid value for `model_component`, must not be `None`")  # noqa: E501
