...
class TimeseriesInput(object):
    ...
    def __init__(self, device_id=None, keys=None, start_ts=None, end_ts=None, order_by=None, local_vars_configuration=None):  # noqa: E501
    ...
    def order_by(self):
        ...
        排序方式，ASC (升序)，DESC (降序) sort order, ASC (ASCENDING) or DESC (DESCENDING)  # noqa: E501
