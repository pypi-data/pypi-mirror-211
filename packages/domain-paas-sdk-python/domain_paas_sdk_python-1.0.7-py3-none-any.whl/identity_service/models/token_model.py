...
class TokenModel(object):
    ...
    def __init__(self, id_token=None, access_token=None, expires_in=None, refresh_token=None, scope=None, error=None, token_type=None, local_vars_configuration=None):  # noqa: E501
