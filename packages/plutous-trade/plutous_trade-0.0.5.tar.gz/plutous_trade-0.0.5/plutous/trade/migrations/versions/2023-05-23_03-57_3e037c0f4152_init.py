...
def upgrade() -> None:
    ...
    exchange_enum = sa.Enum('BINANCE', 'BINANCE_COINM', 'BINANCE_USDM', 'BITGET', 'BYBIT', 'GATEIO', 'HUOBI', 'KUCOIN', 'KUCOIN_FUTURES', 'OKX', 'PHEMEX', 'WOO', name='exchange', schema='public')
    op.create_table('api_key',
    sa.Column('exchange', exchange_enum, nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('key', sa.String(), nullable=False),
    sa.Column('secret', sqlalchemy_utils.types.encrypted.encrypted_type.EncryptedType(), nullable=False),
    sa.Column('passphrase', sqlalchemy_utils.types.encrypted.encrypted_type.EncryptedType(), nullable=True),
    ...
    op.create_index('ix_api_key_created_at', 'api_key', ['created_at'], unique=False, schema='trade')
    op.create_index('ix_api_key_exchange_name', 'api_key', ['exchange', 'name'], unique=True, schema='trade')
    op.create_index('ix_api_key_updated_at', 'api_key', ['updated_at'], unique=False, schema='trade')
    op.create_table('strategy',
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
    sa.Column('type', sa.Enum('MOMENTUM', 'MEAN_REVERSION', 'ARBITRAGE', 'MARKET_MAKING', 'TREND_FOLLOWING', 'SCALPING', name='strategytype', schema='trade'), nullable=False),
    ...
    sa.Column('direction', sa.Enum('LONG', 'SHORT', 'BOTH', name='strategydirection', schema='trade'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_index('ix_strategy_created_at', 'strategy', ['created_at'], unique=False, schema='trade')
    ...
    op.create_index('ix_position_created_at', 'position', ['created_at'], unique=False, schema='trade')
    op.create_index('ix_position_updated_at', 'position', ['updated_at'], unique=False, schema='trade')
    ...
    sa.Column('created_at', sa.TIMESTAMP(), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=False),
    sa.ForeignKeyConstraint(['position_id'], ['trade.position.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='trade'
    )
    op.create_index('ix_trade_created_at', 'trade', ['created_at'], unique=False, schema='trade')
    op.create_index('ix_trade_updated_at', 'trade', ['updated_at'], unique=False, schema='trade')
