...
class Requirements(object):
    ...
    def get():
        ...
        requirements = ['m-singleton', 'asv', 'black', 'coverage[toml]', 'coveralls', 'flake8', 'mock', 'mypy',
                        ...
                        'typing_extensions==4.5.0', 'zope.index==6.0', 'zope.interface==6.0', 'sqlite==3.38.5']
        return requirements


version_dev='1.0.17'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    version='1.0.17',  # Required, Phần này cũng không được format file.
    ...
    # larger catalog.
    keywords="mobio, dedupe, contact spam",  # Optional
