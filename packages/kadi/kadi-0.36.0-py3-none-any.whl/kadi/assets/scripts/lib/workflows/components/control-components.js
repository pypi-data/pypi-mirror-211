...
const variableList = new BuiltinComponent(
  ...
  [
    commonInputs.dep,
    {key: 'names', title: 'Names', socket: sockets.str},
...
const variableJson = new BuiltinComponent(
  ...
  [
    commonInputs.dep,
    {key: 'jsonString', title: 'JSON String', socket: sockets.str},
    {key: 'key', title: 'Key [data]', socket: sockets.str},
  ],
  [commonOutputs.dep],
);
...
const loop = new BuiltinComponent(
  ...
  [
    ...
    {key: 'index', title: 'Index', socket: sockets.int, multi: true},
  ],
);
