...
from uds.common import DiagnosticSession, ResetType, ComType, ComCtrlType, DtcSettingType, CompressionMethod, \
    EncryptionMethod, RoutineControlType, concat_read_data_by_id_request, UdsTimeoutError, \
...
class UdsClient:
    ...
    def read_dtc_information(self,
        ...
        """
        Basic uds service read dtc information.
    ...
    def read_memory_by_address(self,
        ...
        """
        Basic uds service read memory by address.
    ...
    def write_memory_by_address(self,
                                ...
                                addr_size_len: Union[str, Tuple[int, int]] = "auto") -> dict:
        """
        Basic uds service write memory by address.
    ...
    def input_output_control(self,
        ...
        """
        Basic uds service input output control.
    ...
    def link_control(self,
                     ...
                     suppress_response: bool = False) -> dict:
        """
        Basic uds service link control.
    ...
    def read_scaling_data_by_identifier(self,
                                        did: int) -> dict:
        """
        Basic uds service read scaling data by identifier.
