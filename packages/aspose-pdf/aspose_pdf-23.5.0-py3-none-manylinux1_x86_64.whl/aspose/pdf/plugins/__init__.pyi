...
class FileDataSource:
    ...
    @property
    def data_type(self) -> aspose.pdf.plugins.DataType:
...
class PdfFormAddFieldsOptions(aspose.pdf.plugins.PdfFormOptions):
    ...
    def __init__(self, fields_create_options):
        '''Initializes a new instance of the :class:`PdfFormAddFieldsOptions` object.
        
        :param fields_create_options: List of FieldCreateOptions children that set the options for each added field.
