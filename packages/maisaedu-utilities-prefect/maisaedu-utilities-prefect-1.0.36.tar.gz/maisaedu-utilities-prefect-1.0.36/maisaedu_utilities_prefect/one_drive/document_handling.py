...
def __get_shared_info(headers, file_id):
    ...
    try:
        ...
        exception = "No sharepoint id matched the given file_id from docs. Possible shared documents are:"
...
@task
def document_handling(files_info, sheet_name=None):
    token = get_secrets()
