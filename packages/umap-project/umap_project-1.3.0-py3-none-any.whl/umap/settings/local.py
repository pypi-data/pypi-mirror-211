...
SOCIAL_AUTH_TWITTER_OAUTH2_KEY = "VExxNmdTMmwyWk9kUVBxRE92ajA6MTpjaQ"
SOCIAL_AUTH_TWITTER_OAUTH2_SECRET = "41WmLwqV34zN89o5bamLCGD2pO77oc1sDfjbc15nPvMI3b9dO0"
# SOCIAL_AUTH_TWITTER_OAUTH2_SCOPE = ["users.read", ]
# SOCIAL_AUTH_TWITTER_OAUTH2_IGNORE_DEFAULT_SCOPE = True
...
STATIC_ROOT = '/var/local/umap/static'
MEDIA_ROOT = '/var/local/umap/uploads'
