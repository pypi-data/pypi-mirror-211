...
class SubscriptionCancelReason(sgqlc.types.Enum):
    __schema__ = schema
    __choices__ = ('CancelledByBilling', 'DetachBilling', 'Expired', 'Immediate', 'PendingPaymentExpired', 'ScheduledCancellation', 'TrialConverted', 'TrialEnded', 'UpgradeOrDowngrade')
...
class ScheduleVariables(sgqlc.types.Union):
    __schema__ = schema
    __types__ = (BillingPeriodChangeVariables, DowngradeChangeVariables, UnitAmountChangeVariables)
