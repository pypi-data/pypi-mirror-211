...
from .hydrometry.kiwis_hece import *
...
class GenMapManager(wx.Frame):
    ...
    def setup_mapviewer(self, title, wolfparent):
        ...
        """
        self.mapviewer = WolfMapViewer(None, title=title, wolfparent= wolfparent)
        self.add_grid()
        self.add_WMS()
...
class MapManager(GenMapManager):
    def __init__(self,*args, **kw):
        ...
        self.SPWhydrometry=hydrometry_hece(dir=dir_hydro)
...
class Wolf2DModel(GenMapManager):
    ...
    def __init__(self, *args, dir:str='', from_params: Union[None,prev_parameters_simul]=None,  **kw):
        ...
        if dir != '':
            assert os.path.exists(dir), f"'{dir}' does nto exists"
        ...
        try:
            ...
            try:
                ...
                logging.info("Error while reading infinltration file (.INF)")
                self.myinfil=prev_infiltration(self)
