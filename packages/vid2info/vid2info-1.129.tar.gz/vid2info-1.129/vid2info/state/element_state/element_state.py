...
from vid2info.state.element_state.element_analysis import ElementAnalysis
from vid2info.state.element_state.constants import STD_OUTLIER_DEVIATION, ELEMENT_ANALYSIS
...
class ElementState:
    def __init__(self, element_tracker_info : dict, first_detection_timestamp : float | None = None,
                 ...
                 element_img : np.ndarray | None = None,
                 finite_state_machine: ElementFiniteStateMachine | None = None,
        ...
        self.additional_info = ElementAnalysis(element_info=self.element_info, quality_checker=quality_checker)

        self.element_info[ELEMENT_ANALYSIS] = self.additional_info.info
