...
"""
from vid2info.inference.config import SEGMENTATION_INFO, POLYGON_XY
...
class ElementAnalysis:
    def __init__(self, element_info: dict, frame: np.ndarray = None):
        """
        ...
        """
        self.info = {
            FORM: self.analyze_form(element_info)
        }
