...
def post_many_factor_baskets_to_database(dataset: pd.DataFrame, access_token: str, verbose: bool = True):
    """
    This function posts factor basket data to the factor basket table of the database. The function firstly checks
    that the input arguments are of the correct type, followed by modifying the dataset into a json information packet. The json
    ...
    url = "https://www.samsonrockapis.com/factormapping/bulk"
    header = {'Authorization': 'Bearer ' + access_token}
