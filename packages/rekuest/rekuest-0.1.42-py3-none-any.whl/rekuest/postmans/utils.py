...
from .errors import AssignException, IncorrectReserveState, PostmanException
...
class actoruse(RPCContractBase):
    ...
    async def aassign(
        ...
        try:
            ...
            raise AssignException("Timeout error for assignation") from e
