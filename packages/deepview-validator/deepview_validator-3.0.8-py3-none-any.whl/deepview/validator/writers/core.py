...
class Writer:
    """
    This class contains methods that transforms
    the validation dictionary metrics into a
    formatted string and provides methods to print information
    on the console
    ...
    def logger(message, code=''):
        """
        This method logs information to the console of either type:
    ...
    def format_detection_summary(self, metrics, parameters):
        """
        This method formats the dictionary detection summary
        into a string table.
        Unit-test for this method is defined under:
            file: test/test_writer.py
    ...
    def format_segmentation_summary(self, metrics):
        """
        This method formats the dictionary segmentation summary
        into a string table.
        Unit-test for this method is defined under:
            file: test/test_writer.py
    ...
    def __format_timings(timings):
        """
        This method formats the dictionary timings summary
        into a string table.
        Unit-test for this method is defined under:
            file: test/test_writer.py
    ...
    def __format_parameters(parameters):
        """
        This method formats the dictionary parameters summary
        into a string table.
        Unit-test for this method is defined under:
            file: test/test_writer.py
