...
class TFliteRunner(Runner):
    ...
    ------
        MissingLibraryException
            This exception will be raised if tflite_runtime library
            is not intalled.
    ...
    def load_model(self):
        """
        This method loads the TFLite model.
        Unit-test for this method is defined under:
            file: test/deepview/validator/runners/test_tflite.py
    ...
    def run_single_instance(self, image):
        """
        This method produce tflite predictions on one image and records
        the timings.
        Unit-test for this method is defined under:
            file: test/deepview/validator/runners/test_tflite.py
    ...
    def embed_nms(self):
        ...
        ------
            MissingLibraryException
                This exception will be raised if tensorflow library is
                not intalled.
        """
    ...
    def preprocess_input(self, image):
        ...
        if self.norm == 'signed':
            ...
            Writer.logger(
                f"Unknown Normalization method {self.norm}",
                code="ERROR")
