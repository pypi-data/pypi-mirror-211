  ...
  public:
    static std::unique_ptr<Object> Create() __attribute__((used)) {
        return std::static_pointer_cast<Object>(
            std::unique_ptr<ArrowFragment<OID_T, VID_T, VERTEX_MAP_T, COMPACT>>{
                new ArrowFragment<OID_T, VID_T, VERTEX_MAP_T, COMPACT>()});
    }


  public:
    void Construct(const ObjectMeta& meta) override {
        std::string __type_name = type_name<ArrowFragment<OID_T, VID_T, VERTEX_MAP_T, COMPACT>>();
        VINEYARD_ASSERT(
        ...
        meta.GetKeyValue("compact_edges_", this->compact_edges_);
        ...
        for (size_t __idx = 0; __idx < meta.GetKeyValue<size_t>("__ovgid_lists_-size"); ++__idx) {
            this->ovgid_lists_.emplace_back(std::dynamic_pointer_cast<vid_vineyard_array_t>(
        ...
        this->compact_ie_lists_.resize(meta.GetKeyValue<size_t>("__compact_ie_lists_-size"));
        for (size_t __idx = 0; __idx < this->compact_ie_lists_.size(); ++__idx) {
            for (size_t __idy = 0; __idy < meta.GetKeyValue<size_t>(
                    "__compact_ie_lists_-" + std::to_string(__idx) + "-size"); ++__idy) {
                this->compact_ie_lists_[__idx].emplace_back(std::dynamic_pointer_cast<UInt8Array>(
                    meta.GetMember("__compact_ie_lists_-" + std::to_string(__idx) + "-" + std::to_string(__idy))));
            }
        }
        this->compact_oe_lists_.resize(meta.GetKeyValue<size_t>("__compact_oe_lists_-size"));
        for (size_t __idx = 0; __idx < this->compact_oe_lists_.size(); ++__idx) {
            for (size_t __idy = 0; __idy < meta.GetKeyValue<size_t>(
                    "__compact_oe_lists_-" + std::to_string(__idx) + "-size"); ++__idy) {
                this->compact_oe_lists_[__idx].emplace_back(std::dynamic_pointer_cast<UInt8Array>(
                    meta.GetMember("__compact_oe_lists_-" + std::to_string(__idx) + "-" + std::to_string(__idy))));
            }
        }
        this->compact_ie_offsets_lists_.resize(meta.GetKeyValue<size_t>("__compact_ie_offsets_lists_-size"));
        for (size_t __idx = 0; __idx < this->compact_ie_offsets_lists_.size(); ++__idx) {
            for (size_t __idy = 0; __idy < meta.GetKeyValue<size_t>(
                    "__compact_ie_offsets_lists_-" + std::to_string(__idx) + "-size"); ++__idy) {
                this->compact_ie_offsets_lists_[__idx].emplace_back(std::dynamic_pointer_cast<Int64Array>(
                    meta.GetMember("__compact_ie_offsets_lists_-" + std::to_string(__idx) + "-" + std::to_string(__idy))));
            }
        }
        this->compact_oe_offsets_lists_.resize(meta.GetKeyValue<size_t>("__compact_oe_offsets_lists_-size"));
        for (size_t __idx = 0; __idx < this->compact_oe_offsets_lists_.size(); ++__idx) {
            for (size_t __idy = 0; __idy < meta.GetKeyValue<size_t>(
                    "__compact_oe_offsets_lists_-" + std::to_string(__idx) + "-size"); ++__idy) {
                this->compact_oe_offsets_lists_[__idx].emplace_back(std::dynamic_pointer_cast<Int64Array>(
                    meta.GetMember("__compact_oe_offsets_lists_-" + std::to_string(__idx) + "-" + std::to_string(__idy))));
            }
        }
        this->vm_ptr_ = std::dynamic_pointer_cast<vertex_map_t>(meta.GetMember("vm_ptr_"));
...
public:
 ...
 public:
  ...
  prop_id_t vertex_property_num(label_id_t label) const {
    return static_cast<prop_id_t>(
        schema_.GetEntry(label, PropertyGraphSchema::VERTEX_TYPE_NAME)
            .property_num());
  }
  ...
  prop_id_t edge_property_num(label_id_t label) const {
    return static_cast<prop_id_t>(
        schema_.GetEntry(label, PropertyGraphSchema::EDGE_TYPE_NAME)
            .property_num());
  }
 ...
 private:
  ...
  __attribute__((annotate("shared"))) bool compact_edges_;
  ...
  __attribute__((annotate("shared"))) List<List<std::shared_ptr<UInt8Array>>> compact_ie_lists_,
      compact_oe_lists_;
  __attribute__((annotate("shared"))) List<List<std::shared_ptr<Int64Array>>> compact_ie_offsets_lists_,
...
template<typename OID_T, typename VID_T, typename VERTEX_MAP_T =
              ArrowVertexMap<typename InternalType<OID_T>::type, VID_T>, bool COMPACT = false>
class ArrowFragmentBaseBuilder: public ObjectBuilder {
  public:
    ...
    explicit ArrowFragmentBaseBuilder(
            ArrowFragment<OID_T, VID_T, VERTEX_MAP_T, COMPACT> const &__value) {
        this->set_fid_(__value.fid_);
        this->set_fnum_(__value.fnum_);
        this->set_directed_(__value.directed_);
        this->set_compact_edges_(__value.compact_edges_);
        ...
        this->compact_ie_lists_.resize(__value.compact_ie_lists_.size());
        for (size_t __idx = 0; __idx < __value.compact_ie_lists_.size(); ++__idx) {
            this->compact_ie_lists_[__idx].resize(__value.compact_ie_lists_[__idx].size());
            for (size_t __idy = 0; __idy < __value.compact_ie_lists_[__idx].size(); ++__idy) {
                this->compact_ie_lists_[__idx][__idy] = __value.compact_ie_lists_[__idx][__idy];
            }
        }
        this->compact_oe_lists_.resize(__value.compact_oe_lists_.size());
        for (size_t __idx = 0; __idx < __value.compact_oe_lists_.size(); ++__idx) {
            this->compact_oe_lists_[__idx].resize(__value.compact_oe_lists_[__idx].size());
            for (size_t __idy = 0; __idy < __value.compact_oe_lists_[__idx].size(); ++__idy) {
                this->compact_oe_lists_[__idx][__idy] = __value.compact_oe_lists_[__idx][__idy];
            }
        }
        this->compact_ie_offsets_lists_.resize(__value.compact_ie_offsets_lists_.size());
        for (size_t __idx = 0; __idx < __value.compact_ie_offsets_lists_.size(); ++__idx) {
            this->compact_ie_offsets_lists_[__idx].resize(__value.compact_ie_offsets_lists_[__idx].size());
            for (size_t __idy = 0; __idy < __value.compact_ie_offsets_lists_[__idx].size(); ++__idy) {
                this->compact_ie_offsets_lists_[__idx][__idy] = __value.compact_ie_offsets_lists_[__idx][__idy];
            }
        }
        this->compact_oe_offsets_lists_.resize(__value.compact_oe_offsets_lists_.size());
        for (size_t __idx = 0; __idx < __value.compact_oe_offsets_lists_.size(); ++__idx) {
            this->compact_oe_offsets_lists_[__idx].resize(__value.compact_oe_offsets_lists_[__idx].size());
            for (size_t __idy = 0; __idy < __value.compact_oe_offsets_lists_[__idx].size(); ++__idy) {
                this->compact_oe_offsets_lists_[__idx][__idy] = __value.compact_oe_offsets_lists_[__idx][__idy];
            }
        }
    ...
    explicit ArrowFragmentBaseBuilder(
            std::shared_ptr<ArrowFragment<OID_T, VID_T, VERTEX_MAP_T, COMPACT>> const & __value):
        ArrowFragmentBaseBuilder(*__value) {
    }

    ObjectMeta &ValueMetaRef(std::shared_ptr<ArrowFragment<OID_T, VID_T, VERTEX_MAP_T, COMPACT>> &__value) {
    ...
    Status _Seal(Client& client, std::shared_ptr<Object>& object) override {
        ...
        auto __value = std::make_shared<ArrowFragment<OID_T, VID_T, VERTEX_MAP_T, COMPACT>>();
        object = __value;

        size_t __value_nbytes = 0;

        __value->meta_.SetTypeName(type_name<ArrowFragment<OID_T, VID_T, VERTEX_MAP_T, COMPACT>>());
        ...
        __value->compact_edges_ = compact_edges_;
        __value->meta_.AddKeyValue("compact_edges_", __value->compact_edges_);
        ...
        // using __compact_ie_lists__value_type = typename List<List<std::shared_ptr<UInt8Array>>>::value_type::value_type::element_type;
        using __compact_ie_lists__value_type = typename decltype(__value->compact_ie_lists_)::value_type::value_type::element_type;

        size_t __compact_ie_lists__idx = 0;
        __value->compact_ie_lists_.resize(compact_ie_lists_.size());
        for (auto &__compact_ie_lists__value_vec: compact_ie_lists_) {
            size_t __compact_ie_lists__idy = 0;
            __value->meta_.AddKeyValue("__compact_ie_lists_-" + std::to_string(__compact_ie_lists__idx) + "-size", __compact_ie_lists__value_vec.size());
            for (auto &__compact_ie_lists__value: __compact_ie_lists__value_vec) {
                auto __value_compact_ie_lists_ = std::dynamic_pointer_cast<__compact_ie_lists__value_type>(
                    __compact_ie_lists__value->_Seal(client));
                __value->compact_ie_lists_[__compact_ie_lists__idx].emplace_back(__value_compact_ie_lists_);
                __value->meta_.AddMember("__compact_ie_lists_-" + std::to_string(__compact_ie_lists__idx) + "-" + std::to_string(__compact_ie_lists__idy),
                                         __value_compact_ie_lists_);
                __value_nbytes += __value_compact_ie_lists_->nbytes();
                __compact_ie_lists__idy += 1;
            }
            __compact_ie_lists__idx += 1;
        }
        __value->meta_.AddKeyValue("__compact_ie_lists_-size", __value->compact_ie_lists_.size());

        // using __compact_oe_lists__value_type = typename List<List<std::shared_ptr<UInt8Array>>>::value_type::value_type::element_type;
        using __compact_oe_lists__value_type = typename decltype(__value->compact_oe_lists_)::value_type::value_type::element_type;

        size_t __compact_oe_lists__idx = 0;
        __value->compact_oe_lists_.resize(compact_oe_lists_.size());
        for (auto &__compact_oe_lists__value_vec: compact_oe_lists_) {
            size_t __compact_oe_lists__idy = 0;
            __value->meta_.AddKeyValue("__compact_oe_lists_-" + std::to_string(__compact_oe_lists__idx) + "-size", __compact_oe_lists__value_vec.size());
            for (auto &__compact_oe_lists__value: __compact_oe_lists__value_vec) {
                auto __value_compact_oe_lists_ = std::dynamic_pointer_cast<__compact_oe_lists__value_type>(
                    __compact_oe_lists__value->_Seal(client));
                __value->compact_oe_lists_[__compact_oe_lists__idx].emplace_back(__value_compact_oe_lists_);
                __value->meta_.AddMember("__compact_oe_lists_-" + std::to_string(__compact_oe_lists__idx) + "-" + std::to_string(__compact_oe_lists__idy),
                                         __value_compact_oe_lists_);
                __value_nbytes += __value_compact_oe_lists_->nbytes();
                __compact_oe_lists__idy += 1;
            }
            __compact_oe_lists__idx += 1;
        }
        __value->meta_.AddKeyValue("__compact_oe_lists_-size", __value->compact_oe_lists_.size());

        // using __compact_ie_offsets_lists__value_type = typename List<List<std::shared_ptr<Int64Array>>>::value_type::value_type::element_type;
        using __compact_ie_offsets_lists__value_type = typename decltype(__value->compact_ie_offsets_lists_)::value_type::value_type::element_type;

        size_t __compact_ie_offsets_lists__idx = 0;
        __value->compact_ie_offsets_lists_.resize(compact_ie_offsets_lists_.size());
        for (auto &__compact_ie_offsets_lists__value_vec: compact_ie_offsets_lists_) {
            size_t __compact_ie_offsets_lists__idy = 0;
            __value->meta_.AddKeyValue("__compact_ie_offsets_lists_-" + std::to_string(__compact_ie_offsets_lists__idx) + "-size", __compact_ie_offsets_lists__value_vec.size());
            for (auto &__compact_ie_offsets_lists__value: __compact_ie_offsets_lists__value_vec) {
                auto __value_compact_ie_offsets_lists_ = std::dynamic_pointer_cast<__compact_ie_offsets_lists__value_type>(
                    __compact_ie_offsets_lists__value->_Seal(client));
                __value->compact_ie_offsets_lists_[__compact_ie_offsets_lists__idx].emplace_back(__value_compact_ie_offsets_lists_);
                __value->meta_.AddMember("__compact_ie_offsets_lists_-" + std::to_string(__compact_ie_offsets_lists__idx) + "-" + std::to_string(__compact_ie_offsets_lists__idy),
                                         __value_compact_ie_offsets_lists_);
                __value_nbytes += __value_compact_ie_offsets_lists_->nbytes();
                __compact_ie_offsets_lists__idy += 1;
            }
            __compact_ie_offsets_lists__idx += 1;
        }
        __value->meta_.AddKeyValue("__compact_ie_offsets_lists_-size", __value->compact_ie_offsets_lists_.size());

        // using __compact_oe_offsets_lists__value_type = typename List<List<std::shared_ptr<Int64Array>>>::value_type::value_type::element_type;
        using __compact_oe_offsets_lists__value_type = typename decltype(__value->compact_oe_offsets_lists_)::value_type::value_type::element_type;

        size_t __compact_oe_offsets_lists__idx = 0;
        __value->compact_oe_offsets_lists_.resize(compact_oe_offsets_lists_.size());
        for (auto &__compact_oe_offsets_lists__value_vec: compact_oe_offsets_lists_) {
            size_t __compact_oe_offsets_lists__idy = 0;
            __value->meta_.AddKeyValue("__compact_oe_offsets_lists_-" + std::to_string(__compact_oe_offsets_lists__idx) + "-size", __compact_oe_offsets_lists__value_vec.size());
            for (auto &__compact_oe_offsets_lists__value: __compact_oe_offsets_lists__value_vec) {
                auto __value_compact_oe_offsets_lists_ = std::dynamic_pointer_cast<__compact_oe_offsets_lists__value_type>(
                    __compact_oe_offsets_lists__value->_Seal(client));
                __value->compact_oe_offsets_lists_[__compact_oe_offsets_lists__idx].emplace_back(__value_compact_oe_offsets_lists_);
                __value->meta_.AddMember("__compact_oe_offsets_lists_-" + std::to_string(__compact_oe_offsets_lists__idx) + "-" + std::to_string(__compact_oe_offsets_lists__idy),
                                         __value_compact_oe_offsets_lists_);
                __value_nbytes += __value_compact_oe_offsets_lists_->nbytes();
                __compact_oe_offsets_lists__idy += 1;
            }
            __compact_oe_offsets_lists__idx += 1;
        }
        __value->meta_.AddKeyValue("__compact_oe_offsets_lists_-size", __value->compact_oe_offsets_lists_.size());
  ...
  protected:
    ...
    std::vector<std::vector<std::shared_ptr<ObjectBase>>> compact_ie_lists_;
    std::vector<std::vector<std::shared_ptr<ObjectBase>>> compact_oe_lists_;
    std::vector<std::vector<std::shared_ptr<ObjectBase>>> compact_ie_offsets_lists_;
    std::vector<std::vector<std::shared_ptr<ObjectBase>>> compact_oe_offsets_lists_;
    std::shared_ptr<ObjectBase> vm_ptr_;
    json schema_json_;

    void set_fid_(fid_t const &fid__) {
        this->fid_ = fid__;
    }

    void set_fnum_(fid_t const &fnum__) {
        this->fnum_ = fnum__;
    }
    ...
    void set_compact_edges_(bool const &compact_edges__) {
        this->compact_edges_ = compact_edges__;
    }
    ...
    void set_oid_type(String const &oid_type_) {
        this->oid_type = oid_type_;
    }

    void set_vid_type(String const &vid_type_) {
    ...
    void set_compact_ie_lists_(std::vector<std::vector<std::shared_ptr<ObjectBase>>> const &compact_ie_lists__) {
        this->compact_ie_lists_ = compact_ie_lists__;
    }
    void set_compact_ie_lists_(size_t const idx, std::vector<std::shared_ptr<ObjectBase>> const &compact_ie_lists__) {
        if (idx >= this->compact_ie_lists_.size()) {
            this->compact_ie_lists_.resize(idx + 1);
        }
        this->compact_ie_lists_[idx] = compact_ie_lists__;
    }
    void set_compact_ie_lists_(size_t const idx, size_t const idy,
                          std::shared_ptr<ObjectBase> const &compact_ie_lists__) {
        if (idx >= this->compact_ie_lists_.size()) {
            this->compact_ie_lists_.resize(idx + 1);
        }
        if (idy >= this->compact_ie_lists_[idx].size()) {
            this->compact_ie_lists_[idx].resize(idy + 1);
        }
        this->compact_ie_lists_[idx][idy] = compact_ie_lists__;
    }
    void add_compact_ie_lists_(std::vector<std::shared_ptr<ObjectBase>> const &compact_ie_lists__) {
        this->compact_ie_lists_.emplace_back(compact_ie_lists__);
    }
    void remove_compact_ie_lists_(const size_t compact_ie_lists__index_) {
        this->compact_ie_lists_.erase(this->compact_ie_lists_.begin() + compact_ie_lists__index_);
    }
    void remove_compact_ie_lists_(const size_t compact_ie_lists__index_, const size_t compact_ie_lists__inner_index_) {
        auto &compact_ie_lists__inner_ = this->compact_ie_lists_[compact_ie_lists__index_];
        compact_ie_lists__inner_.erase(compact_ie_lists__inner_.begin() + compact_ie_lists__inner_index_);
    }

    void set_compact_oe_lists_(std::vector<std::vector<std::shared_ptr<ObjectBase>>> const &compact_oe_lists__) {
        this->compact_oe_lists_ = compact_oe_lists__;
    }
    void set_compact_oe_lists_(size_t const idx, std::vector<std::shared_ptr<ObjectBase>> const &compact_oe_lists__) {
        if (idx >= this->compact_oe_lists_.size()) {
            this->compact_oe_lists_.resize(idx + 1);
        }
        this->compact_oe_lists_[idx] = compact_oe_lists__;
    }
    void set_compact_oe_lists_(size_t const idx, size_t const idy,
                          std::shared_ptr<ObjectBase> const &compact_oe_lists__) {
        if (idx >= this->compact_oe_lists_.size()) {
            this->compact_oe_lists_.resize(idx + 1);
        }
        if (idy >= this->compact_oe_lists_[idx].size()) {
            this->compact_oe_lists_[idx].resize(idy + 1);
        }
        this->compact_oe_lists_[idx][idy] = compact_oe_lists__;
    }
    void add_compact_oe_lists_(std::vector<std::shared_ptr<ObjectBase>> const &compact_oe_lists__) {
        this->compact_oe_lists_.emplace_back(compact_oe_lists__);
    }
    void remove_compact_oe_lists_(const size_t compact_oe_lists__index_) {
        this->compact_oe_lists_.erase(this->compact_oe_lists_.begin() + compact_oe_lists__index_);
    }
    void remove_compact_oe_lists_(const size_t compact_oe_lists__index_, const size_t compact_oe_lists__inner_index_) {
        auto &compact_oe_lists__inner_ = this->compact_oe_lists_[compact_oe_lists__index_];
        compact_oe_lists__inner_.erase(compact_oe_lists__inner_.begin() + compact_oe_lists__inner_index_);
    }

    void set_compact_ie_offsets_lists_(std::vector<std::vector<std::shared_ptr<ObjectBase>>> const &compact_ie_offsets_lists__) {
        this->compact_ie_offsets_lists_ = compact_ie_offsets_lists__;
    }
    void set_compact_ie_offsets_lists_(size_t const idx, std::vector<std::shared_ptr<ObjectBase>> const &compact_ie_offsets_lists__) {
        if (idx >= this->compact_ie_offsets_lists_.size()) {
            this->compact_ie_offsets_lists_.resize(idx + 1);
        }
        this->compact_ie_offsets_lists_[idx] = compact_ie_offsets_lists__;
    }
    void set_compact_ie_offsets_lists_(size_t const idx, size_t const idy,
                          std::shared_ptr<ObjectBase> const &compact_ie_offsets_lists__) {
        if (idx >= this->compact_ie_offsets_lists_.size()) {
            this->compact_ie_offsets_lists_.resize(idx + 1);
        }
        if (idy >= this->compact_ie_offsets_lists_[idx].size()) {
            this->compact_ie_offsets_lists_[idx].resize(idy + 1);
        }
        this->compact_ie_offsets_lists_[idx][idy] = compact_ie_offsets_lists__;
    }
    void add_compact_ie_offsets_lists_(std::vector<std::shared_ptr<ObjectBase>> const &compact_ie_offsets_lists__) {
        this->compact_ie_offsets_lists_.emplace_back(compact_ie_offsets_lists__);
    }
    void remove_compact_ie_offsets_lists_(const size_t compact_ie_offsets_lists__index_) {
        this->compact_ie_offsets_lists_.erase(this->compact_ie_offsets_lists_.begin() + compact_ie_offsets_lists__index_);
    }
    void remove_compact_ie_offsets_lists_(const size_t compact_ie_offsets_lists__index_, const size_t compact_ie_offsets_lists__inner_index_) {
        auto &compact_ie_offsets_lists__inner_ = this->compact_ie_offsets_lists_[compact_ie_offsets_lists__index_];
        compact_ie_offsets_lists__inner_.erase(compact_ie_offsets_lists__inner_.begin() + compact_ie_offsets_lists__inner_index_);
    }

    void set_compact_oe_offsets_lists_(std::vector<std::vector<std::shared_ptr<ObjectBase>>> const &compact_oe_offsets_lists__) {
        this->compact_oe_offsets_lists_ = compact_oe_offsets_lists__;
    }
    void set_compact_oe_offsets_lists_(size_t const idx, std::vector<std::shared_ptr<ObjectBase>> const &compact_oe_offsets_lists__) {
        if (idx >= this->compact_oe_offsets_lists_.size()) {
            this->compact_oe_offsets_lists_.resize(idx + 1);
        }
        this->compact_oe_offsets_lists_[idx] = compact_oe_offsets_lists__;
    }
    void set_compact_oe_offsets_lists_(size_t const idx, size_t const idy,
                          std::shared_ptr<ObjectBase> const &compact_oe_offsets_lists__) {
        if (idx >= this->compact_oe_offsets_lists_.size()) {
            this->compact_oe_offsets_lists_.resize(idx + 1);
        }
        if (idy >= this->compact_oe_offsets_lists_[idx].size()) {
            this->compact_oe_offsets_lists_[idx].resize(idy + 1);
        }
        this->compact_oe_offsets_lists_[idx][idy] = compact_oe_offsets_lists__;
    }
    void add_compact_oe_offsets_lists_(std::vector<std::shared_ptr<ObjectBase>> const &compact_oe_offsets_lists__) {
        this->compact_oe_offsets_lists_.emplace_back(compact_oe_offsets_lists__);
    }
    void remove_compact_oe_offsets_lists_(const size_t compact_oe_offsets_lists__index_) {
        this->compact_oe_offsets_lists_.erase(this->compact_oe_offsets_lists_.begin() + compact_oe_offsets_lists__index_);
    }
    void remove_compact_oe_offsets_lists_(const size_t compact_oe_offsets_lists__index_, const size_t compact_oe_offsets_lists__inner_index_) {
        auto &compact_oe_offsets_lists__inner_ = this->compact_oe_offsets_lists_[compact_oe_offsets_lists__index_];
        compact_oe_offsets_lists__inner_.erase(compact_oe_offsets_lists__inner_.begin() + compact_oe_offsets_lists__inner_index_);
    }
    ...
    void set_schema_json_(json const &schema_json__) {
        this->schema_json_ = schema_json__;
    }

  private:
    friend class ArrowFragment<OID_T, VID_T, VERTEX_MAP_T, COMPACT>;
};
