...
class ReqFactor(_object):
    ...
    __swig_setmethods__["offset"] = libtgw_python36.ReqFactor_offset_set
    __swig_getmethods__["offset"] = libtgw_python36.ReqFactor_offset_get
    if _newclass:
        offset = _swig_property(libtgw_python36.ReqFactor_offset_get, libtgw_python36.ReqFactor_offset_set)
