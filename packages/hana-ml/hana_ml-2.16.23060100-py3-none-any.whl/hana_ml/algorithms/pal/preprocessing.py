...
#pylint: disable=line-too-long, unused-variable, raise-missing-from, too-many-locals, super-with-arguments
#pylint: disable=too-many-lines, invalid-name, too-many-arguments, c-extension-no-member, bare-except
#pylint: disable=attribute-defined-outside-init, too-many-statements, too-many-branches, too-many-instance-attributes
import logging
import uuid
import json
import itertools
...
class IsolationForest(PALBase):
    ...
    def fit(self,
        ...
        model_tbl = '#PAL_IsolationForest_MODEL_TBL_{}_{}'.format(self.id, unique_id)
        outputs = [model_tbl]
        param_rows = [
            ('N_ESTIMATORS', self.n_estimators, None, None),
            ('MAX_SAMPLES', self.max_samples, None, None),
            ('MAX_FEATURES', self.max_features, None, None),
