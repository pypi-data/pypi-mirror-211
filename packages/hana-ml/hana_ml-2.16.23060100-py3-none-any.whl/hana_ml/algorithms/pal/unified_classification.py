...
from hana_ml.algorithms.pal.utility import AMDPHelper, mlflow_autologging
from hana_ml.algorithms.pal.sqlgen import trace_sql
from hana_ml.algorithms.pal.utility import check_pal_function_exist
from hana_ml.algorithms.pal.tsa.arima import _delete_none_key_in_dict, _col_index_check
...
def _categorical_variable_update(input_cate_var, label_t, label, func):
    ...
    if label_t is not None:
        if 'INT' in label_t:
            ...
            elif label not in input_cate_var and func not in ['LOGR', 'M_LOGR']:
...
class UnifiedClassification(PALBase, _UnifiedClassificationReportBuilder, AMDPHelper):#pylint: disable=too-many-instance-attributes
    ...
    massive : bool, optional
        ...
        .. raw:: html
            ...
            <iframe allowtransparency="true" style="border:1px solid #ccc; background: #eeffcb;"
                src="../../_static/uc_init_example1.html" width="100%" height="100%">
            </iframe>
    ...
    group_params : dict, optional
        ...
        .. raw:: html
            ...
            <iframe allowtransparency="true" style="border:1px solid #ccc; background: #eeffcb;"
                src="../../_static/uc_init_example2.html" width="100%" height="100%">
            </iframe>
    ...
    **kwargs : keyword arguments
        ...
        **Note that some parameters are disabled in the classification algorithm!**
        ...
        .. raw:: html
            ...
            <iframe allowtransparency="true" style="border:1px solid #ccc; background: #eeffcb;"
                src="../../_static/uc_init_example3.html" width="100%" height="100%">
            </iframe>
        ...
        .. raw:: html
            ...
            <iframe allowtransparency="true" style="border:1px solid #ccc; background: #eeffcb;"
                src="../../_static/uc_init_example4.html" width="100%" height="100%">
            </iframe>
    ...
    def fit(self,#pylint: disable=too-many-branches, too-many-statements
        ...
        group_params : dict, optional
            ...
            .. raw:: html
                ...
                <iframe allowtransparency="true" style="border:1px solid #ccc; background: #eeffcb;"
                    src="../../_static/uc_fit_example.html" width="100%" height="100%">
                </iframe>
        ...
        **kwargs : keyword arguments
        ...
        if partition_method is not None:
            if partition_method == "user_defined":
                check = True
        if check is False:
            purpose = None
        ...
        if self.massive is not True:
            fit_map = dict(**self.__fit_param_dict, **self.__impute_dict)
            pal_fit_params = {}
            pal_fit_params = _params_check(input_dict={**self.fit_params, **impute_params},
                                           param_map=fit_map,
                                           func=self.real_func)
            ...
            categorical_variable = _categorical_variable_update(categorical_variable, label_t, label, self.func)
            ...
            fit_map = dict(**self.__fit_param_dict, **self.__impute_dict)
            general_params = {}
            general_params = _params_check(input_dict={**self.fit_params, **impute_params},
                                           param_map=fit_map,
                                           func=self.real_func)
                ...
                if kwargs:
                    ...
                    for kye in kwargs:
                        if kye in additional_param_map.keys():
                            par_val = kwargs[kye]
                            if kye in ['class_map0', 'class_map1'] and self.real_func != 'M_LOGR':
                                value = self._arg(kye, par_val, str)
                                tpl = [tuple([special_group_name] + list(self.__map_param(additional_param_map[kye][0],
                                                                                          value,
                                                                                          additional_param_map[kye][1])))]
                                param_rows.extend(tpl)
                            if additional_param_map[kye][1] == ListOfStrings and isinstance(par_val, str):
                                par_val = [par_val]
                            value = self._arg(kye, par_val, additional_param_map[kye][1])
                            if isinstance(value, (list, tuple)):
                                for val in value:
                                    tpl = [tuple([special_group_name] + list(self.__map_param(additional_param_map[kye][0],
                                                                                              val,
            ...
            if 'HANDLE_MISSING_VALUE' in general_params:
            ...
            if group_params is not None:
                for group in group_params:
                    ...
                    each_group_params = {}
                    each_group_map = dict(**self.__fit_param_dict, **self.__impute_dict, **self.__fit_add_dict[self.func])
                    ...
                    group_categorical_variable = _categorical_variable_update(group_categorical_variable, label_t, label, self.func)
    ...
    def predict(self,
        ...
        group_params : dict, optional
            ...
            .. raw:: html
                ...
                <iframe allowtransparency="true" style="border:1px solid #ccc; background: #eeffcb;"
                    src="../../_static/uc_predict_example.html" width="100%" height="100%">
                </iframe>
        ...
        **kwargs : keyword arguments
        ...
        if self.massive is not True:
            predict_map = dict(**self.__predict_score_param_dict)
            ...
            impute_map = dict(**self.__impute_dict)
            ...
            categorical_variable = _categorical_variable_update(categorical_variable, None, None, self.func)
            if categorical_variable is not None:
                param_rows.extend([('CATEGORICAL_VARIABLE', None, None, var) for var in categorical_variable])
            ...
            special_group_name = 'PAL_MASSIVE_PROCESSING_SPECIAL_GROUP_ID'
            param_rows = []
            predict_map = dict(**self.__predict_score_param_dict, **self.__impute_dict)
            general_params = {}
            general_params = _params_check(input_dict={**predict_params, **predict_impute_params},
                                           param_map=predict_map,
                                           func=self.real_func)
            if 'INT' in group_key_type and (general_params or impute or strategy_by_col):
                warn_msg = "If the type of group_key is INTEGER, only parameters in group_params are valid!"
                warnings.warn(message=warn_msg)
            ...
            if group_params:
                for group in group_params:
                    ...
                    if group_params[group].get('categorical_variable') is not None:
                        group_categorical_variable = group_params[group]['categorical_variable']
                    group_categorical_variable = _categorical_variable_update(group_categorical_variable, None, None, self.func)
    ...
    def score(self,
        ...
        group_params : dict, optional
            ...
            .. raw:: html
                ...
                <iframe allowtransparency="true" style="border:1px solid #ccc; background: #eeffcb;"
                    src="../../_static/uc_score_example.html" width="100%" height="100%">
                </iframe>
        ...
        if self.massive is not True:
            score_map = dict(**self.__predict_score_param_dict)
            ...
            special_group_name = 'PAL_MASSIVE_PROCESSING_SPECIAL_GROUP_ID'
            param_rows = []
            score_map = dict(**self.__predict_score_param_dict, **self.__impute_dict)
            general_params = {}
            general_params = _params_check(input_dict={**score_params, **score_impute_params},
                                           param_map=score_map,
                                           func=self.real_func)
            g_params = general_params
            if g_params.get('HANDLE_MISSING_VALUE') is not True:
                del g_params['HANDLE_MISSING_VALUE']
        ...
        try:
            ...
            if self.model_[5].filter("NAME='ROC_FPR'").count() > 200:
                if self.roc_sampling is None and self.other_samplings is None:
                    ...
                    other_samplings = dict(CUMGAINS=Sampling('simple_random_without_replacement', sampling_size=200),
