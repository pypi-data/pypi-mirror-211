...
#if QT_CONFIG(tooltip)
        self.lineEdit_julia_project.setToolTip(QCoreApplication.translate("Dialog", u"<html><head/><body><p>Julia project for the new kernel. Leave empty to use the default, or enter @. to use the current wodking directory.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.lineEdit_julia_project.setPlaceholderText(QCoreApplication.translate("Dialog", u"Type Julia home project here...", None))
