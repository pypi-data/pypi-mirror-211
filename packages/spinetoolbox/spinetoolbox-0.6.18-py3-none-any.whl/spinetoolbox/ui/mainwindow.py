...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionStartJuliaConsole.setText(QCoreApplication.translate("MainWindow", u"Start Jupyter Console", None))
#if QT_CONFIG(tooltip)
        self.actionStartJuliaConsole.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Start selected Julia kernel spec in Jupyter Console. Select kernel spec in File-&gt;Settings-&gt;Tools.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionStartJuliaConsole.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+2", None))
#endif // QT_CONFIG(shortcut)
        self.actionStartPythonConsole.setText(QCoreApplication.translate("MainWindow", u"Start Jupyter Console", None))
#if QT_CONFIG(tooltip)
        self.actionStartPythonConsole.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Start selected Python kernel spec in Jupyter Console. Select kernel spec in File-&gt;Settings-&gt;Tools.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
