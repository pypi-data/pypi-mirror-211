...
urlpatterns = [
    ...
    re_path(r'^wechat_callback_v3/?$', payment_wechat.PaymentWechat.callback_v3),  # 微信回调接口
    ...
    re_path(r'^pay/?$', PaymentApis.pay),  # 支付总接接口
    re_path(r'^list/?$', PaymentApis.list),
    re_path(r'^ask_order_status/?$', PaymentApis.ask_order_status),
    re_path(r'^golden_touch/?$', PaymentApis.golden_touch),

    re_path(r'^status_add/?$', PaymentStatusApis.add),  # 支付状态添加
    re_path(r'^status_list/?$', PaymentStatusApis.list),  # 支付状态列表
]
