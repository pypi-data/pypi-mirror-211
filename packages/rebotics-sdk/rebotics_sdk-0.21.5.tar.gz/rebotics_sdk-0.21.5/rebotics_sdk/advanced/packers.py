...
class UnpackException(ClassificationDatabaseException):
    def __init__(self, archive_name: AnyStr, data_keys: typing.List):
...
class Py7zrClassificationDatabasePacker(BaseClassificationDatabasePacker):
    ...
    def __init__(
        self,
        archive_file: typing.Union[pathlib.PurePath, typing.AnyStr] = None,
        # check_duplicates=False,
        **kwargs
    ) -> None:
        """
...
class Packer:
    ...
    base_class: typing.Type[BaseClassificationDatabasePacker]
...
def get_packer_class(file_path: typing.Union[AnyStr, pathlib.PurePath]) \
  -> typing.Union[typing.Type[BaseClassificationDatabasePacker], None]:
