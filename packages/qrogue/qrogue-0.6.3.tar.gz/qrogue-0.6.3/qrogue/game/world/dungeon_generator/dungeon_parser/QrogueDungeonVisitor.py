...
class QrogueDungeonVisitor(ParseTreeVisitor):
    ...
    def visitMessage_descriptor(self, ctx):
        return self.visitChildren(ctx)
    ...
    def visitEnergy_descriptor(self, ctx):
        return self.visitChildren(ctx)
