...
class PerformanceValidationTest():
    ...
    def test_agent(self):
        ...
        #     test_step_info = self.init_classification_info()
        ...
        for k, _ in enumerate(test_progress_bar):
            ...
            if self.test_type == 'classification':
                ...
                test_step_info = compute_incidental_probabilities(test_step_info=test_step_info, test_type=self.test_type, predictions=self.predictions)
...
def compute_incidental_probabilities(test_step_info: dict, test_type: str, predictions: list):
    ...
    if test_type == 'classification':
        ...
        hive_pred = hive_model_classification(ensembles=predictions[idx])
        if hive_pred is not None:
            hive_pred = hive_pred.most_common(1)[0][0]
