...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/rest_api/plan/{id}/stats".format(client.base_url, id=id)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, PlanStats]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, PlanStats]]:
    return Response(
