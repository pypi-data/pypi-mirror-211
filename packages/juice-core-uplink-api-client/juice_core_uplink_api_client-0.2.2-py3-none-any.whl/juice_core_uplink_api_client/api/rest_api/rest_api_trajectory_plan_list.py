...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, List["PlanList"]]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, List["PlanList"]]]:
    return Response(
