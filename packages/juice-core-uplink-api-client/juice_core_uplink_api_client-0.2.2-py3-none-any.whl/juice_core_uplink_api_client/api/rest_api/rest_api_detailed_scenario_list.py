...
def _parse_response(*, response: httpx.Response) -> Optional[List["DetailedScenarioList"]]:
...
def _build_response(*, response: httpx.Response) -> Response[List["DetailedScenarioList"]]:
    return Response(
