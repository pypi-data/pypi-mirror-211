...
class Associations:
    def __init__(self,
                 ...
                 derivedKeyFee=1700,
                 appName="DesoPy",
                 appKey="BC1YLgTKfwSeHuNWtuqQmwduJM2QZ7ZQ9C7HFuLpyXuunUN7zTEr5WL"
                 ):
    ...
    def createUserAssociation(self,
        ...
        try:
            ...
            payload = {
                "TransactorPublicKeyBase58Check": self.PUBLIC_KEY,
                "TargetUserPublicKeyBase58Check": targetUserKey,
                "AppPublicKeyBase58Check": self.APP_KEY,
    ...
    def createPostAssociation(self,  postHashHex, associationType, associationValue, postExtraData={"Language": "en"}, ):
    ...
    def deletePostAssociation(self, association_ID, postExtraData={"Language": "en"}, ):
        postExtraData["App"] = self.appName
    ...
    # have to yet redefine these read functions. no docs for them either yet
    ...
    def queryForPostAssociations(self,  postHashHex=None,associationType=None, associationTypePrefix=None, value=None, valuePrefix=None, associationValues=[],
