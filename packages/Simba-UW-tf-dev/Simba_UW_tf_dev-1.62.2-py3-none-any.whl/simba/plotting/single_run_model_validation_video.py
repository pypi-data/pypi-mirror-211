    ...
    def __create_video(self):
        ...
        try:
            ...
            while (cap.isOpened()):
                ...
                cv2.putText(frame, 'Timer', (10, self.settings['styles']['space_scale']), self.font, self.settings['styles']['font size'], (0, 255, 0), 2)
                addSpacer = 2
                cv2.putText(frame, (f'{self.clf_name} {target_timer}s'), (10, self.settings['styles']['space_scale']), self.font, self.settings['styles']['font size'], (0, 0, 255), 2)
                addSpacer+=1
                cv2.putText(frame, 'Ensemble prediction', (10, self.settings['styles']['space_scale']*addSpacer), self.font, self.settings['styles']['font size'], (0, 255, 0), 2)
                addSpacer += 2
                if clf_val == 1:
