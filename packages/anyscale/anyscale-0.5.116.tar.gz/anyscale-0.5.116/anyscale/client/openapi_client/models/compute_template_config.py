...
class ComputeTemplateConfig(object):
    ...
    def __init__(self, cloud_id=None, max_workers=None, region=None, allowed_azs=None, head_node_type=None, worker_node_types=None, aws_advanced_configurations_json=None, aws=None, gcp_advanced_configurations_json=None, gcp=None, azure=None, maximum_uptime_minutes=None, idle_termination_minutes=None, local_vars_configuration=None):  # noqa: E501
    ...
    def aws_advanced_configurations_json(self):
        """Gets the aws_advanced_configurations_json of this ComputeTemplateConfig.  # noqa: E501
        ...
        :return: The aws_advanced_configurations_json of this ComputeTemplateConfig.  # noqa: E501
        :rtype: object
        """
    ...
    def aws_advanced_configurations_json(self, aws_advanced_configurations_json):
        """Sets the aws_advanced_configurations_json of this ComputeTemplateConfig.

        The advanced configuration json that we pass directly AWS APIs when launching an instance. We may do some validation on this json and reject the json if it is using a configuration that Anyscale does not support.  # noqa: E501

        :param aws_advanced_configurations_json: The aws_advanced_configurations_json of this ComputeTemplateConfig.  # noqa: E501
        :type: object
        """
    ...
    def gcp_advanced_configurations_json(self):
        """Gets the gcp_advanced_configurations_json of this ComputeTemplateConfig.  # noqa: E501
        ...
        :return: The gcp_advanced_configurations_json of this ComputeTemplateConfig.  # noqa: E501
        :rtype: object
        """
    ...
    def gcp_advanced_configurations_json(self, gcp_advanced_configurations_json):
        """Sets the gcp_advanced_configurations_json of this ComputeTemplateConfig.

        The advanced configuration json that we pass directly GCP APIs when launching an instance. We may do some validation on this json and reject the json if it is using a configuration that Anyscale does not support.  # noqa: E501

        :param gcp_advanced_configurations_json: The gcp_advanced_configurations_json of this ComputeTemplateConfig.  # noqa: E501
        :type: object
        """
    ...
    def idle_termination_minutes(self):
        """Gets the idle_termination_minutes of this ComputeTemplateConfig.  # noqa: E501
        ...
        :return: The idle_termination_minutes of this ComputeTemplateConfig.  # noqa: E501
        :rtype: int
        """
    ...
    def idle_termination_minutes(self, idle_termination_minutes):
        """Sets the idle_termination_minutes of this ComputeTemplateConfig.

        If set to a positive number, Anyscale will terminate the cluster this many minutes after the cluster is idle. Idle time is defined as the time during which a Cluster is not running a user command or a Ray driver. Time spent running commands on Jupyter or ssh is still considered 'idle'. To disable, set this field to 0.  # noqa: E501

        :param idle_termination_minutes: The idle_termination_minutes of this ComputeTemplateConfig.  # noqa: E501
        :type: int
        """
