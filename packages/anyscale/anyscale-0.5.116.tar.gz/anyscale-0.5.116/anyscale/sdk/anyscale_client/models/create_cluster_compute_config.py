...
class CreateClusterComputeConfig(object):
    ...
    def __init__(self, cloud_id=None, max_workers=None, region='USE_CLOUD', allowed_azs=None, head_node_type=None, worker_node_types=None, aws_advanced_configurations_json=None, aws=None, gcp_advanced_configurations_json=None, gcp=None, azure=None, maximum_uptime_minutes=None, idle_termination_minutes=120, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def cloud_id(self):
        """Gets the cloud_id of this CreateClusterComputeConfig.  # noqa: E501

        The ID of the Anyscale cloud to use for launching Clusters.  # noqa: E501

        :return: The cloud_id of this CreateClusterComputeConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def cloud_id(self, cloud_id):
        """Sets the cloud_id of this CreateClusterComputeConfig.

        The ID of the Anyscale cloud to use for launching Clusters.  # noqa: E501

        :param cloud_id: The cloud_id of this CreateClusterComputeConfig.  # noqa: E501
        :type: str
        """
    ...
    @property
    def region(self):
        """Gets the region of this CreateClusterComputeConfig.  # noqa: E501

        Deprecated! When creating a cluster compute, a region does not have to be provided. Instead we will use the value from the cloud.  # noqa: E501

        :return: The region of this CreateClusterComputeConfig.  # noqa: E501
        :rtype: str
        """
        return self._region
    ...
    def region(self, region):
        """Sets the region of this CreateClusterComputeConfig.

        Deprecated! When creating a cluster compute, a region does not have to be provided. Instead we will use the value from the cloud.  # noqa: E501

        :param region: The region of this CreateClusterComputeConfig.  # noqa: E501
        :type: str
        """
    ...
    def allowed_azs(self):
        """Gets the allowed_azs of this CreateClusterComputeConfig.  # noqa: E501

        The availability zones that clusters are allowed to be launched in, e.g. \"us-west-2a\". If not specified, any AZ may be used.  # noqa: E501

        :return: The allowed_azs of this CreateClusterComputeConfig.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def allowed_azs(self, allowed_azs):
        """Sets the allowed_azs of this CreateClusterComputeConfig.

        The availability zones that clusters are allowed to be launched in, e.g. \"us-west-2a\". If not specified, any AZ may be used.  # noqa: E501

        :param allowed_azs: The allowed_azs of this CreateClusterComputeConfig.  # noqa: E501
        :type: list[str]
        """
    ...
    def head_node_type(self):
        """Gets the head_node_type of this CreateClusterComputeConfig.  # noqa: E501

        Node configuration to use for the head node.   # noqa: E501

        :return: The head_node_type of this CreateClusterComputeConfig.  # noqa: E501
    ...
    def head_node_type(self, head_node_type):
        """Sets the head_node_type of this CreateClusterComputeConfig.

        Node configuration to use for the head node.   # noqa: E501

        :param head_node_type: The head_node_type of this CreateClusterComputeConfig.  # noqa: E501
    ...
    def worker_node_types(self):
        """Gets the worker_node_types of this CreateClusterComputeConfig.  # noqa: E501

        A list of node types to use for worker nodes.   # noqa: E501

        :return: The worker_node_types of this CreateClusterComputeConfig.  # noqa: E501
    ...
    def worker_node_types(self, worker_node_types):
        """Sets the worker_node_types of this CreateClusterComputeConfig.
    ...
    def aws_advanced_configurations_json(self):
        """Gets the aws_advanced_configurations_json of this CreateClusterComputeConfig.  # noqa: E501
        ...
        :return: The aws_advanced_configurations_json of this CreateClusterComputeConfig.  # noqa: E501
        :rtype: object
        """
    ...
    def aws_advanced_configurations_json(self, aws_advanced_configurations_json):
        """Sets the aws_advanced_configurations_json of this CreateClusterComputeConfig.

        The advanced configuration json that we pass directly AWS APIs when launching an instance. We may do some validation on this json and reject the json if it is using a configuration that Anyscale does not support.  # noqa: E501

        :param aws_advanced_configurations_json: The aws_advanced_configurations_json of this CreateClusterComputeConfig.  # noqa: E501
        :type: object
        """
    ...
    @property
    def aws(self):
        """Gets the aws of this CreateClusterComputeConfig.  # noqa: E501
        ...
        :return: The aws of this CreateClusterComputeConfig.  # noqa: E501
    ...
    @aws.setter
    def aws(self, aws):
        """Sets the aws of this CreateClusterComputeConfig.

        DEPRECATED: Please provide instance configuration in the `aws_advanced_configurations_json` field. Fields specific to AWS node types.  # noqa: E501

        :param aws: The aws of this CreateClusterComputeConfig.  # noqa: E501
        :type: AWSNodeOptions
        """
    ...
    def gcp_advanced_configurations_json(self):
        """Gets the gcp_advanced_configurations_json of this CreateClusterComputeConfig.  # noqa: E501
        ...
        :return: The gcp_advanced_configurations_json of this CreateClusterComputeConfig.  # noqa: E501
        :rtype: object
        """
    ...
    def gcp_advanced_configurations_json(self, gcp_advanced_configurations_json):
        """Sets the gcp_advanced_configurations_json of this CreateClusterComputeConfig.

        The advanced configuration json that we pass directly GCP APIs when launching an instance. We may do some validation on this json and reject the json if it is using a configuration that Anyscale does not support.  # noqa: E501

        :param gcp_advanced_configurations_json: The gcp_advanced_configurations_json of this CreateClusterComputeConfig.  # noqa: E501
        :type: object
        """
    ...
    @property
    def gcp(self):
        """Gets the gcp of this CreateClusterComputeConfig.  # noqa: E501
        ...
        :return: The gcp of this CreateClusterComputeConfig.  # noqa: E501
    ...
    @gcp.setter
    def gcp(self, gcp):
        """Sets the gcp of this CreateClusterComputeConfig.

        DEPRECATED: Please provide instance configuration in the `gcp_advanced_configurations_json` field. Fields specific to GCP node types.  # noqa: E501

        :param gcp: The gcp of this CreateClusterComputeConfig.  # noqa: E501
        :type: GCPNodeOptions
        """
    ...
    @property
    def azure(self):
        """Gets the azure of this CreateClusterComputeConfig.  # noqa: E501

        DEPRECATED: We don't currently support azure. Fields specific to Azure node types.  # noqa: E501

        :return: The azure of this CreateClusterComputeConfig.  # noqa: E501
        :rtype: object
        """
        return self._azure
    ...
    def azure(self, azure):
        """Sets the azure of this CreateClusterComputeConfig.

        DEPRECATED: We don't currently support azure. Fields specific to Azure node types.  # noqa: E501

        :param azure: The azure of this CreateClusterComputeConfig.  # noqa: E501
        :type: object
        """
    ...
    def idle_termination_minutes(self):
        """Gets the idle_termination_minutes of this CreateClusterComputeConfig.  # noqa: E501
        ...
        :return: The idle_termination_minutes of this CreateClusterComputeConfig.  # noqa: E501
        :rtype: int
        """
    ...
    def idle_termination_minutes(self, idle_termination_minutes):
        """Sets the idle_termination_minutes of this CreateClusterComputeConfig.

        If set to a positive number, Anyscale will terminate the cluster this many minutes after the cluster is idle. Idle time is defined as the time during which a Cluster is not running a user command or a Ray driver. Time spent running commands on Jupyter or ssh is still considered 'idle'. To disable, set this field to 0.  # noqa: E501

        :param idle_termination_minutes: The idle_termination_minutes of this CreateClusterComputeConfig.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateClusterComputeConfig):
            return False
