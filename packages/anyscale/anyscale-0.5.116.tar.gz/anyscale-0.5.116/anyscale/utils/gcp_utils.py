...
def get_google_cloud_client_factory(logger: BlockLogger, project_id: str):
    ...
    try:
        ...
        factory.resourcemanager_v3.ProjectsClient().get_project(
            name=f"projects/{project_id}"
        )
        return factory
    except (NotFound, PermissionDenied, Forbidden, Unauthorized) as e:
        logger.error(e)
