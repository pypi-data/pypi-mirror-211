...
class HashableSet(set):
    ...
    @classmethod
    def from_index(cls, i: int, ensemble: List = None) -> "HashableSet":
    ...
    @classmethod
    def from_mask(cls, mask: str, ensemble: List = None) -> "HashableSet":
...
class _SetFunction:
    ...
    def __init__(
        self,
        values: Union[List, Dict, "_SetFunction"],
        ensemble: List = None,
        validate: bool = True,
    ):
        if isinstance(values, _SetFunction):
...
class SetFunction(_SetFunction):
    """This class represents a set function.
    ...
    def mobius(self) -> "Mobius":
        ...
        .. note:: Formula is based on :cite:p:`grabisch2008review`.
        """
        res = Mobius([0] * len(self), self.ensemble, validate=False)
...
class Mobius(_SetFunction):
    ...
    def set_function(self) -> SetFunction:
        ...
        .. note:: Formula is based on :cite:p:`grabisch2008review`.
        """
        res = SetFunction([0] * len(self), self.ensemble, validate=False)
...
class Capacity(SetFunction):
    """This class represents a capacity.
    ...
    def validate(self):
        ...
        The properties are the following:
            * the set function is defined on a subset of the ensemble
    ...
    @classmethod
    def uniform(cls, ensemble: List) -> "Capacity":
        ...
        .. note:: Formula is based on :cite:p:`grabisch2008review`.
        """
        res = Capacity([0] * 2 ** len(ensemble), ensemble, validate=False)
        res._values = {k: len(k) / res.size for k in res}
        return res

    @property
    def mobius(self) -> "MobiusCapacity":
        """Return Möbius transform of a set function.
        ...
        .. note:: Formula is based on :cite:p:`grabisch2008review`.
        """
        return MobiusCapacity(super().mobius)


class MobiusCapacity(Mobius):
    """This class represents the Möbius of a capacity.
    ...
    @property
    def set_function(self) -> Capacity:
        """Return set function from it Möbius transform.
        ...
        .. note:: Formula is based on :cite:p:`grabisch2008review`.
        """
        return Capacity(super().set_function)
