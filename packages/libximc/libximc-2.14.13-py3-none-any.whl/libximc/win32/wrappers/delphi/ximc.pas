...
type network_settings_t = record
		DHCPEnabled: cardinal;
		IPv4Address: array [0..3] of cardinal;
		SubnetMask: array [0..3] of cardinal;
		DefaultGateway: array [0..3] of cardinal;
end;

type password_settings_t = record
		UserPassword: array [0..19] of cardinal;
end;
...
function set_network_settings (id: Device; var network_settings: network_settings_t) : XimcResult; stdcall; external XimcDll;

function get_network_settings (id: Device; out network_settings: network_settings_t) : XimcResult; stdcall; external XimcDll;

function set_password_settings (id: Device; var password_settings: password_settings_t) : XimcResult; stdcall; external XimcDll;

function get_password_settings (id: Device; out password_settings: password_settings_t) : XimcResult; stdcall; external XimcDll;
...
function command_move (id: Device; Position: integer; uPosition: integer) : XimcResult; stdcall; external XimcDll;

function command_move_calb (id: Device; Position: single; var calibration: calibration_t) : XimcResult; stdcall; external XimcDll;
