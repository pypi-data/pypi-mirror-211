...
@LastEditTime: 2023-05-29 17:44:00
...
class PayOrder:
    ...
    def get_field_list(self):
        return ['id', 'app_id', 'act_id', 'user_id', 'open_id', 'pay_order_no', 'order_name', 'order_desc', 'source_type', 'out_order_no', 'order_status', 'pay_amount', 'refund_amount', 'create_date', 'pay_date', 'process_count', 'process_date']
