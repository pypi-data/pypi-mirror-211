...
@LastEditTime: 2023-05-25 18:32:10
        ...
        for special_goods in page_list:
            if "items_seller_list_get_response" in resp_on_sale_goods.keys():
                if "items" in resp_on_sale_goods["items_seller_list_get_response"].keys():
                    cur_resp_goods_list = [resp_goods for resp_goods in resp_on_sale_goods["items_seller_list_get_response"]["items"]["item"] if resp_goods.get("num_iid","") == special_goods["goods_id"]]
