...
class HTTPStatus(Enum):
    ...
    INSTRUCTION_STRING_TYPE_ERR = (400008, "请求体的参数字段类型错误", "Instruction 字段应该是 string 类型") # 大模型
    ...
    USER_NAME_INT_TYPE_ERR = (400008, "请求体的参数字段类型错误", "UserName 字段应该是 string 类型")
    DB_NAME_INT_TYPE_ERR = (400008, "请求体的参数字段类型错误", "DbName 字段应该是 string 类型")
    TEMPERATURE_FLOAT_TYPE_ERR = (400008, "请求体的参数字段类型错误", "Temperature 字段应该是 float 类型")
    TOPP_FLOAT_TYPE_ERR = (400008, "请求体的参数字段类型错误", "TopP 字段应该是 float 类型")
    TOPK_INT_TYPE_ERR = (400008, "请求体的参数字段类型错误", "TopK 字段应该是 int 类型")
    ...
    INSTRUCTIONS_EMPTY_ERR = (400009, "请求体的参数字段值为空", "Instructions 字段值为空字符") # 大模型
    INPUT_EMPTY_ERR = (400009, "请求体的参数字段值为空", "Input 字段值为空字符") # 大模型
    INPUTS_EMPTY_ERR = (400009, "请求体的参数字段值为空", "Inputs 字段值为空字符") # 大模型
    PROMPT_EMPTY_ERR = (400009, "请求体的参数字段值为空", "Prompt 字段值为空字符") # 大模型
    USER_NAME_EMPTY_ERR = (400009, "请求体的参数字段值为空", "UserName 字段值为空字符") # 大模型
    DB_NAME_EMPTY_ERR = (400009, "请求体的参数字段值为空", "DbName 字段值为空字符") # 大模型
    ...
    TEMPERATURE_VALUE_ERR = (400010, "请求体的参数字段值设置错误", "Temperature 字段不符合规范，请参考接口文档说明") # 大模型
    TOPP_VALUE_ERR = (400010, "请求体的参数字段值设置错误", "TopP 字段不符合规范，请参考接口文档说明") # 大模型
    TOPK_VALUE_ERR = (400010, "请求体的参数字段值设置错误", "TopK 字段不符合规范，请参考接口文档说明") # 大模型
    BEAMS_VALUE_ERR = (400010, "请求体的参数字段值设置错误", "Beams 字段不符合规范，请参考接口文档说明") # 大模型
    MAX_TOKENS_VALUE_ERR = (400010, "请求体的参数字段值设置错误", "MaxTokens 字段不符合规范，请参考接口文档说明") # 大模型
