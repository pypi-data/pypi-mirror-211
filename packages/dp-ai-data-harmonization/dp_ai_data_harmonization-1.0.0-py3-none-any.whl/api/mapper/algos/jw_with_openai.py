...
class JWWithOpenAI:
    ...
    def invoke(self,df1,df2):
        ...
        table1_parts = np.array_split(table1_parts,JWWithOpenAI.__get_split_size(len(table1_parts)))
        table2_parts = np.array_split(table2_parts, JWWithOpenAI.__get_split_size(len(table2_parts)))
