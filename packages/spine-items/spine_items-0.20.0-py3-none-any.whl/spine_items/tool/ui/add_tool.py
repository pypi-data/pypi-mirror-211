...
################################################################################
## Form generated from reading UI file 'add_tool.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_tool_specification_args = QLineEdit(Form)
        self.lineEdit_tool_specification_args.setObjectName(u"lineEdit_tool_specification_args")
        self.lineEdit_tool_specification_args.setEnabled(False)
        self.lineEdit_tool_specification_args.setCursor(QCursor(Qt.ArrowCursor))
        self.lineEdit_tool_specification_args.setFocusPolicy(Qt.NoFocus)
        ...
        QWidget.setTabOrder(self.comboBox_specification, self.lineEdit_tool_specification_args)
        QWidget.setTabOrder(self.lineEdit_tool_specification_args, self.pushButton_ok)
