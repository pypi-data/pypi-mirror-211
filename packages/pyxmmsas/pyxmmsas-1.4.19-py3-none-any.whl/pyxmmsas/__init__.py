...
default_html_label_dict = {
    'nH__02': 'n<sub>H</sub>',
    'nH__03': '$n<sub>H, pc</sub>',
    'CvrFract__04': 'Cov. Frac.',
    'PhoIndex__05': '$&Gamma;$',
    'norm__08': 'Flux (1-10 keV)',
    'nH__2': '$n<sub>H</sub>',
    'nH__3': '$n<sub>H, pc</sub>',
    'CvrFract__4': 'Cov. Frac.',
    'PhoIndex__5': '$&Gamma;$',
    'norm__8': 'Flux (1-10 keV)',
    'log(nH)__2': '$log(n<sub>H})$',
    'log(nH)__3': '$log(n<sub>H, pc})$',
    'log(norm)__8': '$log$(Flux (1-10 keV))',
    'rate': 'Count Rate'
}
...
def dump_html_table(fit_by_bin, html_label_dict=default_html_label_dict, to_skip=[], flux_norm=1e7, get_unit=None,
                     vertical_stack = True, table_class=''):
    ##too specific, to be revised.
