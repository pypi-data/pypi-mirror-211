...
const struct device_type_s device_types[] = {
    ...
    {JSDRV_DEVICE_TYPE_JS220_APP, "js220", {0xe27188c8, 0x98ff, 0x41de, {0xbe, 0x50, 0x65, 0x33, 0x24, 0xc6, 0xb1, 0x9c}}, 0x16D0, 0x10BA},

    // JS220 updater "{0149f96d-54af-4a91-88a9-1652cb1ecc1f}"
    {JSDRV_DEVICE_TYPE_JS220_BL, "&js220", {0x0149f96d, 0x54af, 0x4a91, {0x88, 0xa9, 0x16, 0x52, 0xcb, 0x1e, 0xcc, 0x1f}}, 0x16D0, 0x10B9},
