...
if TYPE_CHECKING:
    from . import validation_exception_data_fields

class ValidationExceptionData(APIError):
    def __init__(self,) -> None:
        ...
        # The fields property
        self._fields: Optional[validation_exception_data_fields.ValidationExceptionData_fields] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> ValidationExceptionData:
        """
        Creates a new instance of the appropriate class based on discriminator value
        Args:
            parseNode: The parse node to use to read the discriminator value and create the object
        Returns: ValidationExceptionData
        """
    ...
    @property
    def fields(self,) -> Optional[validation_exception_data_fields.ValidationExceptionData_fields]:
        """
        Gets the fields property value. The fields property
        Returns: Optional[validation_exception_data_fields.ValidationExceptionData_fields]
        """
        return self._fields
    
    @fields.setter
    def fields(self,value: Optional[validation_exception_data_fields.ValidationExceptionData_fields] = None) -> None:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "fields": lambda n : setattr(self, 'fields', n.get_object_value(validation_exception_data_fields.ValidationExceptionData_fields)),
        }
        return fields
