...
from function.counters import count
from function.cumul_endommagement import calculate_damage_cumulation
from function.losses import Losses
from function.temperature import calculate_temperature
from function.graphs import graph
from function.path_reader import import_variables
...
def global_calculation(variables_file_path):
  ...
  return (lifetime_IGBT, lifetime_diode, efficiency) #add number_of_km_IGBT, e_kwh_byhours if you want
